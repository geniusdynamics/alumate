<template>
    <div class="directory-filters rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
        <div class="filters-header mb-6 flex items-center justify-between">
            <h3 class="text-lg font-semibold text-gray-900">Filters</h3>
            <button v-if="hasActiveFilters" @click="$emit('clear-filters')" class="text-sm font-medium text-blue-600 hover:text-blue-800">
                Clear All
            </button>
        </div>
        ...
        <div class="filters-content space-y-6">
            ...
            <div class="filter-section">
                <label class="mb-3 block text-sm font-medium text-gray-700"> Graduation Year </label>
            ...
            <!-- Location Filter -->
            <div class="filter-section">
                <label class="mb-3 block text-sm font-medium text-gray-700"> Location </label>
                <div class="location-filter relative">
                    <input
                        ...
                        class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-transparent focus:ring-2 focus:ring-blue-500"
                    />
                    ...
                    >
                        ...
                        >
                            ...
                            <span class="text-xs text-gray-500">{{ location.count }}</span>
                        </button>
                    </div>
                </div>
            </div>
            ...
            <!-- Industry Filter -->
            <div class="filter-section">
                <label class="mb-3 block text-sm font-medium text-gray-700"> Industry </label>
                <div class="industry-filter">
                    <div class="max-h-48 space-y-2 overflow-y-auto">
                        <label v-for="industry in filters.industries?.slice(0, 15) || []" :key="industry.industry" class="flex items-center">
                            <input
                            ...
                            />
                            <span class="ml-2 flex-1 text-sm text-gray-700">{{ industry.industry }}</span>
            ...
            <!-- Company Filter -->
            <div class="filter-section">
                <label class="mb-3 block text-sm font-medium text-gray-700"> Company </label>
                <div class="company-filter relative">
                    ...
                    >
                        ...
                        >
                            ...
                            <span class="text-xs text-gray-500">{{ company.count }}</span>
                        </button>
                    </div>
                </div>
            </div>
            ...
            <!-- Skills Filter -->
            <div class="filter-section">
                <label class="mb-3 block text-sm font-medium text-gray-700"> Skills </label>
                        ...
                        <div v-if="localFilters.skills?.length > 0" class="flex flex-wrap gap-2">
                            ...
                            >
                                ...
                                <button
                                    ...
                                    class="ml-1 inline-flex h-4 w-4 items-center justify-center text-blue-400 hover:text-blue-600"
                                >
                    ...
                    <div class="skill-search relative">
                        ...
                        >
                            ...
                            >
                                ...
                                <span class="text-xs text-gray-500">{{ skill.count }}</span>
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <!-- Institution Filter -->
            <div class="filter-section">
                <label class="mb-3 block text-sm font-medium text-gray-700"> Institution </label>
                <div class="institution-filter">
                    <div class="max-h-48 space-y-2 overflow-y-auto">
                        <label v-for="institution in filters.institutions?.slice(0, 10) || []" :key="institution.id" class="flex items-center">
                            <input
                                ...
                                class="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <span class="ml-2 flex-1 text-sm text-gray-700">{{ institution.name }}</span>
            ...
            <!-- Circles Filter -->
            <div class="filter-section">
                <label class="mb-3 block text-sm font-medium text-gray-700"> Circles </label>
                <div class="circles-filter">
                    <div class="max-h-48 space-y-2 overflow-y-auto">
                        <label v-for="circle in filters.circles?.slice(0, 10) || []" :key="circle.id" class="flex items-center">
                            <input
                                ...
                                class="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <span class="ml-2 flex-1 text-sm text-gray-700">{{ circle.name }}</span>
            ...
            <!-- Groups Filter -->
            <div class="filter-section">
                <label class="mb-3 block text-sm font-medium text-gray-700"> Groups </label>
                <div class="groups-filter">
                    <div class="max-h-48 space-y-2 overflow-y-auto">
                        <label v-for="group in filters.groups?.slice(0, 10) || []" :key="group.id" class="flex items-center">
                            <input
                                ...
                                class="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                            />
                            <span class="ml-2 flex-1 text-sm text-gray-700">{{ group.name }}</span>
    ...
    setup(props, { emit }) {
        ...
        const searchSkills = debounce(async () => {
            ...
            try {
                ...
                const data = await response.json();
                skillSuggestions.value = data.data.filter((skill) => !localFilters.skills.includes(skill.value));
            } catch (error) {
