    ...
    <div class="form-builder" :class="{ loading: isLoading, error: hasError }">
        ...
        <div class="form-builder-header">
            ...
            <div class="header-right">
                ...
                <button @click="saveForm" :disabled="isSaving" class="save-btn" :aria-label="isSaving ? 'Saving form...' : 'Save form'">
        ...
        <div class="form-builder-content" v-if="!isPreviewMode">
            ...
            <div class="form-canvas">
                ...
                <div class="form-drop-zone" @dragover.prevent @drop="onDrop($event)" :class="{ 'drag-over': isDragOver }">
        ...
        <div class="form-preview" v-else>
            <div class="preview-header">
                ...
                <button @click="togglePreviewMode" class="exit-preview-btn">Exit Preview</button>
            </div>

            <div class="preview-content">
                <FormPreview :form-config="formConfig" :fields="formFields" @submit="handleFormSubmission" :is-submitting="isSubmitting" />
            </div>
        </div>

        <!-- Modals -->
        <FormSettingsModal v-if="showFormSettings" :config="formConfig" @update="updateFormConfig" @close="showFormSettings = false" />
        ...
        <div v-if="hasError" class="error-overlay">
            <div class="error-content">
                ...
                <button @click="resetBuilder" class="error-btn">Try Again</button>
            </div>
        </div>
    </div>
</template>
...
/* Field Palette */
.field-palette {
    @apply w-64 border-r border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800;
}
...
.field-type-item {
    @apply flex cursor-move items-center gap-3 rounded-lg bg-gray-50 p-3 dark:bg-gray-700;
    @apply transition-colors hover:bg-gray-100 dark:hover:bg-gray-600;
    @apply focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 dark:focus:ring-offset-gray-800;
...
.settings-btn,
.crm-btn {
    @apply rounded p-2 text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700;
    @apply focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 dark:focus:ring-offset-gray-800;
    @apply focus:outline-none;
}
...
.form-drop-zone.drag-over {
    @apply border-2 border-dashed border-blue-300 bg-blue-50 dark:border-blue-600 dark:bg-blue-900;
}
...
.crm-settings-panel,
.settings-panel {
    @apply mx-4 max-h-[90vh] w-full max-w-2xl overflow-hidden rounded-xl bg-white shadow-xl dark:bg-gray-800;
}
...
.crm-content,
.settings-content {
    @apply max-h-[calc(90vh-80px)] overflow-y-auto p-6;
}
...
@media (max-width: 768px) {
    ...
    .field-type-item {
        @apply flex-col p-2 text-center;
    }
}
