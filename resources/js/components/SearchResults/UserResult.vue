<template>
    <div class="user-result">
        <div class="user-avatar">
            <img v-if="user.avatar_url" :src="user.avatar_url" :alt="`${user.name}'s avatar`" class="avatar-image" />
        ...
        <div class="user-info">
            <div class="user-header">
                ...
                <div class="user-meta">
                    ...
                    <span v-if="user.current_company" class="user-company"> at {{ user.current_company }} </span>
            ...
            <div class="user-details">
                ...
                <div v-if="user.skills && user.skills.length > 0" class="skills-info">
                    ...
                    <div class="skills-list">
                        <span v-for="skill in displaySkills" :key="skill" class="skill-tag" v-html="highlightText(skill, highlight.skills)"></span>
            ...
            <div class="user-actions">
                <button @click="viewProfile" class="action-btn primary">
                    <UserIcon class="h-4 w-4" />
                    View Profile
                </button>

                <button v-if="canConnect" @click="sendConnectionRequest" class="action-btn secondary" :disabled="isConnecting">
                    <UserPlusIcon v-if="!isConnecting" class="h-4 w-4" />
...
// Computed properties
const displaySkills = computed(() => props.user.skills?.slice(0, maxSkillsDisplay) || []);
...
.avatar-placeholder {
    @apply flex h-12 w-12 items-center justify-center rounded-full bg-gray-300;
