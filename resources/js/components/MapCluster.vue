            ...
            <div class="cluster-preview" v-if="showPreview">
                ...
                <div class="preview-info">
                    ...
                    <div class="preview-names">
                        ...
                        <span v-if="cluster.count > previewLimit"> and {{ cluster.count - previewLimit }} more... </span>
                    </div>
                </div>
            </div>
        </div>
...
const previewAlumni = computed(() => props.cluster.alumni.slice(0, props.previewLimit));
