<template>
    <div class="rounded-lg border bg-white shadow-sm transition-shadow duration-200 hover:shadow-md">
        <!-- Event Image/Media -->
        <div v-if="event.media_urls && event.media_urls.length > 0" class="relative">
            <img :src="event.media_urls[0]" :alt="event.title" class="h-32 w-full rounded-t-lg object-cover sm:h-40 md:h-48" />
        ...
        <div class="p-4 sm:p-6">
            ...
            <div class="mb-3 flex items-start justify-between">
                <div class="flex-1">
                    <h3 class="mb-1 line-clamp-2 text-base font-semibold text-gray-900 sm:text-lg">
                        {{ event.title }}
                    </h3>
                ...
                <div v-if="event.user_data?.can_edit" class="ml-2">
                    <button @click.stop="$emit('edit', event)" class="rounded p-1 text-gray-400 hover:text-gray-600">
            ...
            <div class="mb-4 flex items-center text-sm text-gray-600">
                <MapPinIcon class="mr-2 h-4 w-4 flex-shrink-0" />
                <span class="truncate">
                    <template v-if="event.format === 'virtual'"> Virtual Event </template>
            ...
            <div class="mb-4 flex items-center text-sm text-gray-600">
                <div class="flex items-center">
                    ...
                    />
                    <div v-else class="mr-2 flex h-6 w-6 items-center justify-center rounded-full bg-gray-300">
            ...
            <div v-if="event.user_data?.is_registered" class="mb-4">
                <div class="flex items-center text-sm">
                    ...
                    <span class="font-medium text-green-700">
                        <template v-if="event.user_data.is_checked_in"> Checked In </template>
            ...
            <div class="flex items-center justify-between border-t pt-4">
                <button @click="$emit('view', event)" class="text-sm font-medium text-blue-600 hover:text-blue-800">View Details</button>
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <button
                        ...
                        class="rounded-md bg-green-600 px-3 py-1 text-xs font-medium text-white transition-colors hover:bg-green-700"
                    >
                        Check In
                    </button>
                    ...
                    <button
                        ...
                        :class="[
                            ...
                            canRegister ? 'bg-blue-600 text-white hover:bg-blue-700' : 'cursor-not-allowed bg-gray-200 text-gray-500',
                        ]"
                    >
...
import { CalendarIcon, CheckCircleIcon, MapPinIcon, PencilIcon } from '@heroicons/vue/24/outline';
