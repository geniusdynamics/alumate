            ...
            <div v-else-if="stats" class="insights-content">
                ...
                <div v-if="stats.industries && Object.keys(stats.industries).length" class="insight-section">
                    ...
                    <div class="industry-chart">
                        <div v-for="(count, industry) in topIndustries" :key="industry" class="industry-bar">
                            <div class="industry-info">
                                <span class="industry-name">{{ industry }}</span>
                                <span class="industry-count">{{ count }}</span>
                            </div>
                            <div class="industry-progress">
                                <div class="progress-bar" :style="{ width: getIndustryPercentage(count) + '%' }"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div v-if="stats.top_companies && Object.keys(stats.top_companies).length" class="insight-section">
                    ...
                    <div class="companies-list">
                        <div v-for="(count, company) in topCompanies" :key="company" class="company-item">
                            <div class="company-info">
                                <span class="company-name">{{ company }}</span>
                                <span class="company-count">{{ count }} alumni</span>
                            </div>
                            <div class="company-progress">
                                <div class="progress-bar" :style="{ width: getCompanyPercentage(count) + '%' }"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div v-if="suggestedGroups.length" class="insight-section">
                    ...
                    <div class="groups-suggestions">
                        <div v-for="group in suggestedGroups" :key="group.name" class="group-suggestion">
                            ...
                            <p class="group-details">
                                ...
                                <span v-if="group.industries"> • {{ group.industries.slice(0, 2).join(', ') }} </span>
                            </p>
                            <button class="btn btn-sm btn-outline-primary" @click="exploreGroup(group)">Explore Group</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="insight-section">
                    ...
                    <div class="opportunities-list">
                        <div class="opportunity-item">
                            ...
                            <button class="btn btn-sm btn-primary">Organize</button>
                        </div>
