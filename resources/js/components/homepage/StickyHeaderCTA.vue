    ...
    >
        <div class="header-container">
            ...
            <div class="header-actions">
                ...
                <!-- Secondary action -->
                <button v-if="cta.secondaryAction && !isCompact" class="header-secondary-button" @click="handleSecondaryClick">
                    <component v-if="cta.secondaryAction.icon" :is="cta.secondaryAction.icon" class="secondary-icon" />
                    {{ cta.secondaryAction.text }}
                </button>

                <!-- Primary CTA -->
                <button class="header-primary-button" :class="{ 'button-loading': isLoading }" @click="handlePrimaryClick" :disabled="isLoading">
                ...
                <button class="header-menu-toggle" @click="toggleMobileMenu" aria-label="Toggle menu">
        ...
        <div v-if="showMobileMenu" class="mobile-menu">
            <div class="mobile-menu-content">
                ...
                <div class="mobile-cta-options">
                    <button class="mobile-primary-button" @click="handlePrimaryClick" :disabled="isLoading">
                        <component v-if="cta.primaryIcon" :is="cta.primaryIcon" class="mobile-button-icon" />
                        {{ cta.text }}
                    </button>

                    <button v-if="cta.secondaryAction" class="mobile-secondary-button" @click="handleSecondaryClick">
                ...
                <div v-if="cta.trustIndicators" class="mobile-trust-indicators">
                    <div v-for="indicator in cta.trustIndicators" :key="indicator.text" class="mobile-trust-item">
        ...
        <div v-if="cta.notification" class="header-notification">
            <div class="notification-badge">
                ...
                <button class="notification-close" @click="dismissNotification" aria-label="Dismiss notification">
