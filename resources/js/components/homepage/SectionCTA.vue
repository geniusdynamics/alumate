    ...
    <div class="section-cta" :class="[`cta-${cta.placement}`, `cta-${cta.style || 'default'}`, { 'cta-sticky': cta.sticky }]">
        <div class="cta-container">
                ...
                <div class="message-content">
                    ...
                    <div v-if="cta.contextualMessage.progress" class="message-progress">
                        <div class="progress-bar">
                            <div class="progress-fill" :style="{ width: cta.contextualMessage.progress.percentage + '%' }"></div>
                        </div>
            ...
            <div class="cta-actions">
                <!-- Primary CTA -->
                <button class="primary-cta-button" :class="{ 'button-loading': isLoading }" @click="handlePrimaryClick" :disabled="isLoading">
                ...
                <!-- Secondary CTA -->
                <button v-if="cta.secondaryAction" class="secondary-cta-button" @click="handleSecondaryClick">
                ...
                <a v-if="cta.tertiaryAction" :href="cta.tertiaryAction.href" class="tertiary-cta-link" @click="handleTertiaryClick">
            ...
            <div v-if="cta.additionalContext" class="cta-context">
                ...
                <div v-if="cta.additionalContext.valueProps" class="value-props">
                    <div v-for="prop in cta.additionalContext.valueProps" :key="prop.text" class="value-prop-item">
            ...
            <!-- Dismissible option -->
            <button v-if="cta.dismissible" class="cta-dismiss-button" @click="handleDismiss" aria-label="Dismiss this call-to-action">
