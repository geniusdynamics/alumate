<template>
    <Teleport to="body">
        <div v-if="isOpen" class="video-modal-overlay" @click="closeModal" role="dialog" aria-modal="true" aria-labelledby="video-modal-title">
            <div class="video-modal-container" @click.stop>
                ...
                <header class="video-modal-header">
                    ...
                    <button @click="closeModal" class="close-button" aria-label="Close video modal">
                ...
                <div class="video-container">
                    <div class="video-wrapper">
                        ...
                        <!-- Direct Video -->
                        <video v-else-if="videoType === 'direct'" :src="videoUrl" controls autoplay class="video-element">
                        ...
                        <div v-else class="video-error">
                            ...
                            <a :href="videoUrl" target="_blank" rel="noopener noreferrer" class="external-link"> Watch on external site </a>
                        </div>
                    </div>
                </div>
                ...
                <div v-if="description || alumniName" class="video-info">
                    <div v-if="alumniName" class="alumni-info">
                        <img v-if="alumniImage" :src="alumniImage" :alt="`${alumniName} profile photo`" class="alumni-avatar" />
                ...
                <div class="video-actions">
                    <button @click="shareVideo" class="action-button share-button" aria-label="Share video">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                            <path
                    ...
                    <button @click="toggleFullscreen" class="action-button fullscreen-button" aria-label="Toggle fullscreen">
                        <svg viewBox="0 0 24 24" fill="currentColor">
...
.video-modal-container {
    @apply max-h-screen w-full max-w-4xl overflow-y-auto rounded-lg bg-white shadow-2xl;
...
.video-actions {
    @apply flex justify-center gap-4 border-t border-gray-200 p-6;
}
...
:global(.video-modal-container:fullscreen) {
    @apply h-screen max-h-none w-screen max-w-none rounded-none;
}
