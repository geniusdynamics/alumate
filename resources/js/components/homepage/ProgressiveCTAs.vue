    ...
    <div class="progressive-ctas">
        ...
        <div v-if="engagementLevel === 'low'" class="engagement-low">
            <div class="soft-cta" v-for="cta in lowEngagementCTAs" :key="cta.id">
                <button class="soft-cta-button" @click="handleCTAClick(cta)">
                    {{ cta.text }}
                </button>
            </div>
        </div>
        ...
        <div v-else-if="engagementLevel === 'medium'" class="engagement-medium">
            <div class="medium-cta" v-for="cta in mediumEngagementCTAs" :key="cta.id">
                <div class="cta-content">
                    ...
                    <button class="medium-cta-button" @click="handleCTAClick(cta)">
                        {{ cta.text }}
            ...
            <div class="high-engagement-banner">
                <div class="banner-content">
                    ...
                    <div class="banner-actions">
                        <button class="primary-action-button" @click="handleCTAClick(highEngagementContent.primaryCTA)">
        ...
        <div class="scroll-based-ctas" v-if="scrollDepth > 50">
            <div class="scroll-cta" v-for="cta in getScrollBasedCTAs()" :key="cta.id" :class="{ 'cta-visible': scrollDepth >= cta.triggerDepth }">
                <div class="scroll-cta-content">
                    ...
                    <button class="scroll-cta-button" @click="handleCTAClick(cta)">
                        {{ cta.text }}
                    </button>
                </div>
            </div>
        ...
        <div class="micro-ctas" v-if="showMicroCTAs">
            ...
            >
                <button class="micro-cta-button" @click="handleCTAClick(microCTA)" :title="microCTA.tooltip">
