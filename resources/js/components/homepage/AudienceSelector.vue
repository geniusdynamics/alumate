    ...
    <div class="audience-selector-container">
        <div class="audience-selector">
            <div class="selector-wrapper">
                <button
                    :class="['selector-button', { active: audience === 'individual' }]"
                ...
                <button
                    :class="['selector-button', { active: audience === 'institutional' }]"
            ...
            <div v-if="showDescription" class="selector-description">
                ...
                <div v-else>
                    ...
                    <p v-else class="description-text">Engage your alumni community with branded solutions and analytics</p>
                </div>
            </div>
        </div>
    </div>
...
.selector-button {
    @apply flex items-center gap-2 rounded-md border border-gray-300 px-4 py-2;
    @apply bg-white text-sm font-medium text-gray-700;
...
.detecting-text {
    @apply text-xs italic text-blue-600;
    @apply animate-pulse;
}
