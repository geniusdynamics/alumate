<template>
    <Teleport to="body">
        ...
        >
            <div v-if="showPrompt" class="fixed inset-0 z-50 flex items-end justify-center p-4 sm:items-center" @click.self="handleDismiss">
                <!-- Backdrop -->
                <div class="fixed inset-0 bg-black/50 backdrop-blur-sm" />

                <!-- Install Prompt Modal -->
                <div
                    class="relative w-full max-w-md transform rounded-2xl bg-white p-6 shadow-2xl ring-1 ring-black/5 dark:bg-gray-900 dark:ring-white/10"
                >
                    <!-- Close Button -->
                    <button
                        @click="handleDismiss"
                    ...
                    <div class="text-center">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Install Alumni Platform</h3>
                    ...
                    <div class="mt-6 flex space-x-3">
                        <button
                            @click="handleInstall"
                            :disabled="installing"
                            class="flex-1 rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 dark:focus:ring-offset-gray-900"
                        >
...
const trackEvent = (eventName, data = {}) => {
    ...
    window.dispatchEvent(
        new CustomEvent('pwa-install-event', {
