    ...
    <div class="contact-form-container">
        ...
        <form @submit.prevent="handleSubmit" class="contact-form">
            ...
            <div class="form-group">
                ...
                <select id="subject" v-model="form.subject" class="form-select" :class="{ error: errors.subject }" required>
...
.form-select,
.form-textarea {
    @apply w-full rounded-lg border border-gray-300 px-4 py-3 dark:border-gray-600;
...
.form-checkbox {
    @apply h-5 w-5 rounded border-gray-300 text-blue-600 dark:border-gray-600;
...
.submit-button {
    ...
    @apply rounded-lg bg-blue-600 px-6 py-3 font-medium text-white;
...
.success-message {
    @apply mt-6 rounded-lg border border-green-200 bg-green-50 p-4 dark:border-green-800 dark:bg-green-900/20;
    @apply flex items-start gap-3;
}

.success-icon {
    @apply mt-0.5 h-6 w-6 flex-shrink-0 text-green-600 dark:text-green-400;
}
...
.success-title {
    @apply mb-1 text-lg font-medium text-green-800 dark:text-green-400;
}
...
.error-banner {
    @apply mt-6 rounded-lg border border-red-200 bg-red-50 p-4 dark:border-red-800 dark:bg-red-900/20;
    @apply flex items-start gap-3;
}

.error-icon {
    @apply mt-0.5 h-6 w-6 flex-shrink-0 text-red-600 dark:text-red-400;
}
...
.error-title {
    @apply mb-1 text-lg font-medium text-red-800 dark:text-red-400;
}
