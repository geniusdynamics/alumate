                    ...
                    >
                        ...
                        >
                            ...
                            <form @submit.prevent="handleSubmit" class="bg-white">
                                <div class="max-h-96 overflow-y-auto px-6 py-6">
                                    <div class="grid grid-cols-1 gap-6">
                                        ...
                                        <div>
                                            ...
                                            />
                                            <p class="mt-1 text-sm text-gray-500">{{ form.short_description?.length || 0 }}/500 characters</p>
                                        </div>
                                        ...
                                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                            <div>
                                                <label class="mb-2 block text-sm font-medium text-gray-700"> Start Date & Time * </label>
                                                <input
                                            ...
                                            <div>
                                                <label class="mb-2 block text-sm font-medium text-gray-700"> End Date & Time * </label>
                                                <input
                                        ...
                                        <div v-if="form.format !== 'in_person'" class="space-y-4">
                                            ...
                                            <MeetingPlatformSelector v-model="form.meeting_config" @update:modelValue="handleMeetingConfigUpdate" />
                                        </div>
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                                <div>
                                                    <label class="mb-2 block text-sm font-medium text-gray-700"> Maximum Capacity </label>
                                                    <input
                                                ...
                                                <div>
                                                    <label class="mb-2 block text-sm font-medium text-gray-700"> Registration Deadline </label>
                                                    <input
                                            ...
                                            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                                <div>
                                                    <label class="mb-2 block text-sm font-medium text-gray-700"> Ticket Price ($) </label>
                                                    <input
                                            ...
                                            <div class="space-y-3">
                                                ...
                                                <div v-if="form.allow_guests" class="ml-6">
                                                    <label class="mb-2 block text-sm font-medium text-gray-700"> Maximum guests per attendee </label>
                                                    <input
                                                        v-model.number="form.max_guests_per_attendee"
                                                        type="number"
                                                        min="1"
                                                        max="10"
                                                        class="w-32 rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500"
                                                    />
                                                </div>
