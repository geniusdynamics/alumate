<template>
    <div :class="['lazy-image-container', { loading: isLoading, loaded: isLoaded, error: hasError }]" :style="{ aspectRatio: aspectRatio }">
        <!-- Placeholder/Skeleton -->
        <div v-if="isLoading && !hasError" class="lazy-image-placeholder" :style="placeholderStyle">
        ...
        <!-- Error State -->
        <div v-if="hasError" class="lazy-image-error flex items-center justify-center bg-gray-100 text-gray-500 dark:bg-gray-800 dark:text-gray-400">
...
const imageClasses = computed(() => ['lazy-image', 'transition-opacity duration-300', props.class]);
