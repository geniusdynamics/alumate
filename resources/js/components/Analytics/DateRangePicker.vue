    ...
    <div class="date-range-picker">
        <div class="picker-container">
            <div class="date-input-group">
                ...
                <input v-model="localStartDate" type="date" class="date-input" @change="handleStartDateChange" />
            </div>

            <div class="date-separator">
                <Icon name="arrow-right" class="h-4 w-4 text-gray-400" />
            </div>

            <div class="date-input-group">
                <label class="date-label">To</label>
                <input v-model="localEndDate" type="date" class="date-input" @change="handleEndDateChange" />
            </div>
        </div>
...
<style scoped>
.date-range-picker {
    @apply rounded-lg border border-gray-300 bg-white p-4 dark:border-gray-600 dark:bg-gray-800;
    @apply space-y-4 shadow-sm;
}
...
.date-input {
    @apply rounded-md border border-gray-300 px-3 py-2 dark:border-gray-600;
...
.preset-button {
    @apply rounded-md border px-3 py-1.5 text-xs font-medium;
    @apply border-gray-300 text-gray-700 dark:border-gray-600 dark:text-gray-300;
    @apply bg-white hover:bg-gray-50 dark:bg-gray-700 dark:hover:bg-gray-600;
