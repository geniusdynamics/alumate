    ...
    <div class="device-breakdown-chart">
        ...
        <div class="chart-container">
            <div class="device-stats">
                <div v-for="(percentage, device) in data" :key="device" class="device-item">
                    <div class="device-info">
                        <div class="device-icon" :class="getDeviceIconClass(device)">
                            <Icon :name="getDeviceIcon(device)" class="h-5 w-5" />
                        </div>
                    ...
                    <div class="device-bar">
                        <div class="device-fill" :style="{ width: `${percentage}%` }" :class="getDeviceColor(device)"></div>
                    </div>
                </div>
            </div>
        </div>
