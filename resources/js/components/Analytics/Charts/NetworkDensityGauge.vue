        ...
        <div class="gauge-container">
            <div class="gauge-wrapper">
                <svg class="gauge-svg" viewBox="0 0 200 120">
                    ...
                    <!-- Progress arc -->
                    <path :d="progressArc" fill="none" :stroke="gaugeColor" stroke-width="12" stroke-linecap="round" class="progress-arc" />

                    <!-- Center text -->
                    <text x="100" y="85" text-anchor="middle" class="gauge-value">{{ value.toFixed(1) }}%</text>
                    <text x="100" y="105" text-anchor="middle" class="gauge-label">Density</text>
                </svg>
            </div>

            <div class="gauge-description">
                <p class="description-text">
                    Network density measures how interconnected your alumni community is. Higher density indicates stronger community bonds.
                </p>
...
.gauge-value {
    @apply fill-current text-2xl font-bold text-gray-900 dark:text-white;
}

.gauge-label {
    @apply fill-current text-sm text-gray-600 dark:text-gray-400;
}
