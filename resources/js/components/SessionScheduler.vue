        ...
        <div class="relative top-20 mx-auto w-full max-w-2xl rounded-md border bg-white p-5 shadow-lg">
            <div class="mt-3">
                ...
                <div class="mb-6 flex items-center justify-between">
                    <h3 class="text-lg font-semibold text-gray-900">Schedule Mentorship Session</h3>
                ...
                <form @submit.prevent="scheduleSession" class="space-y-6">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option v-for="mentorship in availableMentorships" :key="mentorship.id" :value="mentorship.id">
                    ...
                    <!-- Notes -->
                    <div>
                        <label class="mb-2 block text-sm font-medium text-gray-700"> Session Notes (Optional) </label>
                        <textarea
                            v-model="form.notes"
                            rows="3"
                            class="w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
...
const isFormValid = computed(() => {
    return form.value.mentorship_id && form.value.date && form.value.time;
});
