<template>
    <div class="fixed inset-0 z-50 overflow-y-auto">
        <div class="flex min-h-screen items-center justify-center px-4 pb-20 pt-4 text-center sm:block sm:p-0">
            ...
            <div
                class="my-8 inline-block w-full max-w-lg transform overflow-hidden rounded-lg bg-white p-6 text-left align-middle shadow-xl transition-all dark:bg-gray-800"
            >
                <div class="mb-6 flex items-center justify-between">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white">Integration Test Results</h3>
                ...
                <div class="space-y-4">
                    ...
                    <div v-if="results.success" class="flex items-start space-x-3">
                        ...
                        <div>
                            <h4 class="text-sm font-medium text-green-800 dark:text-green-400">Connection Successful</h4>
                    ...
                    <div v-else class="flex items-start space-x-3">
                        ...
                        <div>
                            <h4 class="text-sm font-medium text-red-800 dark:text-red-400">Connection Failed</h4>
                    ...
                    <div v-if="results.warning" class="flex items-start space-x-3">
                        ...
                        <div>
                            <h4 class="text-sm font-medium text-yellow-800 dark:text-yellow-400">Warning</h4>
                    ...
                    <div v-if="results.data && Object.keys(results.data).length > 0" class="mt-6">
                        <h4 class="mb-3 text-sm font-medium text-gray-900 dark:text-white">Connection Details</h4>
                        <div class="rounded-md bg-gray-50 p-3 dark:bg-gray-700">
                            <pre class="whitespace-pre-wrap text-xs text-gray-700 dark:text-gray-300">{{
                    ...
                    <div v-if="results.discovery_data" class="mt-6">
                        <h4 class="mb-3 text-sm font-medium text-gray-900 dark:text-white">OIDC Discovery Information</h4>
                    ...
                    <div v-if="results.account_info" class="mt-6">
                        <h4 class="mb-3 text-sm font-medium text-gray-900 dark:text-white">Account Information</h4>
                        <div class="space-y-2 rounded-md bg-gray-50 p-3 dark:bg-gray-700">
                    ...
                    <div v-if="results.versions && Array.isArray(results.versions)" class="mt-6">
                        <h4 class="mb-3 text-sm font-medium text-gray-900 dark:text-white">Available API Versions</h4>
                        <div class="rounded-md bg-gray-50 p-3 dark:bg-gray-700">
                            ...
                            <div v-if="results.versions.length > 6" class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <div v-if="results.hasOwnProperty('sso_url_accessible')" class="mt-4">
                        <div class="flex items-center space-x-2">
                            <component
                                ...
                                :class="['h-5 w-5', results.sso_url_accessible ? 'text-green-500' : 'text-red-500']"
                            />
