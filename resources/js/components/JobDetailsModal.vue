    ...
    <div v-if="show" class="modal-overlay" @click="closeModal">
        <div class="modal-container" @click.stop>
            ...
            <div class="modal-content">
                        ...
                        <div class="match-breakdown">
                            <div class="breakdown-item">
                                ...
                                <div class="breakdown-bar">
                                    <div class="breakdown-fill" :style="{ width: `${job.match_analysis.breakdown.connections}%` }"></div>
                                </div>
                            ...
                            <div class="breakdown-item">
                                ...
                                <div class="breakdown-bar">
                                    <div class="breakdown-fill" :style="{ width: `${job.match_analysis.breakdown.skills}%` }"></div>
                                </div>
                            ...
                            <div class="breakdown-item">
                                ...
                                <div class="breakdown-bar">
                                    <div class="breakdown-fill" :style="{ width: `${job.match_analysis.breakdown.education}%` }"></div>
                                </div>
                            ...
                            <div class="breakdown-item">
                                ...
                                <div class="breakdown-bar">
                                    <div class="breakdown-fill" :style="{ width: `${job.match_analysis.breakdown.circles}%` }"></div>
                                </div>
                ...
                <div v-if="job.skills_required && job.skills_required.length > 0" class="skills-section">
                    ...
                    <div class="skills-list">
                        <span v-for="skill in job.skills_required" :key="skill" class="skill-tag">
                            {{ skill }}
                        </span>
                    </div>
                </div>
            ...
            <div class="modal-actions">
                ...
                <button v-if="!job.application_status" @click="$emit('apply', job)" class="btn btn-primary">Apply for this Job</button>
            </div>
        </div>
    </div>
</template>
