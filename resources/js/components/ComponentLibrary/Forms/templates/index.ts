    ...
    config: {
        ...
        fields: [
            ...
            },
            {
                ...
                required: false,
                width: 'half',
                validation: [{ rule: 'phone', message: 'Please enter a valid phone number' }],
            },
            {
                id: 'date-of-birth',
                type: 'date',
                ...
                required: false,
                width: 'half',
                validation: [{ rule: 'max', value: new Date().toISOString().split('T')[0], message: 'Date of birth cannot be in the future' }],
            },
            {
                id: 'graduation-year',
                type: 'select',
                ...
                required: true,
                width: 'half',
                validation: [{ rule: 'required', message: 'Graduation year is required' }],
            ...
            },
            {
                ...
                required: true,
                width: 'half',
                validation: [{ rule: 'required', message: 'Degree level is required' }],
                options: [
            ...
            },
            {
                ...
                required: true,
                width: 'full',
                validation: [{ rule: 'required', message: 'You must agree to the privacy policy to continue' }],
            },
        ],
        layout: 'two-column',
        spacing: 'default',
...
export const institutionDemoRequestTemplate: FormTemplate = {
    ...
    config: {
        ...
        description:
            "Discover how our alumni engagement platform can transform your institution's relationship with graduates. Get a customized demonstration tailored to your specific needs.",
        fields: [
            {
                id: 'contact-name',
                type: 'text',
            ...
            },
            {
                ...
                required: true,
                width: 'half',
                validation: [{ rule: 'required', message: 'Job title is required' }],
            },
            {
                id: 'institution-name',
                type: 'text',
            ...
            },
            {
                ...
                required: true,
                width: 'half',
                validation: [{ rule: 'required', message: 'Institution type is required' }],
                options: [
            ...
            },
            {
                ...
                required: true,
                width: 'half',
                validation: [{ rule: 'required', message: 'Institution size is required' }],
                options: [
            ...
            },
            {
                ...
                required: true,
                width: 'half',
                validation: [{ rule: 'required', message: 'Department is required' }],
                options: [
            ...
            },
            {
                ...
                required: true,
                width: 'half',
                validation: [{ rule: 'required', message: 'Decision role is required' }],
                options: [
            ...
            },
            {
                ...
                required: true,
                width: 'half',
                validation: [{ rule: 'required', message: 'Alumni count is required' }],
                options: [
            ...
            },
            {
                ...
                required: true,
                width: 'half',
                validation: [{ rule: 'required', message: 'Implementation timeline is required' }],
                options: [
            ...
            },
            {
                ...
                width: 'full',
                multiple: true,
                validation: [{ rule: 'required', message: 'Please select at least one primary goal' }],
                options: [
            ...
            },
            {
                ...
                width: 'full',
                rows: 4,
                validation: [{ rule: 'maxLength', value: 1000, message: 'Please limit your response to 1000 characters' }],
            },
            {
                id: 'demo-preferences',
                type: 'textarea',
                ...
                width: 'full',
                rows: 3,
                validation: [{ rule: 'maxLength', value: 500, message: 'Please limit your response to 500 characters' }],
            },
            {
    ...
    config: {
        ...
        fields: [
            ...
            },
            {
                ...
                required: true,
                width: 'half',
                validation: [{ rule: 'required', message: 'Please select your role' }],
                options: [
            ...
            },
            {
                ...
                required: true,
                width: 'half',
                validation: [{ rule: 'required', message: 'Please select an inquiry category' }],
                options: [
            ...
            },
            {
                ...
                required: true,
                width: 'half',
                validation: [{ rule: 'required', message: 'Please select a priority level' }],
                options: [
            ...
            },
            {
                ...
                required: true,
                width: 'full',
                validation: [{ rule: 'required', message: 'You must consent to follow-up communications' }],
            },
        ],
        layout: 'two-column',
        spacing: 'default',
        submission: {
            ...
            successMessage:
                'Thank you for contacting us! Your inquiry has been received and routed to the appropriate team. You can expect a response based on your selected priority level.',
    ...
    config: {
        ...
        fields: [
            ...
            },
            {
                ...
                required: true,
                width: 'half',
                validation: [{ rule: 'required', message: 'Phone number is required' }],
            },
            {
                id: 'graduation-year',
                type: 'select',
