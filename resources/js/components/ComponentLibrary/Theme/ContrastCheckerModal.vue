        ...
        <div class="flex min-h-screen items-center justify-center px-4 pb-20 pt-4 text-center sm:block sm:p-0">
            ...
            >
                ...
                <div class="mb-6 flex items-center justify-between">
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Color Contrast Checker</h3>
                        <p class="text-sm text-gray-600 dark:text-gray-400">Check WCAG accessibility compliance for "{{ color?.name }}"</p>
                    </div>
                ...
                <div v-if="color" class="space-y-6">
                    ...
                    <div class="color-info-section">
                        <div class="flex items-center gap-4">
                            ...
                            <div class="color-details">
                                ...
                                <p class="text-sm text-gray-500">{{ color.type }} color</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="contrast-tests-section">
                        <h4 class="mb-4 text-lg font-medium text-gray-900 dark:text-white">Contrast Tests Against Background Colors</h4>

                        <div class="contrast-grid">
                            <div v-for="bgColor in backgroundColors" :key="bgColor.id" class="contrast-test-card">
                                ...
                                <div class="contrast-info">
                                    <div class="bg-color-info">
                                        <div class="bg-color-swatch" :style="{ backgroundColor: bgColor.value }"></div>
                                        <div>
                    ...
                    <div class="custom-test-section">
                        <h4 class="mb-4 text-lg font-medium text-gray-900 dark:text-white">Test Against Custom Background</h4>

                        <div class="custom-test-controls">
                            <div class="custom-color-input">
                                <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"> Background Color </label>
                                <div class="color-input-group">
                                    <input v-model="customBackgroundColor" type="color" class="color-picker" />
                                    <input
                    ...
                    <div class="guidelines-section">
                        <h4 class="mb-4 text-lg font-medium text-gray-900 dark:text-white">WCAG Contrast Guidelines</h4>

                        <div class="guidelines-grid">
                            <div class="guideline-card">
                                <div class="guideline-header">
                                    <Icon name="information-circle" class="h-5 w-5 text-blue-600" />
                            ...
                            <div class="guideline-card">
                                <div class="guideline-header">
                                    <Icon name="information-circle" class="h-5 w-5 text-green-600" />
                    ...
                    <div v-if="recommendations.length > 0" class="recommendations-section">
                        <h4 class="mb-4 text-lg font-medium text-gray-900 dark:text-white">Recommendations</h4>
                        ...
                        <div class="recommendations-list">
                            ...
                            >
                                <div class="recommendation-icon">
                                    <Icon :name="getRecommendationIcon(recommendation.severity)" class="h-5 w-5" />
                                </div>
                                <div class="recommendation-content">
                                    ...
                                    <div v-if="recommendation.suggestedColors" class="suggested-colors">
                                        <p class="mb-2 text-xs text-gray-500">Suggested alternatives:</p>
...
const getComplianceBadgeClass = (passes: boolean): string => {
    return passes ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200' : 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200';
};
...
.color-display {
    @apply h-16 w-16 rounded-lg border-4 border-white shadow-lg;
}
...
.sample-button {
    @apply mt-3 rounded-md px-4 py-2 font-medium;
}
