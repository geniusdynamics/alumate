    ...
    <div class="modal-overlay" @click="handleOverlayClick">
        <div class="modal-container" @click.stop>
            <div class="modal-header">
                <div>
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Theme Preview: {{ theme.name }}</h3>
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Preview how this theme will look across different components</p>
                </div>
                        ...
                        <div v-if="currentView === 'components'" class="preview-content">
                            ...
                            <section class="hero-preview" :style="heroStyle">
                                <div class="hero-content">
                                    <h1 class="hero-title" :style="heroTitleStyle">Welcome to Our Alumni Network</h1>
                                    <p class="hero-subtitle" :style="heroSubtitleStyle">
                                        Connect, grow, and succeed with thousands of alumni worldwide
                                    </p>
                                    <div class="hero-actions">
                                        <button class="hero-button primary" :style="primaryButtonStyle">Join Network</button>
                                        <button class="hero-button secondary" :style="secondaryButtonStyle">Learn More</button>
                                    </div>
                            ...
                            <section class="form-preview" :style="sectionStyle">
                                <div class="section-container">
                                    <h2 class="section-title" :style="sectionTitleStyle">Get Started Today</h2>
                                    <div class="form-container" :style="formContainerStyle">
                                        ...
                                        <button class="form-submit" :style="primaryButtonStyle">Submit Application</button>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section class="testimonial-preview" :style="testimonialSectionStyle">
                                <div class="section-container">
                                    <h2 class="section-title" :style="sectionTitleStyle">What Our Alumni Say</h2>
                                    <div class="testimonial-grid">
                                        ...
                                        >
                                            <div class="testimonial-content" :style="testimonialContentStyle">"{{ testimonial.content }}"</div>
                            ...
                            <section class="cta-preview" :style="ctaSectionStyle">
                                <div class="section-container">
                                    <div class="cta-content">
                                        <h2 class="cta-title" :style="ctaTitleStyle">Ready to Join Our Community?</h2>
                                        <p class="cta-subtitle" :style="ctaSubtitleStyle">
                                            Take the next step in your career journey with our alumni network
                                        </p>
                                        <div class="cta-actions">
                                            <button class="cta-button primary" :style="primaryButtonStyle">Join Now</button>
                                            <button class="cta-button secondary" :style="secondaryButtonStyle">Contact Us</button>
                                        </div>
                                    </div>
                                </div>
                            </section>
                        ...
                        <div v-else-if="currentView === 'styleguide'" class="style-guide">
                            <div class="style-section">
                                ...
                                <div class="color-palette">
                                    <div v-for="(color, name) in theme.cssVariables" :key="name" v-show="name.includes('color')" class="color-item">
                            ...
                            <div class="style-section">
                                ...
                                <div class="typography-samples">
                                    ...
                                    <div class="type-sample">
                                        <p :style="bodyStyle">
                                            Body text - This is how regular paragraph text will appear throughout the site. It should be readable and
                        ...
                        <div v-else-if="currentView === 'accessibility'" class="accessibility-report">
                            <div class="accessibility-section">
                                ...
                                <div class="accessibility-checks">
                                    <div v-for="check in accessibilityChecks" :key="check.name" class="accessibility-check" :class="check.status">
                                        <Icon
...
.modal-container {
    @apply flex max-h-[95vh] w-full max-w-7xl flex-col overflow-hidden rounded-lg bg-white shadow-xl dark:bg-gray-800;
}
...
.preview-controls {
    @apply mb-6 flex items-center justify-between rounded-lg bg-gray-50 p-4 dark:bg-gray-700;
}
...
.device-btn {
    @apply text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white;
}
...
.hero-button {
    @apply rounded-md px-6 py-3 font-semibold;
}
...
.form-input {
    @apply border focus:border-blue-500 focus:ring-2 focus:ring-blue-500;
}
...
.cta-button {
    @apply rounded-md px-8 py-4 font-semibold;
}
...
.style-section-title {
    @apply border-b border-gray-200 pb-2 text-xl font-bold text-gray-900 dark:border-gray-700 dark:text-white;
}
...
.color-swatch {
    @apply h-12 w-12 rounded border border-gray-300 dark:border-gray-600;
}
...
.spacing-demo {
    @apply rounded border border-blue-300 bg-blue-100 font-mono text-sm dark:border-blue-600 dark:bg-blue-900/20;
}
...
.check-value {
    @apply mt-1 font-mono text-sm text-gray-800 dark:text-gray-200;
}
