    ...
    <div class="theme-preview-frame" :class="frameClasses">
        ...
        <div v-if="showPerformanceMetrics" class="performance-overlay">
            <div class="performance-metrics">
                <div class="metric">
                    ...
                    <span class="metric-value" :class="getMetricClass(performanceData.loadTime, 'loadTime')"> {{ performanceData.loadTime }}ms </span>
                </div>
                <div class="metric">
                ...
                <div class="metric">
                    ...
                    <span class="metric-value" :class="getScoreClass(performanceData.score)"> {{ performanceData.score }}/100 </span>
                </div>
            </div>
        </div>
        ...
        <div v-if="showAccessibilityOverlay" class="accessibility-overlay">
            <div class="accessibility-indicators">
                ...
                >
                    <Icon :name="indicator.icon" class="h-4 w-4" />
                ...
                <section class="hero-section" :style="heroSectionStyles">
                    <div class="hero-container">
                        ...
                        <div class="hero-stats" :style="statsContainerStyles">
                            <div v-for="stat in sampleData.hero.stats" :key="stat.label" class="stat-item">
                ...
                <section class="form-section" :style="sectionStyles">
                    <div class="section-container">
                        ...
                        <div class="form-container" :style="formContainerStyles">
                            <div v-for="field in sampleData.form.fields" :key="field.name" class="form-group">
                                ...
                                />
                                <select v-else class="form-input" :style="formInputStyles">
                ...
                <section class="testimonials-section" :style="testimonialsSectionStyles">
                    <div class="section-container">
                        ...
                        <div class="testimonials-grid">
                            ...
                            >
                                <div class="testimonial-content" :style="testimonialContentStyles">"{{ testimonial.content }}"</div>
            ...
            <div v-else-if="viewMode === 'styleguide'" class="style-guide">
                <div class="style-section">
                    ...
                    <div class="color-grid">
                        <div v-for="(color, name) in colorVariables" :key="name" class="color-item">
                ...
                <div class="style-section">
                    ...
                    <div class="typography-samples">
                        ...
                        <div class="type-sample">
                            <p :style="bodyStyles">
                                Body text - This is how regular paragraph text will appear throughout the site. It should be readable and comfortable
                                for extended reading sessions.
                            </p>
                        </div>
                        <div class="type-sample">
                            <small :style="smallTextStyles"> Small text - Used for captions, disclaimers, and secondary information. </small>
                        </div>
                    </div>
                </div>
                ...
                <div class="style-section">
                    ...
                    <div class="spacing-samples">
                        <div v-for="(size, name) in spacingVariables" :key="name" class="spacing-item">
                            <div class="spacing-label">{{ formatSpacingName(name) }}</div>
                            <div
                                class="spacing-demo"
                                :style="{ padding: size, backgroundColor: theme.cssVariables['--theme-color-primary'], opacity: 0.2 }"
                            >
                                {{ size }}
                            </div>
                        </div>
            ...
            <div v-else-if="viewMode === 'accessibility'" class="accessibility-view">
                <div class="accessibility-section">
                    ...
                    <div class="compliance-grid">
                        <div v-for="check in accessibilityChecks" :key="check.name" class="compliance-item" :class="check.status">
                            <Icon
...
// Computed styles
const frameClasses = computed(() => ['theme-preview-frame', `device-${props.device}`, { 'animations-enabled': props.enableAnimations }]);
...
const primaryButtonStyles = computed(() => ({
    ...
    fontWeight: '600',
    cursor: 'pointer',
    transition: props.enableAnimations
        ? `all ${props.theme.cssVariables['--theme-animation-duration'] || '0.3s'} ${props.theme.cssVariables['--theme-animation-easing'] || 'ease'}`
        : 'none',
}));
...
watch(
    () => props.showAccessibilityOverlay,
    (show) => {
        if (show) {
            generateAccessibilityIndicators();
        }
...
<style scoped>
.theme-preview-frame {
    @apply relative min-h-96 w-full overflow-hidden rounded-lg bg-white;
}
...
.performance-overlay {
    @apply absolute right-4 top-4 z-10 rounded-lg bg-black bg-opacity-75 p-3 text-xs text-white;
}
...
.accessibility-indicator {
    @apply pointer-events-auto absolute flex h-8 w-8 cursor-pointer items-center justify-center rounded-full;
}
...
.indicator-tooltip {
    @apply pointer-events-none absolute left-10 top-0 whitespace-nowrap rounded bg-gray-900 p-2 text-xs text-white opacity-0 transition-opacity duration-200;
}
...
.form-submit {
    @apply w-full rounded-lg px-6 py-3 font-semibold transition-all duration-200;
}
...
.style-section-title {
    @apply border-b border-gray-200 pb-2 text-xl font-semibold text-gray-900 dark:border-gray-700 dark:text-white;
}
...
.color-swatch {
    @apply h-16 w-full rounded-lg border border-gray-200 dark:border-gray-700;
}
...
.type-sample {
    @apply border-l-4 border-gray-200 pl-4 dark:border-gray-700;
}
...
.spacing-demo {
    @apply rounded border border-gray-200 text-center text-xs dark:border-gray-700;
}
...
.compliance-item {
    @apply flex gap-4 rounded-lg border p-4;
}
