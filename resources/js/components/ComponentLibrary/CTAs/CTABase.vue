<template>
    <div :class="baseClasses" :aria-label="config.accessibility?.ariaLabel" :aria-describedby="config.accessibility?.ariaDescribedBy">
        <!-- CTA Button -->
        <CTAButton
        ...
        <div v-else class="rounded-lg border border-red-200 bg-red-50 p-4">
            <p class="text-sm text-red-800">Invalid CTA configuration. Please check the component setup.</p>
        </div>
    </div>
</template>
