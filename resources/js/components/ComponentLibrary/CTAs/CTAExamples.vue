    ...
    <div class="cta-examples">
        <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
            <div class="mb-12 text-center">
                <h1 class="mb-4 text-4xl font-bold text-gray-900">CTA Component Examples</h1>
                <p class="mx-auto max-w-3xl text-xl text-gray-600">
                    Explore our comprehensive collection of call-to-action components with conversion tracking, A/B testing, and accessibility
                    features.
                </p>
            </div>
            ...
            <!-- CTA Buttons Section -->
            <section class="mb-16">
                <h2 class="mb-8 text-3xl font-bold text-gray-900">CTA Buttons</h2>

                <!-- Button Styles -->
                <div class="mb-8">
                    <h3 class="mb-4 text-xl font-semibold text-gray-800">Button Styles</h3>
                ...
                <!-- Button Sizes -->
                <div class="mb-8">
                    <h3 class="mb-4 text-xl font-semibold text-gray-800">Button Sizes</h3>
                ...
                <!-- Buttons with Icons -->
                <div class="mb-8">
                    <h3 class="mb-4 text-xl font-semibold text-gray-800">Buttons with Icons</h3>
                    <div class="flex flex-wrap gap-4">
                        <CTABase
                            :config="{
                                type: 'button',
                ...
                <!-- Loading States -->
                <div class="mb-8">
                    <h3 class="mb-4 text-xl font-semibold text-gray-800">Loading States</h3>
                    <div class="flex flex-wrap gap-4">
                        <CTABase
                            :config="{
                                type: 'button',
            ...
            <!-- CTA Banners Section -->
            <section class="mb-16">
                <h2 class="mb-8 text-3xl font-bold text-gray-900">CTA Banners</h2>

                <!-- Center Aligned Banner -->
                <div class="mb-8">
                    <h3 class="mb-4 text-xl font-semibold text-gray-800">Center Aligned Banner</h3>
                    <CTABase
                        :config="{
                            type: 'banner',
                            bannerConfig: {
                ...
                <!-- Split Layout Banner -->
                <div class="mb-8">
                    <h3 class="mb-4 text-xl font-semibold text-gray-800">Split Layout Banner</h3>
                    <CTABase
                        :config="{
                            type: 'banner',
                            bannerConfig: {
                ...
                <!-- Compact Banner -->
                <div class="mb-8">
                    <h3 class="mb-4 text-xl font-semibold text-gray-800">Compact Banner</h3>
                    <CTABase
                        :config="{
                            type: 'banner',
                            bannerConfig: {
            ...
            <section class="mb-16">
                <h2 class="mb-8 text-3xl font-bold text-gray-900">Inline Links</h2>
            ...
            <!-- A/B Testing Demo -->
            <section class="mb-16">
                <h2 class="mb-8 text-3xl font-bold text-gray-900">A/B Testing Demo</h2>
                <div class="rounded-lg bg-gray-50 p-6">
                    <h3 class="mb-4 text-xl font-semibold text-gray-800">Signup Button Test ({{ currentVariant?.name || 'Loading...' }})</h3>
                    <p class="mb-6 text-gray-600">This button is part of an A/B test. Refresh the page to see different variants.</p>

                    <CTABase v-if="abTestConfig" :config="abTestConfig" @click="handleCTAClick" @conversion="handleConversion" />
            ...
            <!-- Analytics Dashboard -->
            <section class="mb-16">
                <h2 class="mb-8 text-3xl font-bold text-gray-900">Analytics Dashboard</h2>
                <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                    <div class="rounded-lg bg-white p-6 shadow">
                        <h3 class="mb-2 text-lg font-semibold text-gray-800">Total Clicks</h3>
                        <p class="text-3xl font-bold text-blue-600">{{ analytics.totalClicks }}</p>
                    </div>
                    <div class="rounded-lg bg-white p-6 shadow">
                        <h3 class="mb-2 text-lg font-semibold text-gray-800">Conversions</h3>
                        <p class="text-3xl font-bold text-green-600">{{ analytics.totalConversions }}</p>
                    </div>
                    <div class="rounded-lg bg-white p-6 shadow">
                        <h3 class="mb-2 text-lg font-semibold text-gray-800">Conversion Rate</h3>
                        <p class="text-3xl font-bold text-purple-600">{{ analytics.conversionRate }}%</p>
                    </div>
                </div>

                <div class="mt-6">
                    <button @click="clearAnalytics" class="rounded bg-red-600 px-4 py-2 text-white transition-colors hover:bg-red-700">
...
// Set up A/B test
onMounted(() => {
    const testConfig = createABTest(
        'signup_button_test',
        createEqualWeightVariants([
            {
                id: 'control',
...
const updateConversionRate = () => {
    if (analytics.value.totalClicks > 0) {
        analytics.value.conversionRate = parseFloat(((analytics.value.totalConversions / analytics.value.totalClicks) * 100).toFixed(2));
    }
};
