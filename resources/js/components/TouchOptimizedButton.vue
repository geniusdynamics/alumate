...
<template>
    ...
    >
        ...
        <div v-if="showTouchFeedback" class="touch-feedback-overlay" :class="touchFeedbackClass"></div>
    </button>
</template>
...
.button-secondary {
    ...
    @apply hover:border-gray-700 hover:bg-gray-700;
...
.button-ghost {
    @apply border-transparent bg-transparent text-gray-700 dark:text-gray-300;
...
.button-outline {
    @apply border-blue-600 bg-transparent text-blue-600 dark:border-blue-400 dark:text-blue-400;
...
.dark .button-secondary {
    ...
    @apply hover:border-gray-600 hover:bg-gray-600;
    @apply active:bg-gray-700;
}

.dark .button-danger {
    @apply border-red-500 bg-red-500;
    @apply hover:border-red-600 hover:bg-red-600;
