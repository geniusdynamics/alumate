    ...
    <div class="security-incidents-container">
        <div class="incidents-header">
            ...
            <div class="incidents-controls">
                <select v-model="selectedSeverity" @change="filterIncidents" class="severity-filter">
                ...
                <select v-model="selectedStatus" @change="filterIncidents" class="status-filter">
        ...
        <div class="incidents-list">
            ...
            <div v-else class="incidents-items">
                <div
                    ...
                    :key="incident.id"
                    :class="['incident-item', `incident-${incident.severity}`, `status-${incident.status}`]"
                ...
                >
                    ...
                    <div class="incident-actions">
                        ...
                        <button @click.stop="viewIncidentDetails(incident.id)" class="action-button details" title="View Details">
                            <svg class="action-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
...
.overview-card.high {
    @apply border border-orange-200 bg-orange-50 dark:border-orange-800 dark:bg-orange-900/20;
}
...
.overview-card.high .card-icon {
    @apply bg-orange-100 text-orange-600 dark:bg-orange-900/40 dark:text-orange-400;
}
