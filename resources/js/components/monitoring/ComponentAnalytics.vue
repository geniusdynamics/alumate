        ...
        <div class="performance-overview">
            <div class="overview-card">
                ...
                <div class="card-content">
                    <div v-for="component in topPerformingComponents" :key="component.name" class="component-item good">
            ...
            <div class="overview-card">
                ...
                <div class="card-content">
                    <div v-for="component in problematicComponents" :key="component.name" class="component-item warning">
                        <div class="component-info">
                            <span class="component-name">{{ component.name }}</span>
                            <span class="component-metric">{{ formatMetric(component.value, selectedMetric) }}</span>
                        </div>
        ...
        <div class="component-details">
            <div class="details-header">
                ...
                <div class="search-filter">
                    <input v-model="searchQuery" type="text" placeholder="Search components..." class="search-input" />
                </div>
            </div>
            ...
            <div class="component-table">
                ...
                <div class="table-body">
                    <div v-for="component in filteredComponents" :key="component.name" class="table-row" @click="selectComponent(component)">
                        <div class="component-col table-cell">
                        ...
                        <div class="status-col table-cell">
                            <span :class="['status-badge', component.status]">{{ component.status }}</span>
                        </div>

                        <div class="actions-col table-cell">
                            <button @click.stop="analyzeComponent(component)" class="action-button" title="Analyze">
...
const filteredComponents = computed(() => {
    ...
    if (searchQuery.value) {
        ...
        filtered = filtered.filter((component) => component.name.toLowerCase().includes(query) || component.path.toLowerCase().includes(query));
    }
...
.component-item {
    @apply flex items-center justify-between rounded-lg p-3;
}
...
.table-header {
    @apply grid grid-cols-5 gap-4 bg-gray-50 p-4 dark:bg-gray-700;
...
.action-button {
    ...
    @apply rounded-md hover:bg-gray-100 dark:hover:bg-gray-600;
