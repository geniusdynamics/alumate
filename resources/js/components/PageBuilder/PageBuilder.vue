      ...
      <div class="header-right">
        <div class="header-actions">
          ...
          <button
            ...
            class="header-btn template-btn"
            :title="'Browse templates'"
          >
            <Icon name="template" class="w-4 h-4" />
            Templates
          </button>
          ...
          <button
            ...
            class="header-btn component-btn"
            :title="'Browse components'"
          >
            <Icon name="component" class="w-4 h-4" />
            Components
          </button>
          ...
          <!-- Custom Code Actions -->
          <button
            @click="showCustomCodePanel = true"
            class="header-btn custom-code-btn"
            :title="'Custom code'"
          >
          ...
          >
            <Icon v-if="isSaving" name="spinner" class="w-4 h-4 animate-spin" />
          ...
          >
            <Icon v-if="isPublishing" name="spinner" class="w-4 h-4 animate-spin" />
            <Icon v-else name="upload" class="w-4 h-4" />
...
.header-btn {
  @apply flex items-center space-x-2 px-3 py-2 text-sm font-medium rounded-md transition-colors;
}

.template-btn {
  @apply text-purple-700 bg-purple-100 hover:bg-purple-200 dark:text-purple-300 dark:bg-purple-900 dark:hover:bg-purple-800;
}

.component-btn {
  @apply text-blue-700 bg-blue-100 hover:bg-blue-200 dark:text-blue-300 dark:bg-blue-900 dark:hover:bg-blue-800;
}

.save-btn {
  @apply text-gray-700 bg-gray-100 hover:bg-gray-200 dark:text-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600;
}
...
.preview-btn {
  @apply text-indigo-700 bg-indigo-100 hover:bg-indigo-200 dark:text-indigo-300 dark:bg-indigo-900 dark:hover:bg-indigo-800;
}

.publish-btn {
  @apply text-green-700 bg-green-100 hover:bg-green-200 dark:text-green-300 dark:bg-green-900 dark:hover:bg-green-800;
}
...
.left-sidebar {
  @apply w-80 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 overflow-y-auto;
}
...
.right-sidebar {
  @apply w-80 bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700 overflow-y-auto;
}
...
.loading-content {
  @apply bg-white dark:bg-gray-800 rounded-lg p-6 flex flex-col items-center space-y-4;
}
...
.live-preview-panel {
  @apply fixed bottom-0 left-0 right-0 h-96 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 shadow-lg z-40;
}
</style>