<template>
  <div class="form-field-config-panel bg-white border-l border-gray-200 w-80 h-full overflow-y-auto">
    <div class="p-4 border-b border-gray-200">
      <h3 class="text-lg font-semibold text-gray-900">Field Configuration</h3>
      <p class="text-sm text-gray-600 mt-1">Configure the selected form field</p>
    </div>

    <div v-if="!selectedField" class="p-4 text-center text-gray-500">
      <Icon name="cursor-click" class="w-12 h-12 mx-auto mb-3 text-gray-300" />
    ...
    <div v-else class="p-4 space-y-6">
      ...
      <div class="space-y-4">
        ...
        <div>
          ...
          />
          <p class="text-xs text-gray-500 mt-1">Used for form submission data</p>
        </div>
        ...
        <div class="flex items-center space-x-4">
          <label class="flex items-center">
            <input
              v-model="fieldConfig.is_required"
              type="checkbox"
              class="mr-2"
            />
          ...
          <label class="flex items-center">
            <input
              v-model="fieldConfig.is_visible"
              type="checkbox"
              class="mr-2"
            />
      ...
      <div v-if="needsOptions" class="space-y-4">
        ...
        <div class="space-y-2">
          <div
            v-for="(option, index) in fieldConfig.field_options"
            :key="index"
        ...
        <button
          @click="addOption"
          class="w-full px-3 py-2 border border-dashed border-gray-300 rounded-md text-gray-600 hover:border-gray-400 hover:text-gray-800"
        >
          + Add Option
        </button>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div v-if="hasConditionalLogic" class="space-y-3">
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Show this field when:</label>
            <select
          ...
          <div class="space-y-2">
            ...
            >
              ...
              <button
                @click="removeConditionalRule(index)"
