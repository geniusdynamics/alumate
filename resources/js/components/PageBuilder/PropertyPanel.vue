  ...
  <div class="property-panel">
    ...
    <div class="panel-header">
      <div class="header-content">
        ...
        <p v-if="selectedComponent" class="panel-subtitle">
          Configure {{ selectedComponent.category }} component
        </p>
    ...
    <div v-if="!selectedComponent" class="empty-state">
      ...
      <p class="empty-description">
        Click on a component in the editor to configure its properties
      </p>
    </div>
    ...
    <div v-else class="properties-content">
      ...
      <div class="component-info">
        <div class="component-icon">
          <Icon :name="getComponentIcon(selectedComponent.category)" class="w-6 h-6" />
        </div>
...
const updateProperty = (key: string, value: any) => {
  if (props.selectedComponent && props.grapeJSEditor) {
    ...
    if (component) {
      ...
      if (['backgroundColor', 'textColor', 'paddingTop', 'paddingRight', 'paddingBottom', 'paddingLeft', 'marginTop', 'marginRight', 'marginBottom', 'marginLeft'].includes(key)) {
        // Style properties
...
.component-info {
  @apply flex items-center p-4 border-b border-gray-200 bg-gray-50;
}

.component-icon {
  @apply w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center mr-3;
}
...
.section-title {
  @apply flex items-center text-sm font-medium text-gray-900 mb-3;
}
...
.property-textarea {
  @apply w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none;
}
...
.color-text-input {
  @apply flex-1 px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500;
}
...
.spacing-input {
  @apply px-2 py-2 border border-gray-300 rounded text-sm text-center focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500;
}
...
.panel-actions {
  @apply p-4 border-t border-gray-200 bg-gray-50 flex space-x-2;
}
...
.action-btn.danger {
  @apply text-red-700 bg-red-50 border border-red-300 hover:bg-red-100;
}
</style>