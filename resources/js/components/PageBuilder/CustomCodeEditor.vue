          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div class="border border-gray-300 rounded-lg overflow-hidden">
                <div class="bg-gray-50 px-3 py-2 border-b border-gray-300 flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <component :is="codeTypeIcon" class="w-4 h-4 text-gray-600" />
                    <span class="text-sm font-medium text-gray-700">{{ codeTypeLabel }}</span>
                  </div>
                  <div class="flex items-center space-x-2">
                    <button
                      @click="formatCode"
                      class="text-xs text-gray-600 hover:text-gray-800 px-2 py-1 rounded border border-gray-300 hover:bg-gray-100"
                    >
                      Format
                    </button>
                    <button
                ...
                <div class="relative">
                  ...
                  <div
                    ...
                    class="absolute inset-0 p-4 font-mono text-sm pointer-events-none whitespace-pre-wrap"
              ...
              <div class="mt-4 flex items-center justify-between">
                <div class="flex items-center space-x-2">
                  <span class="text-sm text-gray-500">
                    ...
                    Size: {{ formatBytes(codeStats.bytes) }}
                  </span>
                </div>
                <div class="flex items-center space-x-2">
                  <button
            ...
            <div class="lg:col-span-1">
              ...
              <div v-if="validationResults" class="mb-6">
                <h4 class="text-sm font-medium text-gray-900 mb-3">Validation Results</h4>
                <div class="space-y-2">
                  <!-- Errors -->
                  ...
                  <div v-if="validationResults.warnings.length > 0">
                    <div class="flex items-center text-yellow-600 text-sm font-medium mb-1">
                      <ExclamationTriangleIcon class="w-4 h-4 mr-1" />
                    ...
                    <div class="space-y-1">
                      <div
                        ...
                        class="text-xs text-yellow-600 bg-yellow-50 p-2 rounded border border-yellow-200"
                      >
                  ...
                  <!-- Success State -->
                  <div v-if="validationResults.isValid" class="flex items-center text-green-600 text-sm">
              ...
              <!-- Code Templates -->
              <div class="mb-6">
                <h4 class="text-sm font-medium text-gray-900 mb-3">Templates</h4>
                <div class="space-y-2">
                  <button
                    v-for="template in getTemplates()"
                    :key="template.name"
                    @click="insertCodeTemplate(template)"
                    class="w-full text-left text-xs p-2 border border-gray-200 rounded hover:bg-gray-50"
                  >
              ...
              <!-- Code Snippets -->
              <div>
                <h4 class="text-sm font-medium text-gray-900 mb-3">Common Snippets</h4>
                <div class="space-y-2">
                  <button
...
const codeTypeIcon = computed(() => {
  switch (localCode.value.type) {
    case 'html': return DocumentTextIcon
    case 'css': return SwatchIcon
    case 'javascript': return CpuChipIcon
...
const canSave = computed(() => {
  return localCode.value.name.trim() !== '' && 
...
const validateCode = async () => {
  ...
  try {
    const results = await customCodeValidationService.validateCode(
      localCode.value.code,
      localCode.value.type
    )
