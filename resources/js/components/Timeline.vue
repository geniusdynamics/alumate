<template>
    <div class="timeline-container">
        ...
        >
            ...
            <div v-else-if="posts.length > 0" class="space-y-6">
                ...
                <div v-else-if="!hasMore" class="py-8 text-center">
                    <div class="text-gray-500">
                        ...
                        <p class="mt-1 text-xs">Check back later for new posts</p>
                    </div>
                </div>
            </div>
            ...
            <div v-else class="py-12 text-center">
                <div class="text-gray-500">
                    ...
                    <p class="mb-4 text-sm">Be the first to share something with your community!</p>
                    <button
        ...
        <div v-if="hasNewPosts" class="new-posts-notification" @click="loadNewPosts">
            <div class="flex items-center space-x-2">
...
.pull-to-refresh-indicator {
    @apply absolute left-0 right-0 top-0 z-10 transform border-b border-gray-200 bg-white p-4 text-center transition-transform duration-200;
...
.new-posts-notification {
    @apply fixed left-1/2 top-4 z-20 -translate-x-1/2 transform cursor-pointer rounded-full bg-blue-600 px-4 py-2 text-white shadow-lg transition-colors duration-200 hover:bg-blue-700;
}
