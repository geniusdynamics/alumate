<template>
    <div class="onboarding-system">
        ...
        <!-- Feature Spotlight -->
        <FeatureSpotlight v-if="showFeatureSpotlight" :feature="spotlightFeature" @close="closeFeatureSpotlight" @try-feature="tryFeature" />
        ...
        <ContextualHelp v-if="showContextualHelp" :help-content="contextualHelpContent" :position="helpPosition" @close="closeContextualHelp" />

        <!-- What's New Notification -->
        <WhatsNewNotification v-if="showWhatsNew" :updates="whatsNewUpdates" @close="closeWhatsNew" @view-details="viewWhatsNewDetails" />
    </div>
</template>
