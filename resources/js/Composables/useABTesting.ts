 ...
 */
export function createABTest(testId: string, variants: Omit<ABTestVariant, 'impressions' | 'conversions' | 'conversionRate'>[]): ABTestConfig {
    return {
        enabled: true,
        testId,
 ...
 */
export function createEqualWeightVariants(variantConfigs: Array<{ id: string; name: string; config: any }>): ABTestVariant[] {
