...
class PreloadService {
    ...
    private preloadCriticalCSS(): void {
        ...
        const criticalCSS = ['/build/assets/app.css', '/build/assets/mobile.css'];
    ...
    private preloadCriticalJS(): void {
        ...
        const criticalJS = ['/build/assets/app.js', '/build/assets/vendor.js'];
    ...
    public preloadNextPageResources(currentPage: string): void {
        const nextPageMap: Record<string, string[]> = {
            ...
            pricing: ['/build/assets/checkout.js', '/build/assets/payment.js'],
        };
