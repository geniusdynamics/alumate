...
export class ResponsiveConfigService {
     ...
     */
    public createDeviceVariants<T>(baseConfig: T, deviceOverrides: DeviceSpecificConfig<Partial<T>> = {}): ResponsiveComponentVariant[] {
    ...
    public createEnhancedDeviceVariants<T>(
        ...
        this.defaultConfig.enabledDevices.forEach((device) => {
            ...
            validationResults[device] = this.validateDeviceVariant(componentType, device, { ...baseConfig, ...deviceConfig }, constraints);
        });
     ...
     */
    private generateBreakpointOverrides<T>(deviceOverrides: DeviceSpecificConfig<Partial<T>>): { [K in BreakpointName]?: any } {
     ...
     */
    public generateResponsiveClasses(property: string, values: DeviceSpecificConfig<string>, prefix: string = ''): string[] {
