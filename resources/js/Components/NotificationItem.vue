<template>
    ...
    >
        <div class="flex items-start space-x-3">
            <!-- Avatar -->
            <img :src="avatarUrl" :alt="actorName" class="h-10 w-10 flex-shrink-0 rounded-full" />
            ...
            <div class="min-w-0 flex-1">
                <div class="flex items-start justify-between">
                    ...
                    <div class="ml-2 flex items-center space-x-1">
                        <!-- Unread Indicator -->
                        <div v-if="!isRead" class="h-2 w-2 rounded-full bg-blue-500" title="Unread"></div>
                        ...
                        <div class="flex space-x-1 opacity-0 transition-opacity group-hover:opacity-100">
                            ...
                            <button @click.stop="deleteNotification" class="rounded p-1 text-gray-400 hover:text-red-600" title="Delete">
                ...
                <div v-if="showConnectionActions" class="mt-3 flex space-x-2">
                    ...
                    <button
                        ...
                        :disabled="processingConnection"
                        class="rounded bg-gray-300 px-3 py-1 text-xs text-gray-700 hover:bg-gray-400 disabled:opacity-50"
                    >
                        Decline
                    </button>
                </div>
