        ...
        <div class="modal-content" @click.stop>
            ...
            <form @submit.prevent="saveSearch" class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input id="searchName" v-model="searchName" type="text" class="form-input" placeholder="Enter a name for this search" required />
                ...
                <div class="search-summary">
                    ...
                    <div class="summary-content">
                        <div v-if="query" class="summary-item"><strong>Query:</strong> "{{ query }}"</div>
                        <div v-if="hasFilters" class="summary-item"><strong>Filters:</strong> {{ filterSummary }}</div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="checkbox-group">
                        <label class="checkbox-label">
                            <input v-model="createAlert" type="checkbox" class="checkbox-input" />
                ...
                <div v-if="createAlert" class="form-group">
                    ...
                    <select id="alertFrequency" v-model="alertFrequency" class="form-select">
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" :disabled="!searchName.trim() || saving" class="button primary">
...
const generateDefaultName = () => {
    ...
    if (props.filters.industry?.length > 0) {
        const industry = props.filters.industry.length === 1 ? props.filters.industry[0] : `${props.filters.industry.length} industries`;
