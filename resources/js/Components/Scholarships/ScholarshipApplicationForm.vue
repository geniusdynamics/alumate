<template>
    <div class="mx-auto max-w-4xl p-6">
        <div class="rounded-lg bg-white p-8 shadow-lg">
            <div class="mb-8">
                <h2 class="mb-2 text-2xl font-bold text-gray-900">Apply for {{ scholarship.name }}</h2>
            ...
            <form @submit.prevent="handleSubmit" class="space-y-8">
                ...
                <div class="border-b pb-8">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div>
                            <label class="mb-2 block text-sm font-medium text-gray-700"> Academic Year * </label>
                            <select
                        ...
                        <div>
                            <label class="mb-2 block text-sm font-medium text-gray-700"> Field of Study * </label>
                            <input
                        ...
                        <div>
                            <label class="mb-2 block text-sm font-medium text-gray-700"> Current GPA </label>
                            <input
                        ...
                        <div>
                            <label class="mb-2 block text-sm font-medium text-gray-700"> Expected Graduation </label>
                            <input
                ...
                <!-- Personal Statement -->
                <div class="border-b pb-8">
                    <h3 class="mb-4 text-lg font-semibold text-gray-900">Personal Statement *</h3>
                    ...
                    ></textarea>
                    <div class="mt-2 text-sm text-gray-500">{{ form.personal_statement.length }} characters</div>
                </div>

                <!-- Financial Need (if required) -->
                <div v-if="scholarship.eligibility_criteria?.financial_need" class="border-b pb-8">
                    <h3 class="mb-4 text-lg font-semibold text-gray-900">Financial Need Statement</h3>
                    <p class="mb-4 text-sm text-gray-600">Please describe your financial situation and explain why you need this scholarship.</p>
                    <textarea
                ...
                <!-- References -->
                <div class="border-b pb-8">
                    <h3 class="mb-4 text-lg font-semibold text-gray-900">References</h3>
                    <p class="mb-4 text-sm text-gray-600">
                        Please provide contact information for {{ scholarship.application_requirements?.letters_of_recommendation || 2 }} references.
                    </p>

                    <div v-for="(reference, index) in form.references" :key="index" class="mb-6 rounded-lg border border-gray-200 p-4">
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            ...
                            <div>
                                <label class="mb-1 block text-sm font-medium text-gray-700">Title/Position *</label>
                                <input
                    ...
                    <button type="button" @click="addReference" class="text-sm font-medium text-blue-600 hover:text-blue-800">
                ...
                <div class="flex items-center justify-between pt-6">
                    ...
                    <div class="flex space-x-4">
                        <button
                            ...
                            @click="saveDraft"
                            :disabled="loading"
                            class="rounded-md border border-gray-300 bg-white px-6 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
                        >
                            Save Draft
                        </button>
                        <button
                            type="submit"
                            :disabled="loading"
                            class="rounded-md border border-transparent bg-blue-600 px-6 py-2 text-sm font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
                        >
