<template>
    <div class="rounded-lg bg-white p-6 shadow-lg">
        <div class="mb-6 flex items-center justify-between">
            ...
            <button @click="exportReport" class="rounded-lg bg-blue-600 px-4 py-2 text-white transition-colors hover:bg-blue-700">
                Export Report
            </button>
        </div>
        ...
        <div v-else-if="report" class="space-y-8">
            ...
            <div class="rounded-lg bg-gray-50 p-6">
                <h3 class="mb-4 text-lg font-semibold text-gray-900">Recipients by Year</h3>
                <div class="space-y-3">
                    <div v-for="(count, year) in report.recipients_by_year" :key="year" class="flex items-center justify-between">
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                <div class="rounded-lg bg-gray-50 p-6">
                    <h3 class="mb-4 text-lg font-semibold text-gray-900">Program Impact</h3>
                    <div class="space-y-4">
            ...
            <div v-if="successStories.length > 0" class="rounded-lg bg-gray-50 p-6">
                <h3 class="mb-4 text-lg font-semibold text-gray-900">Recent Success Stories</h3>
                <div class="space-y-4">
                    <div v-for="story in successStories.slice(0, 3)" :key="story.id" class="rounded-lg border border-gray-200 bg-white p-4">
                        <div class="flex items-start space-x-3">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="mt-1 line-clamp-2 text-sm text-gray-600">{{ story.success_story }}</p>
                ...
                <div class="mt-4 text-center">
                    <button @click="$emit('view-all-stories')" class="text-sm font-medium text-blue-600 hover:text-blue-800">
