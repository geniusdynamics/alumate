<template>
    <div class="fixed inset-0 z-50 overflow-y-auto">
        <div class="flex min-h-screen items-center justify-center px-4 pb-20 pt-4 text-center sm:block sm:p-0">
            ...
            <div
                class="inline-block transform overflow-hidden rounded-lg bg-white text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-4xl sm:align-middle dark:bg-gray-800"
            >
                <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4 dark:bg-gray-800">
                    ...
                    <form @submit.prevent="saveCampaign" class="space-y-6">
                        ...
                        <div v-if="currentStep === 0" class="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    type="text"
                                    required
                                    class="mt-1 block w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-gray-900 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                            ...
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300"> Campaign Type </label>
                                    <select
                                        v-model="form.type"
                                        required
                                        class="mt-1 block w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-gray-900 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                        ...
                        <div v-if="currentStep === 1" class="space-y-4">
                            <div>
                                <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"> Email Content </label>
                                <div class="rounded-md border border-gray-300 dark:border-gray-600">
                                    <div class="border-b border-gray-300 bg-gray-50 px-3 py-2 dark:border-gray-600 dark:bg-gray-700">
                                    ...
                                    <textarea
                                        ...
                                        rows="12"
                                        required
                                        class="block w-full resize-none border-0 bg-white text-gray-900 focus:ring-0 dark:bg-gray-700 dark:text-white"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300"> Personalization Rules </label>
                                <div class="mt-2 space-y-2">
                                    ...
                                    >
                                        <select
                                            v-model="rule.type"
                                            class="flex-1 rounded border border-gray-300 bg-white px-2 py-1 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-800 dark:text-white"
                                        >
                        ...
                        <div v-if="currentStep === 2" class="space-y-4">
                            <div>
                                <h4 class="mb-3 text-sm font-medium text-gray-700 dark:text-gray-300">Target Audience</h4>

                                <div class="space-y-4">
                                    <div>
                                        <label class="block text-sm text-gray-600 dark:text-gray-400"> Graduation Years </label>
                                        <input
                                    ...
                                    <div>
                                        <label class="block text-sm text-gray-600 dark:text-gray-400"> Industries </label>
                                        <input
                                    ...
                                    <div>
                                        <label class="block text-sm text-gray-600 dark:text-gray-400"> Locations </label>
                                        <input
                                ...
                                <div class="mt-4 rounded-md bg-blue-50 p-3 dark:bg-blue-900">
                                    <p class="text-sm text-blue-700 dark:text-blue-300">Estimated recipients: {{ estimatedRecipients }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div v-if="currentStep === 3" class="space-y-4">
                            <div>
                                <h4 class="mb-3 text-sm font-medium text-gray-700 dark:text-gray-300">Sending Options</h4>
                                ...
                                <div v-if="sendOption === 'schedule'" class="mt-4">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300"> Schedule Date & Time </label>
                                    <input
                            ...
                            <div>
                                <label class="flex items-center">
                                    <input
                                        ...
                                        class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                    />
                                    <span class="ml-2 text-sm text-gray-700 dark:text-gray-300"> Create A/B test variant </span>
                                </label>
...
const updateAudienceCriteria = () => {
    ...
    if (graduationYearsInput.value) {
        criteria.graduation_years = graduationYearsInput.value
            .split(',')
...
const saveCampaign = async () => {
    try {
        ...
        const url = props.campaign ? `/api/email-campaigns/${props.campaign.id}` : '/api/email-campaigns';
