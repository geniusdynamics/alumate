                    ...
                    <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            <div class="mt-3 w-full text-center sm:mt-0 sm:text-left">
                                <h3 class="mb-4 text-lg font-medium leading-6 text-gray-900">Add Major Gift Prospect</h3>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            <label for="prospect_rating" class="block text-sm font-medium text-gray-700"> Prospect Rating </label>
                                            <select
                                                id="prospect_rating"
                                        ...
                                        <div>
                                            <label for="stage" class="block text-sm font-medium text-gray-700"> Current Stage </label>
                                            <select
                                                id="stage"
                                                v-model="form.stage"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            <label for="ask_amount" class="block text-sm font-medium text-gray-700"> Proposed Ask Amount ($) </label>
                                            <input
                                                id="ask_amount"
                                    ...
                                    <div>
                                        <label for="interests" class="block text-sm font-medium text-gray-700"> Interests & Motivations </label>
                                        <textarea
                                            id="interests"
                                    ...
                                    <div>
                                        <label for="strategy" class="block text-sm font-medium text-gray-700"> Cultivation Strategy </label>
                                        <textarea
                                            id="strategy"
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            <label for="next_action" class="block text-sm font-medium text-gray-700"> Next Action </label>
                                            <input
                                                id="next_action"
                                        ...
                                        <div>
                                            <label for="next_action_date" class="block text-sm font-medium text-gray-700"> Next Action Date </label>
                                            <input
                                                id="next_action_date"
                                    ...
                                    <div>
                                        <label for="research_notes" class="block text-sm font-medium text-gray-700"> Research Notes </label>
                                        <textarea
                                            id="research_notes"
