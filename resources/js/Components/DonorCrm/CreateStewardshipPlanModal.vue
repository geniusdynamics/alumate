                    ...
                    <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            <div class="mt-3 w-full text-center sm:mt-0 sm:text-left">
                                <h3 class="mb-4 text-lg font-medium leading-6 text-gray-900">Create Stewardship Plan</h3>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        <label for="giving_goal" class="block text-sm font-medium text-gray-700"> Giving Goal ($) </label>
                                        <input
                                            id="giving_goal"
                                    ...
                                    <div>
                                        <label for="contact_frequency" class="block text-sm font-medium text-gray-700"> Contact Frequency </label>
                                        <select
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-2 space-y-2">
                                            <label v-for="method in contactMethods" :key="method.value" class="mr-4 inline-flex items-center">
                                                <input
                                                    type="checkbox"
                                                    :value="method.value"
                                    ...
                                    <div>
                                        <label for="strategies" class="block text-sm font-medium text-gray-700"> Strategies </label>
                                        <textarea
                                            id="strategies"
