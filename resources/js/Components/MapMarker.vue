    ...
    <div class="map-marker" :class="markerClass">
        <div class="marker-content" @click="handleClick">
            <div class="marker-avatar">
                <img :src="alumni.avatar_url || '/images/default-avatar.png'" :alt="alumni.name" class="avatar-image" />
            </div>
            <div class="marker-info" v-if="showInfo">
                ...
                <p class="alumni-company" v-if="alumni.current_company">at {{ alumni.current_company }}</p>
                <div class="marker-actions">
                    <button @click.stop="viewProfile" class="btn-primary btn-sm" :aria-label="`View ${alumni.name}'s profile`">View Profile</button>
                    <button @click.stop="sendMessage" class="btn-secondary btn-sm" :aria-label="`Send message to ${alumni.name}`">Message</button>
                </div>
            </div>
        </div>
    </div>
