    ...
    <div class="real-time-updates">
        ...
        <div v-if="showActivityFeed" class="activity-feed">
            <div class="rounded-lg bg-white p-6 shadow dark:bg-gray-800">
                <h3 class="mb-4 text-lg font-medium text-gray-900 dark:text-white">Live Activity</h3>
                <div class="space-y-3">
                    <div
        ...
        <div v-if="showPostUpdates" class="post-updates">
            <div v-for="update in postUpdates" :key="update.id" class="post-update-notification" :class="getUpdateClass(update.type)">
                <div class="flex items-center space-x-3">
                    ...
                    <button @click="dismissUpdate(update.id)" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
        ...
        <div v-if="showConnectionStatus" class="connection-status">
            <div class="flex items-center space-x-2">
                <div :class="connectionStatusClass" class="h-3 w-3 rounded-full"></div>
        ...
        <div v-if="showEngagementCounters" class="engagement-counters">
            <div class="flex space-x-4">
                <div v-for="counter in engagementCounters" :key="counter.type" class="flex items-center space-x-2">
                    <component :is="getEngagementIcon(counter.type)" class="h-4 w-4 text-gray-500" />
                    <span :class="{ 'animate-pulse text-blue-600': counter.isUpdating }" class="text-sm font-medium">
                        {{ counter.count }}
                    </span>
                </div>
            </div>
        ...
        <div v-if="showEventUpdates" class="event-updates">
            <div
                ...
                :key="eventUpdate.id"
                class="event-update-notification rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-700 dark:bg-blue-900"
            >
                <div class="flex items-start space-x-3">
                    <CalendarIcon class="mt-0.5 h-5 w-5 text-blue-600 dark:text-blue-400" />
                    <div class="flex-1">
        ...
        <div v-if="showJobUpdates" class="job-updates">
            <div
                ...
                :key="jobUpdate.id"
                class="job-update-notification rounded-lg border border-green-200 bg-green-50 p-4 dark:border-green-700 dark:bg-green-900"
            >
                <div class="flex items-start space-x-3">
                    <BriefcaseIcon class="mt-0.5 h-5 w-5 text-green-600 dark:text-green-400" />
                    <div class="flex-1">
