    ...
    <div class="space-y-8">
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-4">
            <div class="rounded-lg bg-gray-50 p-4 dark:bg-gray-700">
                <h4 class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Total Donations</h4>
            ...
            <div class="rounded-lg bg-gray-50 p-4 dark:bg-gray-700">
                <h4 class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Total Amount</h4>
                <p class="text-2xl font-bold text-gray-900 dark:text-white">
            ...
            <div class="rounded-lg bg-gray-50 p-4 dark:bg-gray-700">
                <h4 class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Average Gift</h4>
                <p class="text-2xl font-bold text-gray-900 dark:text-white">
            ...
            <div class="rounded-lg bg-gray-50 p-4 dark:bg-gray-700">
                <h4 class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Median Gift</h4>
                <p class="text-2xl font-bold text-gray-900 dark:text-white">
        ...
        <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
            <h3 class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Donor Frequency Analysis</h3>
        ...
        <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
            <h3 class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Gift Size Distribution</h3>

            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div class="space-y-3">
                    <div v-for="(count, range) in patterns.gift_size_distribution" :key="range" class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <span class="text-xs text-gray-500 dark:text-gray-400"> ({{ getPercentage(count, patterns.total_donations) }}%) </span>
                        </div>
                    </div>
                </div>
        ...
        <!-- Seasonal Patterns -->
        <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
            <h3 class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Seasonal Giving Patterns</h3>

            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                <div>
                    <h4 class="mb-3 text-sm font-medium text-gray-700 dark:text-gray-300">Peak Periods</h4>
                    <div class="space-y-2">
                        <div class="flex items-center justify-between">
        ...
        <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
            <h3 class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Recurring vs One-time Donations</h3>

            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div class="space-y-4">
                    <div class="rounded-lg bg-gray-50 p-4 dark:bg-gray-700">
                        <h4 class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Recurring Donations</h4>
                    ...
                    <div class="rounded-lg bg-gray-50 p-4 dark:bg-gray-700">
                        <h4 class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">One-time Donations</h4>
        ...
        <!-- Donor Retention -->
        <div v-if="patterns.donor_retention" class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
            <h3 class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Donor Retention Analysis</h3>
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        ...
                        >
                            ...
                            <span class="font-medium text-gray-900 dark:text-white"> {{ rate.toFixed(1) }}% </span>
                        </div>
                    </div>
                </div>
...
const createFrequencyChart = () => {
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [
                {
                    data: [props.patterns.giving_frequency.one_time_donors, props.patterns.giving_frequency.repeat_donors],
...
const createSeasonalChart = () => {
    ...
    const monthlyData = Object.entries(props.patterns.seasonal_patterns.monthly).sort(([a], [b]) => new Date(a + '-01') - new Date(b + '-01'));
...
const createRecurringChart = () => {
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [
                {
                    data: [props.patterns.recurring_vs_one_time.recurring_amount, props.patterns.recurring_vs_one_time.one_time_amount],
