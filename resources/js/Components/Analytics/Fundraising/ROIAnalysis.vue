<template>
    <div class="space-y-8">
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-green-600 dark:text-green-400">{{ formatPercentage(getAverageROI()) }}%</p>
                    </div>
                ...
                <div class="mt-2 flex items-center text-sm">
                    <span class="text-gray-500 dark:text-gray-400"> Across {{ campaigns.length }} campaigns </span>
                </div>
            </div>
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-blue-600 dark:text-blue-400">${{ formatNumber(getTotalInvestment()) }}</p>
                    </div>
                ...
                <div class="mt-2 flex items-center text-sm">
                    <span class="text-gray-500 dark:text-gray-400"> Campaign costs </span>
                </div>
            </div>
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-purple-600 dark:text-purple-400">${{ formatNumber(getTotalReturns()) }}</p>
                    </div>
                ...
                <div class="mt-2 flex items-center text-sm">
                    <span class="text-gray-500 dark:text-gray-400"> Funds raised </span>
                </div>
            </div>
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-orange-600 dark:text-orange-400">${{ formatDecimal(getAverageCostPerDollar()) }}</p>
                    </div>
                ...
                <div class="mt-2 flex items-center text-sm">
                    <span class="text-gray-500 dark:text-gray-400"> Average efficiency </span>
                </div>
            </div>
        </div>
        ...
        <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <h3 class="mb-6 text-lg font-semibold text-gray-900 dark:text-white">Campaign ROI Performance</h3>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-700">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">ROI</th>
                            <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">
                                Cost per $
                            </th>
                            <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">Donors</th>
                        </tr>
                    </thead>
                        ...
                        <tr v-for="campaign in sortedCampaigns" :key="campaign.campaign_id">
                            <td class="whitespace-nowrap px-6 py-4">
                                <div>
                                    ...
                                    <div class="text-sm capitalize text-gray-500 dark:text-gray-400">
        ...
        <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <h3 class="mb-6 text-lg font-semibold text-gray-900 dark:text-white">ROI by Campaign Type</h3>

            <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                <div v-for="typeAnalysis in getCampaignTypeAnalysis()" :key="typeAnalysis.type" class="rounded-lg bg-gray-50 p-4 dark:bg-gray-700">
                    <div class="mb-3 flex items-center justify-between">
                        <h4 class="text-sm font-medium capitalize text-gray-900 dark:text-white">
                            {{ typeAnalysis.type }}
                        </h4>
                        <span class="text-xs text-gray-500 dark:text-gray-400"> {{ typeAnalysis.count }} campaigns </span>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-sm font-semibold text-gray-900 dark:text-white"> ${{ formatNumber(typeAnalysis.totalRaised) }} </span>
                        </div>
            ...
            plugins: {
                ...
                tooltip: {
                    callbacks: {
                        ...
                        label: (context) => [`Amount Raised: $${formatNumber(context.parsed.x)}`, `ROI: ${formatPercentage(context.parsed.y)}%`],
                    },
                },
            },
            scales: {
