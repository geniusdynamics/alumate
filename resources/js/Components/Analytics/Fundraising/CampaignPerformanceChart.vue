    ...
    <div class="rounded-lg bg-white p-6 shadow-sm dark:bg-gray-800">
        <div class="mb-6 flex items-center justify-between">
            ...
            <div class="flex space-x-2">
                <select v-model="selectedMetric" class="rounded-md border-gray-300 text-sm dark:border-gray-600 dark:bg-gray-700 dark:text-white">
        ...
        <div v-else class="flex h-80 items-center justify-center text-gray-500 dark:text-gray-400">
        ...
        <div v-if="topCampaigns.length > 0" class="mt-6">
            <h4 class="mb-3 text-sm font-medium text-gray-900 dark:text-white">Top Performing Campaigns</h4>
            <div class="space-y-2">
                <div
                ...
                tooltip: {
                    callbacks: {
                        ...
                        afterLabel: function (context) {
                            ...
                            return [`Type: ${campaign.type}`, `Total Raised: ${formatCurrency(campaign.total_raised)}`];
                        },
                    },
                },
            },
