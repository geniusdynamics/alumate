            ...
            <form @submit.prevent="submitRequest" class="introduction-form">
                <div class="modal-content">
                    ...
                    <div class="form-section">
                        <label class="form-label" for="message"> Personal Message * </label>
                        <textarea
                            id="message"
                            ...
                            required
                        ></textarea>
                        <div class="character-count">{{ form.message.length }}/500 characters</div>
                    </div>
...
const isFormValid = computed(() => {
    return form.message.trim().length > 0 && form.message.length <= 500;
});
