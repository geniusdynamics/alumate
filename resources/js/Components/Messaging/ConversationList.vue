<template>
    <div class="conversation-list">
        <div class="conversation-list-header">
            ...
            <button @click="showNewConversationModal = true" class="btn btn-primary btn-sm" title="Start new conversation">
        ...
        <div class="conversation-items">
            <div
                ...
                :class="[
                    'conversation-item cursor-pointer border-b border-gray-200 p-3 transition-colors hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-gray-800',
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <div class="mt-1 flex items-center justify-between">
                            <p class="truncate text-sm text-gray-600 dark:text-gray-400">
                                <span v-if="conversation.latest_message?.user?.id === currentUser.id" class="text-gray-500"> You: </span>
                                {{ conversation.latest_message?.content || 'No messages yet' }}
                            </p>
                            <div v-if="conversation.unread_count > 0" class="flex-shrink-0">
                                <span
                                    class="inline-flex items-center justify-center rounded-full bg-blue-500 px-2 py-1 text-xs font-bold leading-none text-white"
                                >
                        ...
                        <div v-if="conversation.type !== 'direct'" class="mt-1">
                            <div class="flex -space-x-1">
                                <img
                                    ...
                                    class="h-5 w-5 rounded-full border border-white dark:border-gray-800"
                                    :title="participant.name"
                                />
                                <span v-if="conversation.participants.length > 3" class="ml-2 text-xs text-gray-500">
            ...
            <div v-if="filteredConversations.length === 0" class="py-8 text-center text-gray-500 dark:text-gray-400">
        ...
        <div v-if="hasMoreConversations" class="p-4 text-center">
            <button @click="loadMoreConversations" :disabled="loadingMore" class="btn btn-secondary btn-sm">
...
.conversation-item.selected {
    @apply border-r-2 border-blue-500 bg-blue-50 dark:bg-blue-900/20;
}
