    ...
    <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
        <div class="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-lg bg-white p-6">
            ...
            <form @submit.prevent="submitFeedback" class="space-y-6">
                <!-- Overall Rating -->
                <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700"> Overall Rating * </label>
                    <div class="flex space-x-2">
                        <button v-for="rating in 5" :key="rating" type="button" @click="form.overall_rating = rating" class="p-1">
                            <svg
                                class="h-8 w-8"
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div>
                        <label class="mb-2 block text-sm font-medium text-gray-700">Content Quality</label>
                        <div class="flex space-x-1">
                            <button v-for="rating in 5" :key="rating" type="button" @click="form.content_rating = rating" class="p-1">
                                <svg
                                    class="h-6 w-6"
                    ...
                    <div>
                        ...
                        <div class="flex space-x-1">
                            <button v-for="rating in 5" :key="rating" type="button" @click="form.organization_rating = rating" class="p-1">
                                <svg
                                    class="h-6 w-6"
                    ...
                    <div>
                        <label class="mb-2 block text-sm font-medium text-gray-700">Networking Opportunities</label>
                        <div class="flex space-x-1">
                            <button v-for="rating in 5" :key="rating" type="button" @click="form.networking_rating = rating" class="p-1">
                                <svg
                                    class="h-6 w-6"
                    ...
                    <div>
                        <label class="mb-2 block text-sm font-medium text-gray-700">Venue/Platform</label>
                        <div class="flex space-x-1">
                            <button v-for="rating in 5" :key="rating" type="button" @click="form.venue_rating = rating" class="p-1">
                                <svg
                                    class="h-6 w-6"
                ...
                <!-- Written Feedback -->
                <div>
                    <label for="feedback_text" class="mb-2 block text-sm font-medium text-gray-700"> Additional Comments </label>
                    <textarea
                        id="feedback_text"
                ...
                <div class="space-y-4">
                    <div class="flex items-center">
                        ...
                        />
                        <label for="would_recommend" class="ml-2 block text-sm text-gray-900"> I would recommend this event to other alumni </label>
                    </div>
                    ...
                    <div class="flex items-center">
                        <input
                            ...
                            class="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                        />
                        <label for="would_attend_again" class="ml-2 block text-sm text-gray-900"> I would attend similar events in the future </label>
                    </div>
                    ...
                    <div class="flex items-center">
                        <input
                            ...
                            class="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                        />
                        <label for="is_anonymous" class="ml-2 block text-sm text-gray-900"> Submit feedback anonymously </label>
                    </div>
                </div>

                <!-- Improvement Suggestions -->
                <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700"> Suggestions for Improvement </label>
                    <div class="space-y-2">
                        <div v-for="(suggestion, index) in form.improvement_suggestions" :key="index" class="flex items-center space-x-2">
                            ...
                            />
                            <button type="button" @click="removeSuggestion(index)" class="text-red-600 hover:text-red-800">
                        ...
                        <button type="button" @click="addSuggestion" class="text-sm text-blue-600 hover:text-blue-800">+ Add suggestion</button>
                    </div>
                </div>
