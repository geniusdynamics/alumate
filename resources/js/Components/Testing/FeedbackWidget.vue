<template>
    <div class="feedback-widget">
        ...
        <button
            ...
            class="fixed bottom-4 right-4 z-50 rounded-full bg-blue-600 p-3 text-white shadow-lg transition-all duration-200 hover:scale-105 hover:bg-blue-700"
        ...
        <div
            v-if="showWidget"
            class="fixed bottom-4 right-4 z-50 w-96 max-w-[calc(100vw-2rem)] rounded-lg border border-gray-200 bg-white shadow-xl dark:border-gray-700 dark:bg-gray-800"
        >
            <!-- Header -->
            <div class="flex items-center justify-between border-b border-gray-200 p-4 dark:border-gray-700">
                ...
                <button @click="closeWidget" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
            ...
            <div class="p-4">
                ...
                <div v-if="currentStep === 'type'" class="space-y-3">
                    <p class="text-sm text-gray-600 dark:text-gray-400">What type of feedback would you like to share?</p>
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <button
                            ...
                            class="rounded-lg border border-gray-200 p-3 text-left transition-colors hover:bg-gray-50 dark:border-gray-600 dark:hover:bg-gray-700"
                        >
                ...
                <div v-else-if="currentStep === 'form'" class="space-y-4">
                    ...
                    <div v-if="form.type === 'general_feedback'" class="space-y-2">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300"> How would you rate your experience? </label>
                ...
                <!-- Step 3: Success -->
                <div v-else-if="currentStep === 'success'" class="space-y-4 text-center">
                    ...
                    <div>
                        <h4 class="text-lg font-medium text-gray-900 dark:text-white">Thank you!</h4>
        ...
        <!-- Overlay -->
        <div v-if="showWidget" @click="closeWidget" class="fixed inset-0 z-40 bg-black bg-opacity-25"></div>
    </div>
</template>
