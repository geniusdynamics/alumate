                ...
                <form @submit.prevent="submitStory" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div class="md:col-span-2">
                            <label class="mb-2 block text-sm font-medium text-gray-700"> Story Title * </label>
                            <input
                                v-model="form.title"
                                type="text"
                                required
                        ...
                        <div class="md:col-span-2">
                            <label class="mb-2 block text-sm font-medium text-gray-700"> Summary * </label>
                            <textarea
                            ...
                            ></textarea>
                            <p class="mt-1 text-sm text-gray-500">{{ form.summary.length }}/500 characters</p>
                        </div>

                        <div>
                            <label class="mb-2 block text-sm font-medium text-gray-700"> Achievement Type * </label>
                            <select
                        ...
                        <div>
                            <label class="mb-2 block text-sm font-medium text-gray-700"> Current Role </label>
                            <input
                        ...
                        <div>
                            <label class="mb-2 block text-sm font-medium text-gray-700"> Current Company </label>
                            <input
                    ...
                    <!-- Story Content -->
                    <div>
                        <label class="mb-2 block text-sm font-medium text-gray-700"> Your Story * </label>
                        <textarea
                    ...
                    <div>
                        ...
                        <div class="rounded-lg border-2 border-dashed border-gray-300 p-6">
                            <input ref="featuredImageInput" type="file" accept="image/*" @change="handleFeaturedImageUpload" class="hidden" />
                            <div v-if="featuredImagePreview" class="mb-4">
                                <img :src="featuredImagePreview" alt="Preview" class="h-32 max-w-xs rounded-md object-cover" />
                                <button @click="removeFeaturedImage" type="button" class="mt-2 text-sm text-red-600 hover:text-red-800">
                                    Remove image
                                </button>
                            </div>
                            <div v-else class="text-center">
                                ...
                                <div class="mt-4">
                                    <button @click="$refs.featuredImageInput.click()" type="button" class="text-blue-600 hover:text-blue-500">
                    ...
                    <!-- Additional Media -->
                    <div>
                        <label class="mb-2 block text-sm font-medium text-gray-700"> Additional Media (Optional) </label>
                        <div class="rounded-lg border-2 border-dashed border-gray-300 p-6">
                            <input
                                ref="mediaFilesInput"
                                type="file"
                            ...
                            <div v-if="mediaFilePreviews.length > 0" class="mb-4">
                                <div class="grid grid-cols-2 gap-4 md:grid-cols-4">
                                    <div v-for="(preview, index) in mediaFilePreviews" :key="index" class="relative">
                                        <img
                                        ...
                                        />
                                        <div v-else class="flex h-20 w-full items-center justify-center rounded-md bg-gray-100">
                                            <span class="text-sm text-gray-600">{{ preview.name }}</span>
                                        </div>
                                        <button
                                            @click="removeMediaFile(index)"
                                            type="button"
                                            class="absolute -right-2 -top-2 flex h-6 w-6 items-center justify-center rounded-full bg-red-500 text-xs text-white"
                                        >
                                            ×
                                        </button>
                                    </div>
                            ...
                            <div class="text-center">
                                <button @click="$refs.mediaFilesInput.click()" type="button" class="text-blue-600 hover:text-blue-500">
                    ...
                    <div>
                        ...
                        <div class="mb-2 flex flex-wrap gap-2">
                            ...
                            >
                                #{{ tag }}
                                <button @click="removeTag(tag)" type="button" class="ml-2 text-blue-600 hover:text-blue-800">×</button>
                            </span>
                        </div>
                        <input
                            v-model="newTag"
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center">
                            ...
                            />
                            <label for="allow_sharing" class="ml-2 block text-sm text-gray-900"> Allow social media sharing </label>
                        </div>
