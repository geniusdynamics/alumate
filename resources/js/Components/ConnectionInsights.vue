            ...
            <div v-for="connection in connections" :key="connection.id" class="connection-card">
                ...
                <div class="connection-header">
                    <div class="avatar-container">
                        <img v-if="connection.avatar_url" :src="connection.avatar_url" :alt="connection.name" class="avatar" />
                ...
                <div class="connection-actions">
                    <button v-if="connection.can_request_introduction" @click="requestIntroduction(connection)" class="introduction-btn">
