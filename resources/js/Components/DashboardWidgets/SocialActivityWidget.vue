        ...
        <div class="space-y-4">
            ...
            <div v-else-if="activities.length > 0" class="space-y-4">
                <div
                    ...
                    :key="activity.id"
                    class="flex cursor-pointer items-start space-x-3 rounded-lg p-3 transition-colors hover:bg-gray-50 dark:hover:bg-gray-700/50"
                ...
                >
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <p v-if="activity.content" class="mt-1 line-clamp-2 text-sm text-gray-600 dark:text-gray-300">
                            {{ activity.content }}
                        </p>
                    </div>
                </div>
            ...
            <div v-else class="py-6 text-center">
                <ChatBubbleLeftRightIcon class="mx-auto mb-3 h-12 w-12 text-gray-300 dark:text-gray-600" />
                <p class="text-sm text-gray-500 dark:text-gray-400">No recent activity</p>
                <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">Connect with alumni to see their updates here</p>
            </div>
        </div>

        <!-- View All Link -->
        <div v-if="activities.length > 0" class="mt-4 border-t border-gray-200 pt-4 dark:border-gray-700">
            <Link
