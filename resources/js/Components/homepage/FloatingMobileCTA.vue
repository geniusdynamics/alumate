<template>
    ...
    >
        ...
        <div v-if="!isExpanded" class="cta-collapsed">
            <button class="cta-main-button" @click="handleMainCTAClick" :aria-label="primaryCTA.text">
                <component :is="getMainIcon()" class="cta-main-icon" />
                <span class="cta-main-text">{{ primaryCTA.text }}</span>
            </button>

            <!-- Expand button -->
            <button class="cta-expand-button" @click="toggleExpanded" aria-label="More options">
        ...
        <div v-else class="cta-expanded-content">
            <!-- Close button -->
            <button class="cta-close-button" @click="toggleExpanded" aria-label="Close options">
            ...
            <div class="expanded-options">
                ...
                <div class="option-buttons">
                    <button class="option-primary-button" @click="handleCTAClick(expandedContent.primaryCTA)">
                    ...
                    <button v-if="expandedContent.secondaryCTA" class="option-secondary-button" @click="handleCTAClick(expandedContent.secondaryCTA)">
                    ...
                    <button v-if="expandedContent.tertiaryCTA" class="option-tertiary-button" @click="handleCTAClick(expandedContent.tertiaryCTA)">
                ...
                <div class="mobile-trust-indicators" v-if="expandedContent.trustIndicators">
                    <div class="trust-item" v-for="indicator in expandedContent.trustIndicators" :key="indicator.text">
