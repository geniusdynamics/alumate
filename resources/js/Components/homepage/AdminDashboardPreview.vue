    ...
    <section class="admin-dashboard-preview">
        <div class="container mx-auto px-4">
            ...
            <div class="mb-12 text-center">
                <h2 class="mb-4 text-4xl font-bold text-gray-900">Powerful Admin Dashboard</h2>
                <p class="mx-auto max-w-3xl text-xl text-gray-600">
                    Comprehensive analytics and management tools designed for institutional administrators to drive alumni engagement and measure
                    success.
                </p>
            </div>
                    ...
                    <div class="dashboard-content">
                        ...
                        <div class="dashboard-header">
                            <div class="mb-6 flex items-center justify-between">
                                ...
                                <button @click="requestDemo" class="demo-cta-button" :aria-label="`Request demo for ${institutionName}`">
                                    Request Demo
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="metrics-grid">
                            <div v-for="metric in keyMetrics" :key="metric.id" class="metric-card" :class="{ 'animate-pulse': isLoading }">
                                <div class="metric-icon">
                                    <component :is="metric.icon" class="h-6 w-6" />
                                </div>
                                <div class="metric-content">
                                    <div class="metric-value">
                                        <AnimatedCounter :value="metric.value" :format="metric.format" :duration="1500" />
                                    </div>
                        ...
                        <div class="features-tabs mt-8">
                            ...
                            <div class="tab-content">
                                <div v-for="tab in featureTabs" :key="tab.id" v-show="activeTab === tab.id" class="tab-panel" role="tabpanel">
                                    <div class="feature-preview">
                                        ...
                                        <div class="feature-description">
                                            <h4 class="mb-3 text-xl font-semibold">{{ tab.title }}</h4>
                                            <p class="mb-4 text-gray-600">{{ tab.description }}</p>
                        ...
                        <div class="comparison-section mt-12">
                            <h4 class="mb-8 text-center text-2xl font-bold">Individual vs Institutional Features</h4>
                            <div class="comparison-table">
                                ...
                                <div v-for="feature in comparisonFeatures" :key="feature.id" class="comparison-row">
            ...
            <div class="demo-cta-section">
                <div class="cta-content">
                    <h3 class="mb-4 text-3xl font-bold text-white">Ready to Transform Your Alumni Engagement?</h3>
                    <p class="mx-auto mb-8 max-w-2xl text-xl text-blue-100">
                        Schedule a personalized demo to see how our institutional dashboard can increase alumni participation by up to 300%.
                    </p>
                    <div class="cta-buttons">
                        <button @click="requestDemo" class="primary-cta-button" :disabled="isRequestingDemo">
                            <span v-if="!isRequestingDemo">Request Live Demo</span>
                            <span v-else class="flex items-center">
                                <LoadingSpinner class="mr-2 h-5 w-5" />
                                Scheduling...
                            </span>
                        </button>
                        <button @click="downloadCaseStudies" class="secondary-cta-button">Download Case Studies</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Demo Request Modal -->
        <DemoRequestModal v-if="showDemoModal" @close="showDemoModal = false" @submit="handleDemoRequest" :institution-name="institutionName" />

        <!-- Hotspot Detail Modal -->
        <HotspotDetailModal v-if="selectedHotspot" :hotspot="selectedHotspot" @close="selectedHotspot = null" />
    </section>
</template>
...
const featureTabs = ref([
    ...
    },
    {
        ...
        benefits: ['CRM system integration', 'Email platform sync', 'Single sign-on (SSO)', 'API access', 'Data synchronization'],
        hotspots: [
