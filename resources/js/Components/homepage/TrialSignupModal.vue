        ...
        <div class="flex min-h-screen items-center justify-center p-4">
            ...
            <div class="relative mx-auto w-full max-w-md rounded-xl bg-white shadow-xl">
                ...
                <div class="flex items-center justify-between border-b border-gray-200 p-6">
                    <h3 class="text-xl font-semibold text-gray-900">Start Your Free Trial</h3>
                ...
                <div class="p-6">
                    <div class="mb-6">
                        <p class="mb-4 text-gray-600">Get full access to all professional features for 14 days. No credit card required.</p>

                        <!-- Trial Benefits -->
                        <div class="mb-6 rounded-lg bg-blue-50 p-4">
                            <h4 class="mb-3 font-medium text-blue-900">What's included:</h4>
                            <ul class="space-y-2 text-sm text-blue-800">
                                <li class="flex items-center">
                                    <CheckIcon class="mr-2 h-4 w-4 flex-shrink-0 text-blue-600" />
                    ...
                    <form @submit.prevent="handleSubmit" class="space-y-4">
                        ...
                        <div>
                            <label for="graduationYear" class="mb-1 block text-sm font-medium text-gray-700"> Graduation Year </label>
                            <input
                                id="graduationYear"
                        ...
                        <div>
                            <label for="institution" class="mb-1 block text-sm font-medium text-gray-700"> Institution </label>
                            <input
                                id="institution"
                        ...
                        <div>
                            <label for="currentRole" class="mb-1 block text-sm font-medium text-gray-700"> Current Role </label>
                            <input
                                id="currentRole"
                        ...
                        <div>
                            <label for="referralSource" class="mb-1 block text-sm font-medium text-gray-700"> How did you hear about us? </label>
                            <select
                                id="referralSource"
                        ...
                        <div class="flex items-start">
                            ...
                            <label for="terms" class="ml-2 text-sm text-gray-600">
                                I agree to the
                                <a href="/terms" target="_blank" class="text-blue-600 underline hover:text-blue-800"> Terms of Service </a>
                                and
                    ...
                    <!-- Success Message -->
                    <div v-if="showSuccess" class="mt-4 rounded-md border border-green-200 bg-green-50 p-4">
                        <div class="flex">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-green-700">Check your email for login instructions and next steps.</p>
                            </div>
                        </div>
                    </div>

                    <!-- Error Message -->
                    <div v-if="generalError" class="mt-4 rounded-md border border-red-200 bg-red-50 p-4">
                        <div class="flex">
                ...
                <div class="rounded-b-xl bg-gray-50 px-6 py-4">
                    <p class="text-center text-xs text-gray-500">Your trial will automatically expire after 14 days. No charges will be made.</p>
                </div>
            </div>
        </div>
    </div>
