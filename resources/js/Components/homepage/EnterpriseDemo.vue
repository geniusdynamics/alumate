<template>
    <div v-if="isOpen" class="fixed inset-0 z-50 overflow-y-auto" @click="handleBackdropClick">
        <div class="flex min-h-screen items-center justify-center p-4">
            ...
            <!-- Modal -->
            <div class="relative mx-auto w-full max-w-2xl rounded-xl bg-white shadow-xl">
                <!-- Header -->
                <div class="flex items-center justify-between border-b border-gray-200 p-6">
                    <div>
                        <h3 class="text-xl font-semibold text-gray-900">Request Enterprise Demo</h3>
                        <p class="mt-1 text-sm text-gray-600">See how our platform can transform your alumni engagement</p>
                    </div>
                ...
                <div class="p-6">
                    ...
                    <div class="mb-6 rounded-lg bg-gradient-to-r from-blue-50 to-indigo-50 p-6">
                        <h4 class="mb-4 font-semibold text-gray-900">What you'll see in your demo:</h4>
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div class="flex items-start">
                                <CheckIcon class="mr-3 mt-0.5 h-5 w-5 flex-shrink-0 text-blue-600" />
                                <div>
                    ...
                    <form @submit.prevent="handleSubmit" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div>
                                <label for="institutionName" class="mb-1 block text-sm font-medium text-gray-700"> Institution Name * </label>
                                <input
                                    id="institutionName"
                            ...
                            <div>
                                <label for="alumniCount" class="mb-1 block text-sm font-medium text-gray-700"> Alumni Count </label>
                                <select
                                    id="alumniCount"
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div>
                                <label for="contactName" class="mb-1 block text-sm font-medium text-gray-700"> Your Name * </label>
                                <input
                                    id="contactName"
                        ...
                        <!-- Current Solution -->
                        <div>
                            <label for="currentSolution" class="mb-1 block text-sm font-medium text-gray-700">
                        ...
                        <!-- Interests -->
                        <div>
                            <label class="mb-3 block text-sm font-medium text-gray-700"> Areas of Interest (select all that apply) </label>
                            <div class="grid grid-cols-2 gap-3 md:grid-cols-3">
                                <label v-for="interest in availableInterests" :key="interest.value" class="flex items-center">
                                    <input
                        ...
                        <!-- Preferred Demo Time -->
                        <div>
                            <label for="preferredTime" class="mb-1 block text-sm font-medium text-gray-700"> Preferred Demo Time </label>
                            <select
                                id="preferredTime"
                        ...
                        <!-- Additional Message -->
                        <div>
                            <label for="message" class="mb-1 block text-sm font-medium text-gray-700"> Additional Information </label>
                            <textarea
                                id="message"
                        ...
                        <button
                            ...
                            class="w-full rounded-md bg-blue-600 px-4 py-3 font-medium text-white transition-colors hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                        >
                    ...
                    <!-- Success Message -->
                    <div v-if="showSuccess" class="mt-6 rounded-md border border-green-200 bg-green-50 p-4">
                        <div class="flex">
                            <CheckCircleIcon class="mr-2 mt-0.5 h-5 w-5 flex-shrink-0 text-green-400" />
                            <div>
                    ...
                    <!-- Error Message -->
                    <div v-if="generalError" class="mt-6 rounded-md border border-red-200 bg-red-50 p-4">
                        <div class="flex">
                ...
                <div class="rounded-b-xl bg-gray-50 px-6 py-4">
                    <p class="text-center text-xs text-gray-500">
                        ...
                        <a href="/privacy" class="text-blue-600 underline hover:text-blue-800">Privacy Policy</a>
                    </p>
                </div>
            </div>
        </div>
...
<<<<<<< HEAD:resources/js/components/homepage/EnterpriseDemo.vue
import type { DemoRequestData } from '@/Types/homepage';
=======
import type { DemoRequestData } from '@/types/homepage';
>>>>>>> origin/db1:resources/js/Components/homepage/EnterpriseDemo.vue
