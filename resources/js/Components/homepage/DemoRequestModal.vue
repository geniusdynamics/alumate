        ...
        <div class="modal-content" @click.stop>
            ...
            <div class="modal-body">
                <p class="modal-description">
                    Schedule a personalized demo to see how {{ institutionName }} can benefit from our institutional alumni platform.
                </p>
                ...
                <form @submit.prevent="handleSubmit" class="demo-form">
                    ...
                    <div class="form-group">
                        ...
                        <input id="title" v-model="formData.title" type="text" class="form-input" placeholder="e.g., Alumni Relations Director" />
                    </div>

                    <div class="form-group">
                        <label for="phone" class="form-label">Phone Number</label>
                        <input id="phone" v-model="formData.phone" type="tel" class="form-input" placeholder="+1 (555) 123-4567" />
                    </div>

                    <div class="form-group">
                        <label for="alumniCount" class="form-label">Approximate Alumni Count</label>
                        <select id="alumniCount" v-model="formData.alumniCount" class="form-select">
                    ...
                    <div class="form-group">
                        ...
                        <select id="currentSolution" v-model="formData.currentSolution" class="form-select">
                    ...
                    <div class="form-group">
                        ...
                        <div class="checkbox-group">
                            <label v-for="interest in availableInterests" :key="interest.value" class="checkbox-label">
                                <input type="checkbox" :value="interest.value" v-model="formData.interests" class="checkbox-input" />
                    ...
                    <div class="form-group">
                        ...
                        <select id="preferredTime" v-model="formData.preferredTime" class="form-select">
                    ...
                    <div class="form-actions">
                        <button type="button" @click="$emit('close')" class="cancel-button" :disabled="isSubmitting">Cancel</button>
...
const isFormValid = computed(() => {
    return (
        formData.institutionName.trim() !== '' && formData.contactName.trim() !== '' && formData.email.trim() !== '' && isValidEmail(formData.email)
    );
});
...
.modal-content {
    @apply max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-lg bg-white shadow-xl;
}
...
.form-select,
.form-textarea {
    @apply w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm transition-colors focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500;
}
...
.form-actions {
    @apply flex justify-end space-x-3 border-t border-gray-200 pt-4;
}

.cancel-button {
    @apply rounded-md bg-gray-100 px-4 py-2 text-gray-700 transition-colors hover:bg-gray-200 disabled:opacity-50;
}

.submit-button {
    @apply rounded-md bg-blue-600 px-6 py-2 text-white transition-colors hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-50;
}
