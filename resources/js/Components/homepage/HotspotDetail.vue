<template>
    <div class="hotspot-detail">
        ...
        <div class="mb-4 flex items-center justify-between">
            ...
            <button @click="$emit('close')" class="rounded p-1 text-gray-400 transition-colors hover:text-gray-600" aria-label="Close hotspot detail">
        ...
        <div v-if="featureDetails" class="mb-6">
            <h4 class="mb-3 font-medium text-gray-900">Feature Details</h4>
            <div class="rounded-lg bg-blue-50 p-4">
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        <h5 class="mb-1 font-medium text-blue-900">{{ featureDetails.name }}</h5>
                        ...
                        <div v-if="featureDetails.benefits && featureDetails.benefits.length > 0" class="mt-3">
                            <ul class="space-y-1">
                                <li v-for="benefit in featureDetails.benefits" :key="benefit" class="flex items-start space-x-2">
        ...
        <div v-if="usageStats" class="mb-6">
            <h4 class="mb-3 font-medium text-gray-900">Usage Statistics</h4>
            <div class="grid grid-cols-2 gap-4">
                <div v-for="stat in usageStats" :key="stat.label" class="rounded-lg bg-gray-50 p-3 text-center">
        ...
        <div v-if="hotspot.action" class="mb-6">
            <h4 class="mb-3 font-medium text-gray-900">Try It Yourself</h4>
        ...
        <div v-if="relatedFeatures && relatedFeatures.length > 0" class="mb-6">
            <h4 class="mb-3 font-medium text-gray-900">Related Features</h4>
            <div class="space-y-2">
                <button
...
const featureDetails = computed((): FeatureDetail | null => {
    ...
    const featureMap: Record<string, FeatureDetail> = {
        ...
        jobs: {
            ...
            benefits: ['Alumni-exclusive job postings', 'Referral tracking system', 'Application status updates', 'Salary insights and benchmarks'],
        },
        events: {
            name: 'Alumni Events',
            description: 'Discover and attend networking events, webinars, and reunions.',
            benefits: ['Local and virtual events', 'RSVP and calendar integration', 'Event networking features', 'Post-event follow-up tools'],
        },
        mentorship: {
        ...
        search: {
            ...
            benefits: ['Multi-criteria search filters', 'Saved search preferences', 'Search result recommendations', 'Privacy-controlled visibility'],
        },
        profiles: {
            name: 'Professional Profiles',
            description: 'Comprehensive alumni profiles with career history and achievements.',
            benefits: ['Detailed career timelines', 'Skills and expertise showcase', 'Professional accomplishments', 'Contact preferences'],
        },
        navigation: {
            name: 'Mobile Navigation',
            description: 'Intuitive mobile interface optimized for on-the-go networking.',
            benefits: ['Touch-optimized interface', 'Offline functionality', 'Push notifications', 'Quick action shortcuts'],
        },
    };
