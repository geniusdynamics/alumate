<template>
    <Teleport to="body">
        <div v-if="isVisible" class="exit-intent-overlay" @click="handleOverlayClick">
            <div class="exit-intent-popup" @click.stop :class="{ 'popup-mobile': isMobile }">
                <!-- Close button -->
                <button class="close-button" @click="$emit('close')" aria-label="Close popup">
                ...
                <div class="popup-content">
                    ...
                    <div class="popup-actions">
                        <button class="primary-cta-button" @click="handlePrimaryCTA" :disabled="isProcessing">
                            <span v-if="!isProcessing">{{ popupContent.primaryCTA.text }}</span>
                            <span v-else class="loading-spinner">Processing...</span>
                        </button>

                        <button v-if="popupContent.secondaryCTA" class="secondary-cta-button" @click="handleSecondaryCTA">
