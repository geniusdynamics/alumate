...
<<<<<<< HEAD:resources/js/components/ComponentLibrary/Hero/HeroIndividual.vue
...
import type { HeroComponentConfig } from '@/types/Components';
import { abTestingService, heroABTestConfigs, useABTest } from '@/utils/abTesting';
>>>>>>> origin/db1:resources/js/Components/ComponentLibrary/Hero/HeroIndividual.vue
...
const { variant, trackEvent, trackConversion } = useABTest(baseConfig.value.abTest || { enabled: false }, props.userId);
