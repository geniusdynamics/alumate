<template>
    ...
    >
        ...
        <Icon v-if="config.style === 'arrow'" name="arrow-right" size="sm" class="cta-inline-link__arrow" aria-hidden="true" />
    </component>
</template>
...
.cta-inline-link--button-like {
    @apply rounded border border-blue-600 px-2 py-1 text-blue-600;
}
...
.cta-inline-link--external::after {
    content: '';
    @apply ml-1 inline-block h-3 w-3 opacity-75;
