    ...
    <article :class="testimonialClasses" role="article" :aria-labelledby="headingId">
        <div v-if="testimonial.content.type === 'video' && testimonial.content.videoAsset" class="relative mb-8">
            <ResponsiveVideo
                ...
                :poster="testimonial.content.videoAsset.thumbnail"
                ...
                :preload="config.videoSettings?.preload ?? 'metadata'"
                :lazy-load="config.lazyLoad ?? true"
        ...
        <div class="testimonial-content">
            <blockquote :class="quoteClasses" :cite="String(testimonial.content.id)">
                <svg
                    v-if="theme !== 'minimal'"
                    class="quote-icon w-8 h-8 text-gray-400 dark:text-gray-500 mb-4"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                >
            ...
            >
                <div class="flex space-x-1">
                    <svg
                        ...
                        :class="[
                            'w-5 h-5',
                            star <= testimonial.content.rating ? 'text-yellow-400 fill-current' : 'text-gray-300 dark:text-gray-600',
                        ]"
                        viewBox="0 0 20 20"
                        aria-hidden="true"
                    >
            ...
            <footer class="testimonial-author">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                            ...
                            <div v-if="config.showGraduationYear && testimonial.author.graduationYear" class="author-graduation">
                    ...
                    <div v-if="testimonial.content.verified" class="flex-shrink-0" title="Verified testimonial">
                        <svg class="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20" aria-label="Verified">
                            <path
                                fill-rule="evenodd"
                ...
                <div v-if="config.showDate && testimonial.content.dateCreated" class="mt-3 text-xs text-gray-500 dark:text-gray-400">
...
const showInteractionButtons = computed(() => {
    return Boolean(props.config.showInteractionButtons) && (
