        ...
        <div class="flex min-h-screen items-end justify-center px-4 pb-20 pt-4 text-center sm:block sm:p-0">
            ...
            >
                ...
                <div class="mb-4 flex items-center justify-between">
                    <h3 id="modal-title" class="text-lg font-medium text-gray-900 dark:text-white">Edit Field: {{ localField.label }}</h3>
                    <button
                        type="button"
                ...
                <div class="max-h-96 overflow-y-auto">
                    <FieldPropertiesEditor :field="localField" @update:field="updateField" />
                </div>
