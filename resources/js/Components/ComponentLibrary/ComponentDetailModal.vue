<template>
    <Teleport to="body">
        <div v-if="isOpen" class="fixed inset-0 z-50 overflow-y-auto" role="dialog" :aria-labelledby="modalTitleId" aria-modal="true">
            <!-- Backdrop -->
            <div class="fixed inset-0 bg-black bg-opacity-50 transition-opacity" @click="$emit('close')"></div>

            <!-- Modal -->
            <div class="flex min-h-full items-center justify-center p-4">
                <div class="relative max-h-[90vh] w-full max-w-4xl overflow-hidden rounded-lg bg-white shadow-xl dark:bg-gray-800" @click.stop>
                    <!-- Header -->
                    <div class="flex items-center justify-between border-b border-gray-200 p-6 dark:border-gray-700">
                                    ...
                                    <div class="flex items-center space-x-1">
                                        <div class="flex items-center">
                                            <Icon
                                                ...
                                                :class="[
                                                    'h-4 w-4',
                                                    star <= Math.floor(rating.average) ? 'text-yellow-400' : 'text-gray-300 dark:text-gray-600',
                                                ]"
                                            />
                                        </div>
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            >
                                <Icon :name="isFavorite ? 'heart-solid' : 'heart'" class="h-5 w-5" />
                            </button>
                            <button
                                @click="$emit('close')"
                    ...
                    <div class="max-h-[calc(90vh-120px)] overflow-y-auto">
                        <div class="p-6">
                            <!-- Component Preview -->
                            <div class="mb-8">
                                <h3 class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Preview</h3>
                                <div class="relative aspect-video overflow-hidden rounded-lg bg-gray-100 dark:bg-gray-800">
                                    ...
                                    <!-- Preview Actions -->
                                    <div
                                        class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-0 opacity-0 transition-all duration-300 hover:bg-opacity-40 hover:opacity-100"
                                    >
                                        <button
                                            @click="$emit('preview', component)"
                                            class="rounded-md bg-white px-6 py-3 font-medium text-gray-900 transition-colors hover:bg-gray-100"
                                        >
                                            <Icon name="eye" class="mr-2 h-5 w-5" />
                                            Live Preview
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div v-if="activeTab === 'overview'" class="space-y-6">
                                    <!-- Description -->
                                    <div>
                                        <h4 class="text-md mb-3 font-semibold text-gray-900 dark:text-white">Description</h4>
                                    ...
                                    <!-- Key Features -->
                                    <div>
                                        <h4 class="text-md mb-3 font-semibold text-gray-900 dark:text-white">Key Features</h4>
                                        <ul class="space-y-2">
                                            <li v-for="feature in getKeyFeatures()" :key="feature" class="flex items-start space-x-2">
                                                <Icon name="check" class="mt-0.5 h-4 w-4 flex-shrink-0 text-green-500" />
                                    ...
                                    <!-- Best Practices -->
                                    <div>
                                        <h4 class="text-md mb-3 font-semibold text-gray-900 dark:text-white">Best Practices</h4>
                                        <ul class="space-y-2">
                                            <li v-for="practice in documentation.bestPractices" :key="practice" class="flex items-start space-x-2">
                                                <Icon name="light-bulb" class="mt-0.5 h-4 w-4 flex-shrink-0 text-yellow-500" />
                                ...
                                <div v-if="activeTab === 'configuration'" class="space-y-6">
                                    <!-- Properties -->
                                    <div>
                                        <h4 class="text-md mb-3 font-semibold text-gray-900 dark:text-white">Configuration Properties</h4>
                                        <div class="rounded-lg bg-gray-50 p-4 dark:bg-gray-900">
                                            <dl class="space-y-3">
                                                ...
                                                >
                                                    <dt class="font-mono text-sm text-indigo-600 sm:w-1/3 dark:text-indigo-400">
                                                        {{ property }}
                                                    </dt>
                                                    <dd class="text-sm text-gray-600 sm:w-2/3 dark:text-gray-400">
                                                        {{ description }}
                                                    </dd>
                                                </div>
                                            </dl>
                                    ...
                                    <div>
                                        <h4 class="text-md mb-3 font-semibold text-gray-900 dark:text-white">Current Configuration</h4>
                                        <div class="rounded-lg bg-gray-50 p-4 dark:bg-gray-900">
                                            <pre class="overflow-x-auto text-sm text-gray-600 dark:text-gray-400">{{
                                ...
                                <div v-if="activeTab === 'analytics'" class="space-y-6">
                                    ...
                                    <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                                        <div class="rounded-lg bg-gray-50 p-4 text-center dark:bg-gray-900">
                                            <div class="mb-2 text-2xl font-bold text-blue-600 dark:text-blue-400">
                                                {{ formatUsageCount(usageStats.totalUsage) }}
                                            </div>
                                            <div class="text-sm text-gray-600 dark:text-gray-400">Total Uses</div>
                                        </div>
                                        <div class="rounded-lg bg-gray-50 p-4 text-center dark:bg-gray-900">
                                        ...
                                        <div class="rounded-lg bg-gray-50 p-4 text-center dark:bg-gray-900">
                                            ...
                                            <div class="text-sm text-gray-600 dark:text-gray-400">Recent Uses</div>
                                        </div>
                                    </div>

                                    <!-- Rating Distribution -->
                                    <div>
                                        <h4 class="text-md mb-3 font-semibold text-gray-900 dark:text-white">Rating Distribution</h4>
                                        <div class="space-y-2">
                                            <div v-for="(count, stars) in rating.distribution" :key="stars" class="flex items-center space-x-3">
                                                ...
                                                <span class="w-8 text-sm text-gray-600 dark:text-gray-400">{{ count }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div v-if="activeTab === 'accessibility'" class="space-y-6">
                                    ...
                                    <div>
                                        <h4 class="text-md mb-3 font-semibold text-gray-900 dark:text-white">Accessibility Features</h4>
                                        <ul class="space-y-2">
                                            <li v-for="feature in documentation.accessibility" :key="feature" class="flex items-start space-x-2">
                                                <Icon name="check" class="mt-0.5 h-4 w-4 flex-shrink-0 text-green-500" />
                                                <span class="text-gray-600 dark:text-gray-400">{{ feature }}</span>
                                            </li>
                                        </ul>
                                    ...
                                    <!-- WCAG Compliance -->
                                    <div>
                                        <h4 class="text-md mb-3 font-semibold text-gray-900 dark:text-white">WCAG 2.1 Compliance</h4>
                                    ...
                                    <!-- Testing Tools -->
                                    <div>
                                        <h4 class="text-md mb-3 font-semibold text-gray-900 dark:text-white">Recommended Testing Tools</h4>
                                        <ul class="space-y-2">
                                            <li class="flex items-start space-x-2">
                                                <Icon name="wrench" class="mt-0.5 h-4 w-4 flex-shrink-0 text-blue-500" />
                    ...
                    <!-- Footer -->
                    <div class="flex items-center justify-between border-t border-gray-200 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-900">
                        ...
                        <div class="flex space-x-3">
                            <button
                                @click="$emit('preview', component)"
                                class="rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
                            >
