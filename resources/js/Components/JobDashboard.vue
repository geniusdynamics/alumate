    ...
    <div class="job-dashboard">
        ...
        <div class="dashboard-header">
            <div class="header-content">
                ...
                <p class="dashboard-subtitle">Discover opportunities through your alumni network</p>
            </div>
        ...
        <div class="filters-section">
            <div class="filters-row">
                <div class="filter-group">
                    ...
                    <input v-model="filters.location" type="text" placeholder="Enter city or remote" class="filter-input" @input="debouncedSearch" />
                </div>
                ...
                <div class="filter-group">
                    <label class="filter-checkbox">
                        <input v-model="filters.remoteOnly" type="checkbox" @change="searchJobs" />
        ...
        <div v-else-if="jobs.length > 0" class="jobs-container">
            <div class="jobs-grid">
                <JobCard v-for="job in jobs" :key="job.id" :job="job" @view-details="viewJobDetails" @apply="handleApply" />
            </div>

            <!-- Load More Button -->
            <div v-if="hasMoreJobs" class="load-more-container">
                <button @click="loadMoreJobs" :disabled="loadingMore" class="load-more-btn">
