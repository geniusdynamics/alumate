        ...
        <div class="mx-4 max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-lg bg-white shadow-xl">
            <div class="p-6">
                ...
                <form @submit.prevent="createCampaign" class="space-y-6">
                    <!-- Basic Information -->
                    <div>
                        <label class="mb-2 block text-sm font-medium text-gray-700"> Campaign Title * </label>
                        <input
                            v-model="form.title"
                            type="text"
                            required
                    ...
                    <div>
                        <label class="mb-2 block text-sm font-medium text-gray-700"> Campaign Story </label>
                        <textarea
                            v-model="form.story"
                            rows="4"
                            class="w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div>
                            <label class="mb-2 block text-sm font-medium text-gray-700"> Goal Amount ($) * </label>
                            <input
                        ...
                        <div>
                            <label class="mb-2 block text-sm font-medium text-gray-700"> Campaign Type * </label>
                            <select
                                v-model="form.type"
                                required
                                class="w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-3">
                            <label class="flex items-center">
                                ...
                                />
                                <span class="ml-2 text-sm text-gray-700"> Allow peer-to-peer fundraising </span>
                            </label>
                            ...
                            <label class="flex items-center">
                                <input
                                    ...
                                    class="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                                />
                                <span class="ml-2 text-sm text-gray-700"> Show donor names publicly </span>
                            </label>
                            ...
                            <label class="flex items-center">
                                <input
                                    ...
                                    class="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                                />
                                <span class="ml-2 text-sm text-gray-700"> Allow anonymous donations </span>
                            </label>
                        </div>
                    </div>
                    ...
                    <!-- Thank You Message -->
                    <div>
                        <label class="mb-2 block text-sm font-medium text-gray-700"> Thank You Message </label>
                        <textarea
                    ...
                    <!-- Media URLs -->
                    <div>
                        <label class="mb-2 block text-sm font-medium text-gray-700"> Campaign Images </label>
                        <div class="space-y-2">
                            <input
                            ...
                            />
                            <button type="button" @click="addMediaUrl" class="text-sm font-medium text-blue-600 hover:text-blue-700">
                                + Add Image URL
                            </button>
                        </div>
                    </div>
