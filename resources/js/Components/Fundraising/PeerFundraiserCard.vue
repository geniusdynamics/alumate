    ...
    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
        <div class="mb-4 flex items-start justify-between">
            ...
            <div class="text-right">
                <div class="text-lg font-bold text-gray-900">${{ formatAmount(fundraiser.raised_amount) }}</div>
                <div v-if="fundraiser.goal_amount" class="text-sm text-gray-500">of ${{ formatAmount(fundraiser.goal_amount) }}</div>
            </div>
        </div>

        <p v-if="fundraiser.personal_message" class="mb-4 line-clamp-3 text-sm text-gray-700">
        ...
        <div v-if="fundraiser.goal_amount" class="mb-4">
            <div class="mb-2 flex items-center justify-between">
                ...
                <span class="text-sm font-medium text-gray-900"> {{ Math.round(fundraiser.progress_percentage) }}% </span>
            </div>
            ...
            <div class="mx-4 w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
                ...
                <div class="space-y-3">
                    <button
                        ...
                        class="flex w-full items-center justify-center rounded-md bg-blue-600 px-4 py-2 text-white hover:bg-blue-700"
                    >
                    ...
                    <button
                        ...
                        class="flex w-full items-center justify-center rounded-md bg-blue-400 px-4 py-2 text-white hover:bg-blue-500"
                    >
                        <svg class="mr-2 h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                            <path
                    ...
                    <button
                        ...
                        class="flex w-full items-center justify-center rounded-md bg-blue-700 px-4 py-2 text-white hover:bg-blue-800"
                    >
                        <svg class="mr-2 h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                            <path
                    ...
                    <div class="border-t pt-3">
                        <label class="mb-2 block text-sm font-medium text-gray-700">Share Link</label>
                        <div class="flex">
                            <input
                                ref="shareUrlInput"
                                :value="shareUrl"
                                readonly
                                class="flex-1 rounded-l-md border border-gray-300 px-3 py-2 text-sm"
                            />
                            <button
                                @click="copyShareUrl"
                                class="rounded-r-md border border-l-0 border-gray-300 bg-gray-100 px-3 py-2 text-sm font-medium hover:bg-gray-200"
                            >
                                Copy
                            </button>
                        </div>
