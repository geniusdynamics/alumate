<template>
    <div class="recurring-donation-manager">
        <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div v-else-if="recurringDonations.length === 0" class="py-8 text-center">
            ...
            <div v-else class="space-y-4">
                <div
                    ...
                    :key="donation.id"
                    class="rounded-lg border border-gray-200 p-4 transition-shadow hover:shadow-sm"
                >
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <div class="flex items-center space-x-3">
                                ...
                                <span :class="['rounded-full px-2 py-1 text-xs font-medium', getStatusColor(donation.status)]">
                            ...
                            <div v-if="donation.status === 'cancelled' && donation.cancellation_reason" class="mt-2">
                                <span class="text-sm text-gray-500"> <strong>Cancelled:</strong> {{ donation.cancellation_reason }} </span>
                            </div>
                        </div>
                        ...
                        <div class="ml-4 flex space-x-2">
                            <button
                                ...
                                class="rounded-md bg-yellow-100 px-3 py-1 text-sm font-medium text-yellow-700 transition-colors hover:bg-yellow-200 disabled:opacity-50"
                            >
                            ...
                            <button
                                ...
                                :disabled="processingId === donation.id"
                                class="rounded-md bg-red-100 px-3 py-1 text-sm font-medium text-red-700 transition-colors hover:bg-red-200 disabled:opacity-50"
                            >
                                Cancel
                            </button>
        ...
        <div v-if="showingCancelModal" class="fixed inset-0 z-50 h-full w-full overflow-y-auto bg-gray-600 bg-opacity-50" @click="closeCancelModal">
            <div class="relative top-20 mx-auto w-96 rounded-md border bg-white p-5 shadow-lg" @click.stop>
                <div class="mt-3">
                    <h3 class="mb-4 text-lg font-medium text-gray-900">Cancel Recurring Donation</h3>
                    ...
                    <div class="mb-4">
                        <label class="mb-2 block text-sm font-medium text-gray-700"> Reason for cancellation (optional) </label>
                        <textarea
