    ...
    <div class="rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="p-6">
            <div class="mb-6 flex items-center justify-between">
                <div>
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Calendar Integration</h3>
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Connect your calendars to sync events and manage availability</p>
                </div>
                <button
                    @click="refreshConnections"
                    :disabled="loading"
                    class="inline-flex items-center rounded-md border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
                >
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-2">
                                <button
                                    ...
                                    :disabled="loading"
                                    class="inline-flex items-center rounded border border-transparent bg-blue-600 px-3 py-1.5 text-xs font-medium text-white hover:bg-blue-700 disabled:opacity-50"
                                >
                                    Connect
                                </button>
                                <template v-else>
                                    <button
                                        ...
                                        :disabled="loading"
                                        class="inline-flex items-center rounded border border-gray-300 bg-white px-3 py-1.5 text-xs font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
                                    >
                                        Sync
                                    </button>
                                    <button
                                        ...
                                        :disabled="loading"
                                        class="inline-flex items-center rounded border border-red-300 bg-red-50 px-3 py-1.5 text-xs font-medium text-red-700 hover:bg-red-100 disabled:opacity-50"
                                    >
                                        Disconnect
                                    </button>
                                </template>
                            ...
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    <svg class="h-8 w-8" viewBox="0 0 24 24">
                                        <path
                                            fill="#0078D4"
                                            d="M7 3a4 4 0 00-4 4v10a4 4 0 004 4h10a4 4 0 004-4V7a4 4 0 00-4-4H7zm5 2h5a2 2 0 012 2v10a2 2 0 01-2 2h-5V5zm-2 2v12H7a2 2 0 01-2-2V7a2 2 0 012-2h3z"
                                        />
                                    </svg>
                                </div>
                                <div class="ml-3">
            ...
            <div v-if="connections.length > 0" class="mt-6">
                <h4 class="text-md mb-4 font-medium text-gray-900 dark:text-white">Recent Activity</h4>
                <div class="space-y-3">
                    <div
