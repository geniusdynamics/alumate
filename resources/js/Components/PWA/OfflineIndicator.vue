<template>
    <Teleport to="body">
        ...
        >
            <div
                v-if="showIndicator"
                :class="['fixed left-0 right-0 top-0 z-50 px-4 py-3 text-center text-sm font-medium shadow-lg', indicatorClasses]"
            >
                <div class="flex items-center justify-center space-x-2">
                    ...
                    <!-- Close Button -->
                    <button v-if="dismissible" @click="handleDismiss" class="ml-2 rounded-full p-1 hover:bg-white/20">
