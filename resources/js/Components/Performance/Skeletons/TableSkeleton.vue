    ...
    <div class="table-skeleton">
        ...
        <div class="table-content-skeleton">
            ...
            <div class="table-headers-skeleton">
                <div v-for="i in columns" :key="i" class="table-header-cell-skeleton skeleton-item"></div>
            </div>

            <!-- Table Rows -->
            <div class="table-rows-skeleton">
                <div v-for="i in rows" :key="i" class="table-row-skeleton" :class="{ 'table-row-alternate': i % 2 === 0 }">
                    <div v-for="j in columns" :key="j" class="table-cell-skeleton skeleton-item" :class="getCellClass(j)"></div>
                </div>
            </div>
        </div>
        ...
        <div class="table-footer-skeleton">
            ...
            <div class="pagination-controls-skeleton">
                ...
                <div class="pagination-numbers-skeleton">
                    <div v-for="i in 3" :key="i" class="pagination-number-skeleton skeleton-item"></div>
                </div>
                <div class="pagination-button-skeleton skeleton-item"></div>
            </div>
        </div>
...
.table-headers-skeleton {
    @apply grid gap-4 border-b border-gray-200 bg-gray-50 px-6 py-4 dark:border-gray-600 dark:bg-gray-700;
...
.table-footer-skeleton {
    @apply flex items-center justify-between border-t border-gray-200 bg-gray-50 px-6 py-4 dark:border-gray-700 dark:bg-gray-700;
}
