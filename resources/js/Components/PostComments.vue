<template>
    <div class="post-comments">
        <!-- Comment Form -->
        <div class="mb-4">
            <CommentForm :post-id="postId" @submitted="handleCommentSubmitted" placeholder="Write a comment..." />
        </div>
        ...
        <!-- Load More Comments -->
        <div v-if="hasMoreComments" class="mt-4 text-center">
            <button @click="loadMoreComments" :disabled="loadingMore" class="text-sm font-medium text-blue-500 hover:text-blue-600">
        ...
        <!-- Loading State -->
        <div v-if="loading && comments.length === 0" class="py-4 text-center">
            <i class="fas fa-spinner fa-spin text-gray-400"></i>
        </div>

        <!-- Empty State -->
        <div v-if="!loading && comments.length === 0" class="py-4 text-center text-gray-500">No comments yet. Be the first to comment!</div>
    </div>
</template>
