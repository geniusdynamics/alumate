    ...
    <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div class="mb-6 rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700">Expertise Area</label>
                    <select
                ...
                <!-- Availability Filter -->
                <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700">Availability</label>
                    <select
            ...
            <div class="mt-4 flex items-center justify-between">
                ...
                <span class="text-sm text-gray-500"> {{ mentors.length }} mentor{{ mentors.length !== 1 ? 's' : '' }} found </span>
            </div>
        </div>
        ...
        <!-- Mentors Grid -->
        <div v-else-if="mentors.length > 0" class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            <MentorCard v-for="mentor in mentors" :key="mentor.id" :mentor="mentor" @request-mentorship="handleMentorshipRequest" />
        </div>
