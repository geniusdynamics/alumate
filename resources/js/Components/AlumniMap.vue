    ...
    <div class="alumni-map-container">
        ...
        <div class="map-controls">
            <div class="control-group">
                ...
                <select id="view-mode" v-model="viewMode" class="control-select" @change="handleViewModeChange">
            ...
            <div class="control-group">
                ...
                <select id="privacy-filter" v-model="privacyFilter" class="control-select" @change="applyFilters">
            ...
            <button @click="toggleFilters" class="filter-toggle-btn" :aria-expanded="showFilters" aria-controls="map-filters">
        ...
        <div id="map-filters" v-show="showFilters" class="filters-panel" :aria-hidden="!showFilters">
            <div class="filters-grid">
                <div class="filter-group">
                    <label for="graduation-year" class="filter-label">Graduation Year:</label>
                    <select id="graduation-year" v-model="filters.graduation_year" class="filter-select" @change="applyFilters">
                ...
                <div class="filter-group">
                    ...
                    <select id="school-filter" v-model="filters.school_id" class="filter-select" @change="applyFilters">
                ...
                <div class="filter-group">
                    ...
                    <select id="industry-filter" v-model="filters.industry" class="filter-select" @change="applyFilters">
                ...
                <div class="filter-group">
                    ...
                    <select id="country-filter" v-model="filters.country" class="filter-select" @change="applyFilters">
            ...
            <div class="filter-actions">
                ...
                <button @click="showFilters = false" class="btn-primary">Apply & Close</button>
            </div>
        </div>

        <!-- Map Container -->
        <div ref="mapContainer" class="map-container" role="application" aria-label="Interactive alumni location map">
        ...
        <!-- Alumni Info Panel -->
        <div v-if="selectedAlumni" class="alumni-info-panel" role="dialog" aria-labelledby="alumni-info-title">
            <div class="panel-header">
                <h3 id="alumni-info-title">{{ selectedAlumni.name }}</h3>
                <button @click="selectedAlumni = null" class="close-btn" aria-label="Close alumni information panel">
            ...
            <div class="panel-content">
                <div class="alumni-avatar">
                    <img :src="selectedAlumni.avatar_url || '/images/default-avatar.png'" :alt="selectedAlumni.name" class="avatar-image" />
                </div>
                ...
                <div class="alumni-details">
                    ...
                    <p v-if="selectedAlumni.location" class="alumni-location">📍 {{ selectedAlumni.location }}</p>
                </div>

                <div class="panel-actions">
                    <button @click="viewProfile(selectedAlumni)" class="btn-primary">View Profile</button>
                    <button @click="sendMessage(selectedAlumni)" class="btn-secondary">Send Message</button>
                </div>
            </div>
        </div>
