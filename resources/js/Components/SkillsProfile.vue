<template>
    <div class="skills-profile">
        <div class="skills-header">
            ...
            <button @click="showAddSkillModal = true" class="btn-primary" v-if="isOwnProfile">Add Skill</button>
        </div>
            ...
            <div class="skills-grid">
                <div v-for="skill in filteredSkills" :key="skill.id" class="skill-card">
                    ...
                    <div class="skill-details">
                        <div class="experience">{{ skill.years_experience }} years experience</div>
                    ...
                    <div class="skill-endorsements" v-if="skill.endorsements.length > 0">
                        <div class="endorsement-preview">
                            ...
                            >
                                <img :src="endorsement.endorser.avatar_url" :alt="endorsement.endorser.name" class="h-6 w-6 rounded-full" />
                            </div>
                            <button v-if="skill.endorsements.length > 3" @click="showEndorsements(skill)" class="more-endorsements">
                    ...
                    <div class="skill-actions" v-if="!isOwnProfile">
                        <button @click="endorseSkill(skill)" class="btn-secondary btn-sm" :disabled="hasEndorsed(skill)">
            ...
            <div class="modal-content" @click.stop>
                ...
                <form @submit.prevent="addSkill">
                    ...
                    <div class="form-group">
                        ...
                        <input v-model.number="newSkill.years_experience" type="number" min="0" max="50" class="form-input" />
                    </div>

                    <div class="modal-actions">
                        <button type="button" @click="showAddSkillModal = false" class="btn-secondary">Cancel</button>
        ...
        <div v-if="showEndorsementsModal" class="modal-overlay" @click="showEndorsementsModal = false">
            <div class="modal-content" @click.stop>
                ...
                <div class="endorsements-list">
                    <div v-for="endorsement in selectedSkillForEndorsements?.endorsements" :key="endorsement.id" class="endorsement-item">
                        <img :src="endorsement.endorser.avatar_url" :alt="endorsement.endorser.name" class="h-10 w-10 rounded-full" />
                        <div class="endorsement-content">
                            <div class="endorser-name">{{ endorsement.endorser.name }}</div>
                            <div class="endorsement-message" v-if="endorsement.message">"{{ endorsement.message }}"</div>
                ...
                <div class="modal-actions">
                    <button @click="showEndorsementsModal = false" class="btn-primary">Close</button>
                </div>
            </div>
        </div>
    </div>
...
.category-tab {
    @apply whitespace-nowrap rounded-full px-4 py-2 text-sm font-medium;
...
.skill-card {
    @apply rounded-lg border bg-white p-4 transition-shadow hover:shadow-md;
}
...
.skill-details {
    @apply mb-3 space-y-1 text-sm text-gray-600;
}
...
.endorsements-list {
    @apply max-h-96 space-y-4 overflow-y-auto;
}
...
.endorsement-message {
    @apply mt-1 italic text-gray-700;
}
