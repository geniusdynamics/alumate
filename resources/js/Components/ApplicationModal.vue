                ...
                <div class="modal-content">
                    ...
                    <div class="job-summary">
                        <div class="company-info">
                            <div class="company-logo">
                                <img v-if="job.company?.logo_url" :src="job.company.logo_url" :alt="job.company.name" class="logo-image" />
                    ...
                    <div class="form-section">
                        ...
                        <textarea
                            ...
                            required
                        ></textarea>
                        <div class="character-count">{{ form.coverLetter.length }}/2000 characters</div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="file-upload-area">
                            ...
                            <div v-if="!form.resume" class="upload-placeholder">
                                ...
                                <p class="upload-text">Click to upload your resume or drag and drop</p>
                            ...
                            <div v-else class="uploaded-file">
                                ...
                                <button type="button" @click="removeResume" class="remove-file-btn">
                                    <Icon name="x" />
                                </button>
                            </div>
                        </div>
                    ...
                    <div v-if="job.mutual_connections && job.mutual_connections.length > 0" class="form-section">
                        <label class="form-label"> Request Introduction (Optional) </label>
                        <p class="form-hint">
                            You have {{ job.mutual_connections.length }} mutual connection{{ job.mutual_connections.length > 1 ? 's' : '' }} at
                            {{ job.company?.name }}. Would you like to request an introduction?
                        </p>
                        ...
                        <div class="connections-list">
                            ...
                            >
                                <input type="radio" :value="connection.id" v-model="form.introductionContactId" class="connection-radio" />
                                <div class="connection-avatar">
                                    <img v-if="connection.avatar_url" :src="connection.avatar_url" :alt="connection.name" class="avatar-image" />
...
const isFormValid = computed(() => {
    return form.coverLetter.trim().length > 0 && form.coverLetter.length <= 2000;
});
