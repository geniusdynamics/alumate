...
.skip-link {
    @apply absolute -top-10 left-4 rounded bg-blue-600 px-4 py-2 text-white;
    @apply z-50 transition-all duration-200 focus:top-4;
}
.homepage-main {
    @apply flex-1;
}
.homepage-footer {
    @apply bg-gray-900 py-8 text-white;
}
.footer-content {
