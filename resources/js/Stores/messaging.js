...
export const useMessagingStore = defineStore('messaging', () => {
    ...
    const pinnedConversations = computed(() => conversations.value.filter((c) => c.is_pinned));

    const directConversations = computed(() => conversations.value.filter((c) => c.type === 'direct'));

    const groupConversations = computed(() => conversations.value.filter((c) => c.type === 'group' || c.type === 'circle'));
