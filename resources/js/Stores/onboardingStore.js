        ...
        graduate: [
            {
                ...
                icon: 'rocket',
                tips: ['Your dashboard is your home base for all alumni activities', 'Check back regularly for new opportunities and connections'],
            },
            {
                id: 'social-timeline',
            ...
            },
            {
                ...
                tips: ['Keep your career timeline updated', 'Set SMART goals for career advancement', 'Celebrate your achievements'],
            },
            {
                id: 'events',
                title: 'Stay Engaged',
                ...
                icon: 'calendar',
                tips: ['RSVP early for popular events', 'Network actively during events', 'Follow up with new connections after events'],
            },
            {
                ...
                icon: 'academic',
                tips: ['Add a professional photo', 'Write a compelling bio', 'Keep your information current'],
            },
        ],
        employer: [
            {
            ...
            },
            {
                ...
                icon: 'briefcase',
                tips: ['Highlight your company culture', 'Mention alumni referral bonuses', 'Use clear, inclusive language'],
            },
            {
                id: 'candidate-search',
                ...
                icon: 'users',
                tips: ['Use advanced filters for precise targeting', 'Reach out through mutual connections', 'Personalize your outreach messages'],
            },
            {
                id: 'company-profile',
                ...
                icon: 'heart',
                tips: ['Showcase your company culture', 'Highlight alumni success stories', 'Keep your information updated'],
            },
        ],
        'institution-admin': [
            {
            ...
            },
            {
                ...
                icon: 'users',
                tips: ['Keep alumni data current', 'Use bulk import for efficiency', 'Respect privacy preferences'],
            },
            {
                id: 'engagement-tools',
                ...
                icon: 'heart',
                tips: ['Create regular touchpoints', 'Segment your communications', 'Track engagement metrics'],
            },
            {
                id: 'analytics',
                title: 'Track Success',
                ...
                icon: 'chart',
                tips: ['Set clear KPIs', 'Regular reporting cycles', 'Use data to improve programs'],
            },
        ],
        student: [
            {
            ...
            },
            {
                ...
                icon: 'trophy',
                tips: ['Filter stories by industry', 'Take notes on career paths', 'Reach out to alumni for advice'],
            },
            {
                id: 'mentorship',
                title: 'Find a Mentor',
                ...
                icon: 'academic',
                tips: ['Be specific about your goals', 'Come prepared to meetings', 'Show appreciation for their time'],
            },
            {
                id: 'career-guidance',
                ...
                icon: 'chart',
                tips: ['Explore different career paths', 'Build relevant skills early', 'Network before you need it'],
            },
        ],
    };
