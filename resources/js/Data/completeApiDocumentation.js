...
const timeline = await response.json();`,
            ...
            },
            {
                ...
                parameters: [{ name: 'post', type: 'integer', required: true, description: 'Post ID', location: 'path' }],
                responses: {
                    200: {
    ...
    alumni: {
        ...
        endpoints: [
            ...
            },
            {
                ...
                parameters: [{ name: 'userId', type: 'integer', required: true, description: 'User ID to connect with', location: 'path' }],
                requestBody: {
                    contentType: 'application/json',
                    example: {
...
$timeline = app('alumni-platform')->posts()->getTimeline();`,
    ...
    python: {
        ...
        setupPy: {
            ...
            install_requires: ['requests>=2.28.0', 'websocket-client>=1.6.0', 'pydantic>=2.0.0'],
        },
