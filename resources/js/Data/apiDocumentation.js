...
timeline = response.json()`,
            ...
            },
            {
                ...
                requestBody: {
                    ...
                    example: {
                        content:
                            'Excited to share my new role as Senior Developer at TechCorp! Looking forward to working with amazing technologies.',
                        post_type: 'career_update',
                        visibility: 'public',
                ...
                parameters: [
                    { name: 'content', type: 'string', required: true, description: 'Post content (max 5000 characters)' },
                    {
                        ...
                        type: 'string',
                        required: false,
                        description: 'Type of post (text, career_update, achievement, milestone)',
                        default: 'text',
                    },
                    {
                        name: 'visibility',
                        type: 'string',
                        required: false,
                        description: 'Post visibility (public, circles, groups, private)',
                        default: 'public',
                    },
            ...
            },
            {
                ...
                parameters: [
                    { name: 'post', type: 'integer', required: true, description: 'Post ID', location: 'path' },
                    {
                        ...
                        type: 'string',
                        required: true,
                        description: 'Type of reaction (like, love, celebrate, support, insightful)',
                    },
                ],
                requestBody: {
                    contentType: 'application/json',
    ...
    events: {
        ...
        endpoints: [
            ...
            },
            {
                ...
                parameters: [{ name: 'event', type: 'integer', required: true, description: 'Event ID', location: 'path' }],
                requestBody: {
                    contentType: 'application/json',
                    example: {
        ...
        endpoints: [
            {
                ...
                parameters: [
                    ...
                    { name: 'category', type: 'string', required: false, description: 'Campaign category (scholarship, infrastructure, research)' },
                    {
                        ...
                        type: 'string',
                        required: false,
                        description: 'Sort by (created_at, goal_amount, raised_amount)',
                        default: 'created_at',
                    },
                ],
                responses: {
        ...
        endpoints: [
            {
                ...
                parameters: [
                    { name: 'period', type: 'string', required: false, description: 'Time period (7d, 30d, 90d, 1y)', default: '30d' },
                    {
                        ...
                        type: 'string',
                        required: false,
                        description: 'Specific metric (posts, connections, events, all)',
                        default: 'all',
                    },
                        ...
                        example: {
                            ...
                            data: {
                                ...
                                trends: {
                                    ...
                                    post_engagement: [{ date: '2024-01-01', likes: 234, comments: 67, shares: 23 }],
                                },
                                segments: {
                                    by_graduation_year: [
