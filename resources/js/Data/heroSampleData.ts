...
export const heroSampleData: HeroSampleData = {
    individual: {
        ...
        description:
            'From recent graduates landing dream jobs to seasoned professionals making career pivots - our alumni network has been the catalyst for countless success stories. Your next chapter begins with a single connection.',
        ctaButtons: [
            {
                id: 'join-network',
    ...
    institution: {
        ...
        description:
            'Leading institutions trust our platform to strengthen alumni bonds, increase giving by 120%, and create lasting partnerships that drive student success. Join 500+ institutions already transforming their alumni engagement strategy.',
        ctaButtons: [
            {
                id: 'partnership-demo',
    ...
    employer: {
        ...
        description:
            'Stop sifting through endless resumes. Our platform connects you directly with qualified alumni professionals who are actively seeking opportunities, complete with verified credentials and peer recommendations.',
        ctaButtons: [
            {
                id: 'start-hiring',
