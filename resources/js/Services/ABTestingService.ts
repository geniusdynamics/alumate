...
export class ABTestingService {
    ...
    constructor(analyticsService: AnalyticsIntegrationService, tenantId?: string, baseURL: string = '/api/ab-testing') {
    ...
    assignVariant(experimentId: string, userId: string, sessionId: string): string | null {
        ...
        const existingAssignment = Array.from(this.trafficAssignments.values()).find(
...
export const createABTestingService = (analyticsService: AnalyticsIntegrationService, tenantId?: string): ABTestingService => {
