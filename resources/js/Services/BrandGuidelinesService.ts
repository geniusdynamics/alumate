...
export class BrandGuidelinesService {
    ...
    public async isValueCompliant(type: BrandGuideline['type'], value: string): Promise<boolean> {
        ...
        return guidelines.some((guideline) => guideline.value.toLowerCase() === value.toLowerCase());
    }
     ...
     */
    private async validateColors(styles: Record<string, any>, violations: BrandViolation[], suggestions: BrandSuggestion[]): Promise<void> {
     ...
     */
    private async validateFonts(styles: Record<string, any>, violations: BrandViolation[], suggestions: BrandSuggestion[]): Promise<void> {
     ...
     */
    private async validateSpacing(styles: Record<string, any>, violations: BrandViolation[], suggestions: BrandSuggestion[]): Promise<void> {
     ...
     */
    private async validateShadows(styles: Record<string, any>, violations: BrandViolation[], suggestions: BrandSuggestion[]): Promise<void> {
     ...
     */
    private async validateBorderRadius(styles: Record<string, any>, violations: BrandViolation[], suggestions: BrandSuggestion[]): Promise<void> {
