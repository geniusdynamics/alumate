...
class TemplateCustomizationService {
    ...
    async getConfig(templateId: number): Promise<TemplateCustomizationAPIResponse> {
        const response = await httpService.get<TemplateCustomizationAPIResponse>(`${this.baseUrl}/templates/${templateId}/config`);
     ...
     */
    async saveConfig(templateId: number, config: Partial<TemplateCustomizationConfig>): Promise<TemplateCustomizationAPIResponse> {
        const response = await httpService.post<TemplateCustomizationAPIResponse>(`${this.baseUrl}/templates/${templateId}/config`, config);
        return response.data;
    }
    ...
    async getBrandCustomization(templateId: number): Promise<BrandCustomization> {
        const response = await httpService.get<BrandCustomization>(`${this.baseUrl}/templates/${templateId}/brand`);
        return response.data;
    }
     ...
     */
    async saveBrandCustomization(templateId: number, brand: Partial<BrandCustomization>): Promise<BrandCustomization> {
        const response = await httpService.put<BrandCustomization>(`${this.baseUrl}/templates/${templateId}/brand`, brand);
        return response.data;
    }
    ...
    async getContentCustomization(templateId: number): Promise<ContentCustomization> {
        const response = await httpService.get<ContentCustomization>(`${this.baseUrl}/templates/${templateId}/content`);
        return response.data;
    }
     ...
     */
    async saveContentCustomization(templateId: number, content: Partial<ContentCustomization>): Promise<ContentCustomization> {
        const response = await httpService.put<ContentCustomization>(`${this.baseUrl}/templates/${templateId}/content`, content);
        return response.data;
    }
    ...
    async validateCustomization(
        ...
        }>(`${this.baseUrl}/templates/${templateId}/validate`, customization);
        return response.data;
    }
    ...
    async getPresets(category?: string): Promise<BrandCustomization[]> {
        ...
        const response = await httpService.get<BrandCustomization[]>(`${this.baseUrl}/presets${queryParams}`);
        return response.data;
    }
     ...
     */
    async applyPreset(templateId: number, presetId: string): Promise<TemplateCustomizationConfig> {
        const response = await httpService.post<TemplateCustomizationConfig>(`${this.baseUrl}/templates/${templateId}/presets/${presetId}/apply`);
        return response.data;
    }
    ...
    async getRealtimePreview(
        ...
        }>(`${this.baseUrl}/templates/${templateId}/preview/realtime`, { changes });
        return response.data;
    }
     ...
     */
    async createShareableLink(templateId: number, customization: TemplateCustomizationConfig): Promise<{ shareUrl: string; expiryDate: string }> {
        const response = await httpService.post<{ shareUrl: string; expiryDate: string }>(`${this.baseUrl}/templates/${templateId}/share`, {
            customization,
        });
        return response.data;
    }
     ...
     */
    async importCustomization(templateId: number, configJson: string): Promise<TemplateCustomizationConfig> {
        const response = await httpService.post<TemplateCustomizationConfig>(`${this.baseUrl}/templates/${templateId}/import`, {
     ...
     */
    async getAnalytics(templateId: number): Promise<{
        views: number;
        saves: number;
        exports: number;
        shares: number;
     ...
     */
    async restoreVersion(templateId: number, version: number): Promise<TemplateCustomizationConfig> {
        const response = await httpService.post<TemplateCustomizationConfig>(`${this.baseUrl}/templates/${templateId}/restore/${version}`);
        return response.data;
    }
    ...
    async getRecommendations(
        ...
        }>(`${this.baseUrl}/templates/${templateId}/recommendations`, customization);
        return response.data;
    }
}
