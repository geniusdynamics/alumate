<template>
    <div style="min-height: 100vh; display: flex; align-items: center; justify-content: center; background-color: #f3f4f6; padding: 20px">
        <div style="width: 100%; max-width: 400px; background: white; padding: 30px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1)">
            ...
            <div
                v-if="status"
                style="margin-bottom: 16px; padding: 12px; background-color: #d1fae5; color: #065f46; border-radius: 4px; font-size: 14px"
            >
                {{ status }}
            </div>
            ...
            <form @submit.prevent="submit">
                <div style="margin-bottom: 20px">
                    <label for="email" style="display: block; font-weight: 500; font-size: 14px; color: #374151; margin-bottom: 8px"> Email </label>
                    <input
                        id="email"
                        v-model="form.email"
                        type="email"
                ...
                <div style="margin-bottom: 20px">
                    <label style="display: flex; align-items: center; cursor: pointer">
                        <input v-model="form.remember" type="checkbox" style="margin-right: 8px" />
                ...
                <div style="text-align: center">
                    <Link :href="route('register')" style="font-size: 14px; color: #6b7280; text-decoration: underline">
