            ...
            <div class="mobile-container lg:py-12">
                <div class="mx-auto max-w-2xl">
                    ...
                    <div class="mb-8 hidden lg:block">
                        ...
                        <p class="mt-2 text-gray-600 dark:text-gray-400">Customize how the platform looks and feels for you.</p>
                    </div>
                    ...
                    <div class="card-mobile">
                        ...
                        <div class="space-y-4">
                            <p class="text-sm text-gray-600 dark:text-gray-400">
                                Choose how the platform appears to you. Select a single theme, or sync with your system and automatically switch
                            ...
                            <div class="space-y-3">
                                <div
                                    ...
                                    :key="option.value"
                                    class="flex cursor-pointer items-center justify-between rounded-lg border border-gray-200 p-4 transition-colors hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-gray-700"
                                    :class="{ 'border-blue-500 ring-2 ring-blue-500': currentTheme === option.value }"
                                ...
                                >
                                    ...
                                    <div class="flex-shrink-0">
                                        <div
                                            class="flex h-4 w-4 items-center justify-center rounded-full border-2 border-gray-300 dark:border-gray-600"
                                            :class="currentTheme === option.value ? 'border-blue-500 bg-blue-500' : ''"
                                        >
                                            <div v-if="currentTheme === option.value" class="h-2 w-2 rounded-full bg-white"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-6 rounded-lg bg-gray-50 p-4 dark:bg-gray-800">
                                <h3 class="mb-3 text-sm font-medium text-gray-900 dark:text-white">Theme Toggle Styles</h3>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400">Increase contrast for better visibility</p>
                                </div>
                                <button
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400">Enable pull-to-refresh on mobile</p>
                                </div>
                                <button
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400">Enable swipe navigation</p>
                                </div>
                                <button
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <input type="text" placeholder="Sample input" class="input-mobile w-32 text-sm" readonly />
                                </div>

                                <!-- Sample Card -->
                                <div class="rounded-lg border border-gray-200 bg-white p-3 dark:border-gray-700 dark:bg-gray-800">
                                    <h4 class="mb-1 text-sm font-medium text-gray-900 dark:text-white">Sample Card</h4>
