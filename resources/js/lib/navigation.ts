...
export const employerMenuItems = [
    ...
    { title: 'Manage Jobs', icon: Briefcase, href: route('jobs.dashboard'), active: route().current('jobs.dashboard*'), permission: 'view jobs' },
    {
        ...
        active: route().current('employer.search-graduates'),
...
export const institutionAdminMenuItems = [
    { title: 'Dashboard', icon: Home, href: route('dashboard'), active: route().current('dashboard') },
    {
        ...
        active: route().current('institution-admin.graduates.*'),
    ...
    },
    {
        ...
        active: route().current('institution-admin.courses.*'),
    ...
    },
    {
        ...
        active: route().current('institution-admin.tutors.*'),
        permission: 'manage tutors',
    },
    {
        title: 'Manage Jobs',
        icon: Briefcase,
        href: route('institution-admin.jobs.public.index'),
        active: route().current('institution-admin.jobs.public.index'),
        permission: 'view jobs',
    },
    {
        title: 'Approve Companies',
        icon: UserCheck,
        href: route('institution-admin.companies.index'),
        active: route().current('institution-admin.companies.*'),
    ...
    },
    {
        ...
        icon: Users,
        href: route('institution-admin.users.index'),
        active: route().current('institution-admin.users.*'),
        permission: 'view users',
    },
    {
        title: 'Role Management',
        icon: Shield,
        href: route('institution-admin.roles.index'),
        active: route().current('institution-admin.roles.*'),
    ...
    { title: 'Analytics', icon: ChartBarIcon, href: route('institution-admin.analytics'), active: route().current('institution-admin.analytics') },
    {
        title: 'Course ROI',
        icon: DollarSign,
        href: route('institution-admin.analytics.course-roi'),
        active: route().current('institution-admin.analytics.course-roi'),
    },
    {
        title: 'Employer Engagement',
        icon: Briefcase,
        href: route('institution-admin.analytics.employer-engagement'),
        active: route().current('institution-admin.analytics.employer-engagement'),
    },
    {
        title: 'Community Health',
        icon: HeartPulse,
        href: route('institution-admin.analytics.community-health'),
        active: route().current('institution-admin.analytics.community-health'),
    },
    {
        title: 'Branding',
        icon: Palette,
        href: route('institution-admin.settings.branding'),
        active: route().current('institution-admin.settings.branding'),
    },
    {
        title: 'Integrations',
        icon: Plug,
        href: route('institution-admin.settings.integrations'),
        active: route().current('institution-admin.settings.integrations'),
    },
    {
        title: 'Institution Settings',
        icon: Settings,
        href: route('institution-admin.institution.edit'),
        active: route().current('institution-admin.institution.edit'),
