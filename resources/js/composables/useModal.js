...
export function useModal(options = {}) {
    const { onClose, closeOnEscape = true, trapFocus = true, lockBodyScroll = true } = options;
    ...
    const getFocusableElements = () => {
        ...
        return Array.from(modalRef.value.querySelectorAll(focusableSelectors)).filter((el) => {
