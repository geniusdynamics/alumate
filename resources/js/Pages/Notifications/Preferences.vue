...
<template>
    ...
    <AppLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800">Notification Preferences</h2>
        </template>
            ...
            <div class="mx-auto max-w-4xl sm:px-6 lg:px-8">
                <div class="overflow-hidden rounded-lg bg-white shadow">
                    <div class="px-4 py-5 sm:p-6">
                        <div class="mb-6">
                            <h3 class="text-lg font-medium leading-6 text-gray-900">Manage Your Notifications</h3>
                            <p class="mt-1 text-sm text-gray-600">
                                Choose how you want to receive different types of notifications. You can customize settings for each notification
                                type.
                            </p>
                        </div>
                                ...
                                >
                                    ...
                                    <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
                                        ...
                                        <div class="flex items-center">
                                            <input
                                                :id="`${preference.notification_type}_email`"
                                                type="checkbox"
                                                v-model="preference.email_enabled"
                                                class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                                            />
                                            <label :for="`${preference.notification_type}_email`" class="ml-3 flex items-center">
                                        ...
                                        <div class="flex items-center">
                                            <input
                                                :id="`${preference.notification_type}_sms`"
                                                type="checkbox"
                                                v-model="preference.sms_enabled"
                                                class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                                            />
                                            <label :for="`${preference.notification_type}_sms`" class="ml-3 flex items-center">
                                                <svg class="mr-2 h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path
                                                        stroke-linecap="round"
                                                        stroke-linejoin="round"
                                        ...
                                        <div class="flex items-center">
                                            <input
                                                :id="`${preference.notification_type}_in_app`"
                                                type="checkbox"
                                                v-model="preference.in_app_enabled"
                                                class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                                            />
                                            <label :for="`${preference.notification_type}_in_app`" class="ml-3 flex items-center">
                                                <svg class="mr-2 h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path
                                                        stroke-linecap="round"
                                                        stroke-linejoin="round"
                                        ...
                                        <div class="flex items-center">
                                            <input
                                                :id="`${preference.notification_type}_push`"
                                                type="checkbox"
                                                v-model="preference.push_enabled"
                                                class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                                            />
                                            <label :for="`${preference.notification_type}_push`" class="ml-3 flex items-center">
                                                <svg class="mr-2 h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path
                                                        stroke-linecap="round"
                                                        stroke-linejoin="round"
