                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            <div>
                                <label for="id" class="block text-sm font-medium text-gray-700"> Institution ID * </label>
                                <input
                                    id="id"
                                    v-model="form.id"
                                    type="text"
                                    ...
                                    required
                                />
                                <p class="mt-1 text-sm text-gray-500">Unique identifier for the institution (lowercase, no spaces)</p>
