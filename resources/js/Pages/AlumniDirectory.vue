    ...
    <AppLayout title="Alumni Directory">
        ...
        <PullToRefresh @refresh="refreshDirectory" class="alumni-directory theme-bg-secondary">
            ...
            <div class="safe-area-top border-b border-gray-200 bg-white shadow-sm lg:hidden dark:border-gray-700 dark:bg-gray-800">
                <div class="p-4">
                    <h1 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Alumni Directory</h1>
                    ...
                    >
                        <template #filters="{ filters, updateFilter }">
                            <DirectoryFilters :filters="availableFilters" :active-filters="filters" @update-filters="updateFilter" mobile />
                        </template>
                    </MobileSearchInterface>
                </div>
            </div>
            ...
            <!-- Desktop Header -->
            <div class="directory-header mobile-container hidden lg:block">
                <h1 class="mb-6 text-3xl font-bold text-gray-900 dark:text-white">Alumni Directory</h1>
                ...
                <div class="search-section mb-6">
                    <div class="relative">
                        <input
                            ...
                            class="w-full rounded-lg border border-gray-300 bg-white px-4 py-3 pl-12 pr-4 text-gray-900 focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-800 dark:text-white"
                        />
            ...
            <div class="directory-content mobile-container flex gap-6 lg:px-6">
                <!-- Desktop Filters Sidebar -->
                <div class="filters-sidebar hidden w-80 flex-shrink-0 lg:block">
                    <DirectoryFilters
                ...
                <div class="alumni-grid flex-1">
                    <!-- Results Header -->
                    <div class="results-header mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div class="results-info">
                            <p class="text-sm text-gray-600 dark:text-gray-400">Showing {{ meta.from }}-{{ meta.to }} of {{ meta.total }} alumni</p>
                        </div>

                        <!-- Mobile Sort Controls -->
                        <div class="sort-controls flex items-center space-x-2">
                            <select v-model="sortBy" @change="loadAlumni" class="input-mobile flex-1 text-sm sm:flex-none">
                            ...
                            <button
                                ...
                                class="btn-mobile-secondary flex-shrink-0 p-2"
                    ...
                    <div v-if="loading" class="loading-mobile">
                        <div class="mobile-grid gap-4 lg:grid-cols-2 xl:grid-cols-3">
                            ...
                            <nav class="flex justify-center">
                                <div class="flex flex-wrap justify-center gap-2">
                                    ...
                                    <button
                                        ...
                                        :key="page"
                                        @click="goToPage(page)"
                                        class="btn-mobile min-w-[44px] text-sm"
                                        :class="
                    ...
                    <div v-else class="error-mobile">
                        ...
                        <p class="error-mobile-message">Try adjusting your search criteria or filters.</p>
                        <button @click="clearFilters" class="btn-mobile-primary">Clear Filters</button>
                    </div>
                </div>
            </div>
