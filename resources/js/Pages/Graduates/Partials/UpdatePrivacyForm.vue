...
<template>
    <section>
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">Control how your information is shared with employers and other users.</p>
        </header>

        <form @submit.prevent="submit" class="mt-6 space-y-6">
            <div class="rounded-lg bg-gray-50 p-4">
                <h3 class="text-md mb-4 font-semibold text-gray-800">Profile Visibility</h3>
                <div class="space-y-3">
            ...
            <div class="rounded-lg bg-gray-50 p-4">
                <h3 class="text-md mb-4 font-semibold text-gray-800">Contact Preferences</h3>
                <div class="space-y-3">
                    <label class="flex items-center">
                        <input
                            type="checkbox"
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-blue-700">
                            <p>
                                Your privacy settings control how your information is shared. You can change these settings at any time. Your
                                institution administrators will always have access to your profile for academic and career support purposes.
                            </p>
                        </div>
                    </div>
                </div>
