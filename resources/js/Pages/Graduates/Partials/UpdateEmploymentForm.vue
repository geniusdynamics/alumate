...
<template>
    <section>
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">Update the graduate's current employment information.</p>
        </header>
        ...
        <form @submit.prevent="submit" class="mt-6 space-y-6">
            <div>
                ...
                <div v-if="form.errors.employment_status" class="mt-1 text-sm text-red-600">{{ form.errors.employment_status }}</div>
            </div>
            ...
            <div v-if="form.employment_status === 'employed' || form.employment_status === 'self_employed'" class="space-y-4">
                <div>
                    ...
                    <input
                        ...
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                    />
                    <div v-if="form.errors.current_job_title" class="mt-1 text-sm text-red-600">{{ form.errors.current_job_title }}</div>
                </div>
                ...
                <div v-if="form.employment_status === 'employed'">
                    ...
                    <input
                        ...
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                    />
                    <div v-if="form.errors.current_company" class="mt-1 text-sm text-red-600">{{ form.errors.current_company }}</div>
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                    />
                    <div v-if="form.errors.current_salary" class="mt-1 text-sm text-red-600">{{ form.errors.current_salary }}</div>
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                    />
                    <div v-if="form.errors.employment_start_date" class="mt-1 text-sm text-red-600">{{ form.errors.employment_start_date }}</div>
                </div>
            </div>
