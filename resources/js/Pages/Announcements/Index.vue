    ...
    <AppLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-semibold leading-tight text-gray-800">Announcements</h2>
                <Link
                    v-if="$page.props.auth.user.roles.some((role) => ['super-admin', 'institution-admin'].includes(role.name))"
        ...
        <div class="py-12">
            <div class="mx-auto max-w-4xl space-y-6 sm:px-6 lg:px-8">
                ...
                <div class="rounded-lg bg-white p-6 shadow">
                    <h3 class="mb-4 text-lg font-medium text-gray-900">Filter Announcements</h3>
                ...
                <div class="space-y-4">
                    <div
                        ...
                        :key="announcement.id"
                        class="rounded-lg border border-gray-200 bg-white transition-shadow hover:shadow-md"
                    >
                        <div class="p-6">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    <div class="mb-2 flex items-center gap-3">
                                        <div :class="['flex h-8 w-8 items-center justify-center rounded-lg', getTypeColor(announcement.type)]">
                                        ...
                                        <div>
                                            <h3 class="text-lg font-semibold text-gray-900">
                                                <Link :href="route('announcements.show', announcement.id)" class="hover:text-indigo-600">
                                                    {{ announcement.title }}
                                                </Link>
                                            </h3>
                                            <div class="mt-1 flex items-center gap-2">
                                                ...
                                                <span
                                                    ...
                                                    class="inline-flex rounded-full bg-yellow-100 px-2 py-1 text-xs text-yellow-800"
                                                >
                                                    PINNED
                                                </span>
                                            </div>
                ...
                <!-- Pagination -->
                <div v-if="announcements.links" class="rounded-lg bg-white px-4 py-3 shadow">
                    <div class="flex items-center justify-between">
                ...
                <!-- Empty State -->
                <div v-if="announcements.data.length === 0" class="overflow-hidden rounded-lg bg-white shadow">
                    <div class="p-12 text-center">
                        ...
                        <h3 class="mb-2 text-lg font-medium text-gray-900">No announcements found</h3>
