...
const sortOptions = computed(() => {
    ...
    if (props.searchType === 'jobs') {
        return [...baseOptions, { value: 'salary', label: 'Salary' }, { value: 'location', label: 'Location' }];
    } else if (props.searchType === 'graduates') {
        return [...baseOptions, { value: 'graduation_year', label: 'Graduation Year' }, { value: 'employment_status', label: 'Employment Status' }];
    } else if (props.searchType === 'courses') {
        return [...baseOptions, { value: 'level', label: 'Level' }, { value: 'duration', label: 'Duration' }];
    }
