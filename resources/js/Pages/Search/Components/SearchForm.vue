<template>
    <form @submit.prevent="performSearch" class="space-y-6">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            <div>
                <label class="mb-2 block text-sm font-medium text-gray-700">Keywords</label>
                <div class="relative">
                    <input
                        v-model="form.keywords"
                        type="text"
                        class="w-full rounded-md border border-gray-300 py-2 pl-10 pr-4 focus:border-indigo-500 focus:ring-indigo-500"
                    ...
                    <div v-if="suggestions.length > 0" class="absolute z-10 mt-1 w-full rounded-md border border-gray-300 bg-white shadow-lg">
                        ...
                        >
                            <span class="mr-2 text-xs text-gray-500">{{ suggestion.type }}</span>
        ...
        <div v-if="showAdvanced" class="border-t pt-6">
            <h4 class="mb-4 text-sm font-medium text-gray-900">Advanced Filters</h4>

            <!-- Job-specific filters -->
            <div v-if="searchType === 'jobs'" class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700">Job Type</label>
                    <select
                ...
                <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700">Experience Level</label>
                    <select
                ...
                <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700">Min Salary</label>
                    <input
                ...
                <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700">Max Salary</label>
                    <input
                ...
                <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700">Work Arrangement</label>
                    <select
            ...
            <div v-else-if="searchType === 'graduates'" class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700">Graduation Year</label>
                ...
                <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700">Min GPA</label>
                    <input
                ...
                <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700">Min Profile Completion</label>
                    <input
            ...
            <div v-else-if="searchType === 'courses'" class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                <div>
                ...
                <div>
                    <label class="mb-2 block text-sm font-medium text-gray-700">Min Employment Rate</label>
                    <input
            ...
            <div class="mt-4">
                <label class="mb-2 block text-sm font-medium text-gray-700">Skills</label>
                <SkillsInput v-model="form.skills" :placeholder="getSkillsPlaceholder()" />
            </div>
        </div>

        <!-- Action Buttons -->
        <div class="flex items-center justify-between">
            <button type="button" @click="showAdvanced = !showAdvanced" class="text-sm font-medium text-indigo-600 hover:text-indigo-500">
            ...
            <div class="flex space-x-3">
                ...
                <button type="submit" class="rounded-md bg-indigo-600 px-6 py-2 text-sm font-medium text-white hover:bg-indigo-700">Search</button>
            </div>
        </div>
    </form>
</template>
    ...
    methods: {
        performSearch() {
            ...
            Object.keys(criteria).forEach((key) => {
                if (criteria[key] === '' || criteria[key] === null || (Array.isArray(criteria[key]) && criteria[key].length === 0)) {
                    delete criteria[key];
                }
            });
            ...
            if (criteria.graduation_year_from || criteria.graduation_year_to) {
                criteria.graduation_year = [criteria.graduation_year_from || 2000, criteria.graduation_year_to || new Date().getFullYear() + 5];
