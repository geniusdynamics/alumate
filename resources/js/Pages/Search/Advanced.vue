        ...
        <div class="advanced-search-page">
            ...
            <div class="page-header">
                ...
                <div class="header-actions">
                    <button @click="showSavedSearches = !showSavedSearches" class="saved-searches-toggle" :class="{ active: showSavedSearches }">
            ...
            <div class="search-container">
                ...
                <div v-if="showSavedSearches" class="saved-searches-sidebar">
                    <SavedSearches
...
.page-header {
    @apply border-b border-gray-200 bg-white px-6 py-8;
...
.page-description {
    @apply max-w-2xl text-lg text-gray-600;
}
...
.saved-searches-toggle {
    ...
    @apply rounded-md border border-gray-300 text-gray-700;
...
.saved-searches-sidebar {
    @apply w-80 rounded-lg border border-gray-200 bg-white p-6 shadow-sm;
