<template>
    <AdminLayout app-name="Alumate" user-role="Super Admin" page-title="Dashboard" :navigation-items="navigationItems">
        <Head title="Super Admin Dashboard" />

        <!-- Welcome Section -->
        <div class="mb-8">
            <h2 class="mb-2 text-2xl font-bold text-white">Welcome Admin</h2>
            <p class="text-gray-400">Here's what's happening with your platform today.</p>
        </div>
        <!-- System Stats Cards -->
        <div class="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            <DarkStatCard title="New Users (30 Days)" :value="systemStats.new_users" icon="UsersIcon" color="blue" change="+12%" />
            <DarkStatCard
                ...
                change="+8.2%"
            />
            <DarkStatCard title="Activity" :value="2456" icon="ChartBarIcon" color="purple" change="+15%" />
            <DarkStatCard title="Views" :value="34567" icon="EyeIcon" color="yellow" change="-2.4%" />
        </div>

        <!-- Quick Actions -->
        <div class="mb-8 rounded-lg border border-gray-700 bg-gray-800">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                    <Link
                        ...
                        class="flex items-center rounded-lg border border-gray-600 p-4 transition-colors hover:bg-gray-700"
                    >
                        <BuildingOfficeIcon class="mr-3 h-8 w-8 text-blue-400" />
                        <div>
                    ...
                    <Link
                        ...
                        class="flex items-center rounded-lg border border-gray-600 p-4 transition-colors hover:bg-gray-700"
                    >
                        <UsersIcon class="mr-3 h-8 w-8 text-green-400" />
                        <div>
                    ...
                    <Link
                        ...
                        class="flex items-center rounded-lg border border-gray-600 p-4 transition-colors hover:bg-gray-700"
                    >
                        <ShieldCheckIcon class="mr-3 h-8 w-8 text-orange-400" />
                        <div>
                    ...
                    <Link
                        ...
                        class="flex items-center rounded-lg border border-gray-600 p-4 transition-colors hover:bg-gray-700"
                    >
                        <DocumentTextIcon class="mr-3 h-8 w-8 text-purple-400" />
                        <div>
        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            ...
            <div class="rounded-lg bg-white shadow lg:col-span-2">
                ...
                <div class="p-6">
                    <div class="flex h-64 items-end justify-center space-x-2">
                        <div v-for="day in systemStats.user_growth_data" :key="day.date" class="flex flex-col items-center">
                            <div class="rounded-t bg-blue-500" :style="{ height: day.count * 10 + 'px', width: '10px' }"></div>
            ...
            <div class="rounded-lg bg-white shadow">
                ...
                <div class="p-6">
                    ...
                    <div class="mt-6">
                        <Link :href="route('super-admin.institutions')" class="text-sm font-medium text-indigo-600 hover:text-indigo-500">
                    ...
                    <div class="flow-root">
                        <ul class="-mb-8">
                            <li v-for="(activity, index) in recentActivity.slice(0, 8)" :key="index" class="relative pb-8">
                                <div
                                    v-if="index !== recentActivity.slice(0, 8).length - 1"
            ...
            <div class="rounded-lg bg-white shadow">
                ...
                <div class="p-6">
                    ...
                    <div class="mt-6">
                        <h4 class="mb-3 text-sm font-medium text-gray-900">Top Job Types</h4>
                        <div class="space-y-2">
