<template>
    <div class="min-h-screen bg-gray-50">
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between py-6">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">Discover and join alumni events in your area</p>
                    </div>
                    <button
        ...
        <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            <div class="flex flex-col gap-8 lg:flex-row">
                ...
                <div class="flex-shrink-0 lg:w-80">
                    <EventFilters :filters="filters" @update:filters="handleFiltersUpdate" :loading="loading" />
                </div>
                ...
                <div class="flex-1">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <button
                                ...
                                :class="[
                                    ...
                                    isQuickFilterActive(quickFilter) ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200',
                                ]"
                            >
                                {{ quickFilter.label }}
                            </button>
                    ...
                    <div v-if="upcomingEvents.length > 0" class="mb-8">
                        <h2 class="mb-4 text-lg font-semibold text-gray-900">Your Upcoming Events</h2>
                    ...
                    <div v-if="recommendedEvents.length > 0" class="mb-8">
                        <h2 class="mb-4 text-lg font-semibold text-gray-900">Recommended for You</h2>
                    ...
                    <div>
                        <div class="mb-4 flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-2">
                                <span class="text-sm text-gray-500"> {{ events.length }} of {{ totalEvents }} events </span>
                            </div>
                        </div>
                        ...
                        <div v-else class="py-12 text-center">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Try adjusting your filters or create a new event.</p>
                        </div>
                        ...
                        <div v-if="hasMoreEvents && !loading" class="mt-8 text-center">
                            ...
                            >
                                <template v-if="loadingMore">
                                    <svg
                                        class="-ml-1 mr-3 h-4 w-4 animate-spin text-gray-700"
        ...
        <EventFormModal :show="showCreateModal || showEditModal" :event="editingEvent" @close="closeFormModal" @saved="handleEventSaved" />
    </div>
</template>
