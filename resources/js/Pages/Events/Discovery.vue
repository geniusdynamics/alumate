    ...
    <AppLayout title="Events Discovery">
        ...
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div class="mb-6 rounded-lg bg-white shadow dark:bg-gray-800">
                <div class="p-6">
                    <EventFilters :filters="filters" :event-types="eventTypes" :locations="locations" @filters-changed="handleFiltersChanged" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-4">
                ...
                <div class="lg:col-span-3">
                    ...
                    <div v-if="featuredEvents.length > 0" class="mb-8">
                        <h2 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white">Featured Events</h2>
                    ...
                    <div class="rounded-lg bg-white shadow dark:bg-gray-800">
                        <div class="border-b border-gray-200 px-6 py-4 dark:border-gray-700">
                            <div class="flex items-center justify-between">
                                <h2 class="text-lg font-medium text-gray-900 dark:text-white">All Events ({{ events.total }})</h2>
                ...
                <div class="space-y-6">
                    ...
                    <div class="rounded-lg bg-white shadow dark:bg-gray-800">
                        <div class="border-b border-gray-200 px-6 py-4 dark:border-gray-700">
                            <div class="flex items-center justify-between">
                                ...
                                <Link :href="route('events.my-events')" class="text-sm text-blue-600 hover:text-blue-500"> View All </Link>
                            </div>
                        </div>
                        <div class="p-6">
                            <div v-if="myEvents.length === 0" class="py-4 text-center">
                            ...
                            <div v-else class="space-y-3">
                                <div v-for="event in myEvents" :key="event.id" class="rounded-lg border border-gray-200 p-3 dark:border-gray-700">
                    ...
                    <div class="rounded-lg bg-white shadow dark:bg-gray-800">
                        ...
                        <div class="p-6">
                            <div v-if="upcomingReunions.length === 0" class="py-4 text-center">
                    ...
                    <div class="rounded-lg bg-white shadow dark:bg-gray-800">
                        ...
                        <div class="space-y-2 p-6">
                            <button
                                ...
                                class="flex w-full items-center justify-between rounded-md px-3 py-2 text-left text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700"
                            >
                                <span>{{ category.name }}</span>
                                <span class="rounded-full bg-gray-200 px-2 py-1 text-xs text-gray-500 dark:bg-gray-600">
                                    {{ category.count }}
                                </span>
                            </button>
                        </div>
        ...
        <EventRegistrationModal v-if="showRegistrationModal" :event="selectedEvent" @confirm="confirmEventRegistration" @close="closeModals" />

        <!-- Event Feedback Modal -->
        <EventFeedbackModal v-if="showFeedbackModal" :event="selectedEvent" @submit="submitEventFeedback" @close="closeModals" />

        <!-- Event Connection Recommendations -->
        <EventConnectionRecommendations v-if="showConnectionRecommendations" :event="selectedEvent" @close="closeModals" />

        <!-- Virtual Event Viewer -->
        <VirtualEventViewer v-if="showVirtualEventViewer" :event="virtualEvent" @close="closeModals" />
    </AppLayout>
</template>
