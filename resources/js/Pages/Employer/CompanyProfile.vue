    ...
    <AppLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-semibold leading-tight text-gray-800">Company Profile</h2>
                <div class="flex items-center gap-2">
                    <span
                        :class="[
                            'inline-flex rounded-full px-2 py-1 text-xs font-semibold',
                            getVerificationStatusClass(employer.verification_status),
                        ]"
                    >
        ...
        <div class="py-12">
            <div class="mx-auto max-w-4xl space-y-6 sm:px-6 lg:px-8">
                ...
                <div v-if="employer.verification_status !== 'verified'" class="rounded-md border border-yellow-200 bg-yellow-50 p-4">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p v-if="employer.verification_status === 'pending'">
                                    Your account is pending verification. Complete your profile and submit verification documents to start posting
                                    jobs.
                                </p>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="overflow-hidden rounded-lg bg-white shadow">
                        <div class="px-4 py-5 sm:p-6">
                            <h3 class="mb-4 text-lg font-medium leading-6 text-gray-900">Company Information</h3>
                            ...
                            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                    />
                                    <div v-if="form.errors.established_year" class="mt-1 text-sm text-red-600">
                            ...
                            <div class="mt-6">
                                ...
                                ></textarea>
                                <div v-if="form.errors.company_description" class="mt-1 text-sm text-red-600">
                            ...
                            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                    />
                                    <div v-if="form.errors.contact_person_name" class="mt-1 text-sm text-red-600">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                    />
                                    <div v-if="form.errors.contact_person_title" class="mt-1 text-sm text-red-600">
                                        {{ form.errors.contact_person_title }}
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                    />
                                    <div v-if="form.errors.contact_person_email" class="mt-1 text-sm text-red-600">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                    />
                                    <div v-if="form.errors.contact_person_phone" class="mt-1 text-sm text-red-600">
                                        {{ form.errors.contact_person_phone }}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="overflow-hidden rounded-lg bg-white shadow">
                        <div class="px-4 py-5 sm:p-6">
                            <h3 class="mb-4 text-lg font-medium leading-6 text-gray-900">Legal Information</h3>
                            ...
                            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div>
                                    ...
                                    <input
                                        ...
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                    />
                                    <div v-if="form.errors.company_registration_number" class="mt-1 text-sm text-red-600">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                    />
                                    <div v-if="form.errors.company_tax_number" class="mt-1 text-sm text-red-600">
                    ...
                    <div class="overflow-hidden rounded-lg bg-white shadow">
                        <div class="px-4 py-5 sm:p-6">
                            <h3 class="mb-4 text-lg font-medium leading-6 text-gray-900">Business Locations</h3>

                            <div class="mb-4 space-y-2">
                                <div
                                    v-for="(location, index) in form.business_locations"
                                    :key="index"
                                    class="flex items-center justify-between rounded bg-gray-50 p-2"
                                >
                                    <span>{{ location }}</span>
                                    <button type="button" @click="removeLocation(index)" class="text-red-600 hover:text-red-800">Remove</button>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-2">
                                ...
                                />
                                <button type="button" @click="addLocation" class="rounded-md bg-indigo-600 px-4 py-2 text-white hover:bg-indigo-700">
                                    Add
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="overflow-hidden rounded-lg bg-white shadow">
                        <div class="px-4 py-5 sm:p-6">
                            <h3 class="mb-4 text-lg font-medium leading-6 text-gray-900">Services & Products</h3>
                            ...
                            <div class="mb-4 space-y-2">
                                ...
                                >
                                    <span>{{ service }}</span>
                                    <button type="button" @click="removeService(index)" class="text-red-600 hover:text-red-800">Remove</button>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-2">
                                <input
                                    ...
                                    class="flex-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                />
                                <button type="button" @click="addService" class="rounded-md bg-indigo-600 px-4 py-2 text-white hover:bg-indigo-700">
                                    Add
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="overflow-hidden rounded-lg bg-white shadow">
                        <div class="px-4 py-5 sm:p-6">
                            <h3 class="mb-4 text-lg font-medium leading-6 text-gray-900">Employee Benefits</h3>

                            <div class="mb-4 space-y-2">
                                <div
                                    v-for="(benefit, index) in form.employer_benefits"
                                    :key="index"
                                    class="flex items-center justify-between rounded bg-gray-50 p-2"
                                >
                                    <span>{{ benefit }}</span>
                                    <button type="button" @click="removeBenefit(index)" class="text-red-600 hover:text-red-800">Remove</button>
                                </div>
                            </div>
