    ...
    <AppLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-semibold leading-tight text-gray-800">Hiring Analytics</h2>
                <Link :href="route('employer.dashboard')" class="rounded-md bg-gray-300 px-4 py-2 font-medium text-gray-700 hover:bg-gray-400">
                    Back to Dashboard
                </Link>
            </div>
        </template>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
                        ...
                        <div class="p-5">
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        <dt class="truncate text-sm font-medium text-gray-500">Jobs Posted (30 days)</dt>
                    ...
                    <div class="overflow-hidden rounded-lg bg-white shadow">
                        <div class="p-5">
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        <dt class="truncate text-sm font-medium text-gray-500">Applications (30 days)</dt>
                    ...
                    <div class="overflow-hidden rounded-lg bg-white shadow">
                        <div class="p-5">
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        <dt class="truncate text-sm font-medium text-gray-500">Hires (30 days)</dt>
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        ...
                                        <dd class="text-lg font-medium text-gray-900">
                                            {{
                                                analytics.overview.applications_last_30_days > 0
                                                    ? formatPercentage(
                                                          (analytics.overview.hires_last_30_days / analytics.overview.applications_last_30_days) *
                                                              100,
                                                      )
                                                    : '0%'
                                            }}
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                    ...
                    <div class="overflow-hidden rounded-lg bg-white shadow">
                        <div class="px-4 py-5 sm:p-6">
                            <h3 class="mb-4 text-lg font-medium leading-6 text-gray-900">Application Trends (Last 30 Days)</h3>
                            <div v-if="chartData.length > 0" class="space-y-2">
                                <div v-for="trend in chartData" :key="trend.date" class="flex items-center">
                                    ...
                                    <div class="ml-4 flex-1">
                                        <div class="flex items-center">
                                            <div class="mr-2 h-2 w-full rounded-full bg-gray-200">
                                                <div
                                                    class="h-2 rounded-full bg-blue-600"
                                                    :style="`width: ${(trend.applications / maxApplications) * 100}%`"
                                                ></div>
                                            </div>
                                            <span class="w-8 text-sm font-medium text-gray-900">{{ trend.applications }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div v-else class="py-8 text-center text-gray-500">No application data available</div>
                        </div>
                    </div>
                    ...
                    <div class="overflow-hidden rounded-lg bg-white shadow">
                        <div class="px-4 py-5 sm:p-6">
                            <h3 class="mb-4 text-lg font-medium leading-6 text-gray-900">Hiring Funnel</h3>
                            <div class="space-y-4">
                ...
                <div class="overflow-hidden rounded-lg bg-white shadow">
                    <div class="px-4 py-5 sm:p-6">
                        <h3 class="mb-4 text-lg font-medium leading-6 text-gray-900">Top Performing Jobs</h3>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">Posted Date</th>
                                        <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">Performance</th>
                                    </tr>
                                </thead>
                                            ...
                                            <div class="flex items-center">
                                                <div class="mr-2 h-2 w-16 rounded-full bg-gray-200">
                                                    <div
                                                        :class="[
                                                            'h-2 rounded-full',
                                                            job.applications_count >= 20
                                                                ? 'bg-green-600'
                                                                : job.applications_count >= 10
                                                                  ? 'bg-yellow-600'
                                                                  : 'bg-red-600',
                                                        ]"
                                                        :style="`width: ${Math.min((job.applications_count / 30) * 100, 100)}%`"
                                                    ></div>
                                                </div>
                                                <span
                                                    :class="[
                                                ...
                                                >
                                                    {{ job.applications_count >= 20 ? 'High' : job.applications_count >= 10 ? 'Medium' : 'Low' }}
                                                </span>
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <div v-else class="py-8 text-center text-gray-500">No job performance data available</div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                    ...
                    <div class="overflow-hidden rounded-lg bg-white shadow">
                        <div class="px-4 py-5 sm:p-6">
                            <h3 class="mb-4 text-lg font-medium leading-6 text-gray-900">Top Courses (Applicants)</h3>
                            <div v-if="Object.keys(analytics.candidate_insights.top_courses).length > 0" class="space-y-3">
                                <div
                                    v-for="(count, course) in analytics.candidate_insights.top_courses"
                                    :key="course"
                                    ...
                                    <div class="flex items-center">
                                        <div class="mr-2 h-2 w-20 rounded-full bg-gray-200">
                                            <div
                                                ...
                                                :style="`width: ${(count / Math.max(...Object.values(analytics.candidate_insights.top_courses))) * 100}%`"
                                            ></div>
                                        </div>
                            ...
                            <div v-else class="py-8 text-center text-gray-500">No course data available</div>
                        </div>
                    </div>
                    ...
                    <div class="overflow-hidden rounded-lg bg-white shadow">
                        <div class="px-4 py-5 sm:p-6">
                            <h3 class="mb-4 text-lg font-medium leading-6 text-gray-900">Graduation Years (Applicants)</h3>
                            <div v-if="Object.keys(analytics.candidate_insights.graduation_years).length > 0" class="space-y-3">
                                <div
                                    v-for="(count, year) in analytics.candidate_insights.graduation_years"
                                    :key="year"
                                    class="flex items-center justify-between"
                                >
                                    ...
                                    <div class="flex items-center">
                                        <div class="mr-2 h-2 w-20 rounded-full bg-gray-200">
                                            <div
                                                ...
                                                :style="`width: ${(count / Math.max(...Object.values(analytics.candidate_insights.graduation_years))) * 100}%`"
                                            ></div>
                                        </div>
                                        <span class="text-sm font-medium text-gray-900">{{ count }}</span>
                                    </div>
                            ...
                            <div v-else class="py-8 text-center text-gray-500">No graduation year data available</div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-blue-700">
                                <ul class="list-inside list-disc space-y-1">
                                    ...
                                    <li
                                        v-if="analytics.overview.hires_last_30_days / Math.max(analytics.overview.applications_last_30_days, 1) < 0.1"
                                    >
                                    ...
                                    <li>Use the graduate search feature to proactively find candidates that match your requirements</li>
                                </ul>
                            </div>
                        </div>
                    </div>
