...
watch(
    [search, location, course_id, experience_level, job_type, work_arrangement, salary_min, salary_max, sort_by, sort_order],
    ...
    <AppLayout>
        <template #header>
            <div class="flex items-center justify-between">
                ...
                <div class="text-sm text-gray-600">{{ jobs.total }} jobs available</div>
            </div>
        </template>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="flex flex-col gap-6 lg:flex-row">
                    ...
                    <div class="lg:w-1/4">
                        <div class="sticky top-6 rounded-lg bg-white p-6 shadow">
                            <div class="mb-4 flex items-center justify-between">
                                ...
                                <button @click="clearFilters" class="text-sm text-indigo-600 hover:text-indigo-800">Clear All</button>
                            </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <!-- Salary Range -->
                                <div>
                                    <label class="mb-2 block text-sm font-medium text-gray-700">Salary Range</label>
                    ...
                    <div class="lg:w-3/4">
                        <!-- Recommendations -->
                        <div v-if="recommendations.length > 0" class="mb-6 rounded-lg border border-indigo-200 bg-indigo-50 p-6">
                            <h3 class="mb-4 text-lg font-medium text-indigo-900">Recommended for You</h3>
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div v-for="rec in recommendations" :key="rec.job.id" class="rounded-lg border border-indigo-200 bg-white p-4">
                                    ...
                                    <p class="mb-2 text-sm text-gray-600">{{ rec.job.employer.company_name }}</p>
                                    <Link
                        ...
                        <div class="mb-6 rounded-lg bg-white p-4 shadow">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="text-sm text-gray-600">Showing {{ jobs.from }}-{{ jobs.to }} of {{ jobs.total }} jobs</div>
                            </div>
                        </div>

                        <!-- Jobs List -->
                        <div class="space-y-6">
                            <div v-for="job in jobs.data" :key="job.id" class="overflow-hidden rounded-lg bg-white shadow">
                                <div class="p-6">
                                    <div class="flex items-start justify-between">
                                        <div class="flex-1">
                                            <div class="mb-2 flex items-center space-x-2">
                                                ...
                                                <span
                                                    :class="getJobTypeColor(job.job_type)"
                                            ...
                                            <p class="mb-4 line-clamp-3 text-gray-700">{{ job.description }}</p>
                        ...
                        <div v-if="jobs.links" class="mt-8">
                            <nav class="flex items-center justify-between rounded-lg border-t border-gray-200 bg-white px-4 py-3 shadow sm:px-6">
                                ...
                                <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                                    <div>
                                        <p class="text-sm text-gray-700">
                                            Showing <span class="font-medium">{{ jobs.from }}</span> to
                                            <span class="font-medium">{{ jobs.to }}</span> of
                                            <span class="font-medium">{{ jobs.total }}</span> results
                                        </p>
                                    </div>
                                    <div>
