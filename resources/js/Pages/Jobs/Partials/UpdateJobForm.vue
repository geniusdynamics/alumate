...
const form = useForm({
    ...
    course_id: props.job.course_id || '',
    required_skills: props.job.required_skills || [],
    preferred_qualifications: props.job.preferred_qualifications || [],
    experience_level: props.job.experience_level || 'entry',
    min_experience_years: props.job.min_experience_years || 0,
    ...
    work_arrangement: props.job.work_arrangement || 'on_site',
    application_deadline: props.job.application_deadline ? props.job.application_deadline.split('T')[0] : '',
    job_start_date: props.job.job_start_date ? props.job.job_start_date.split('T')[0] : '',
    job_end_date: props.job.job_end_date ? props.job.job_end_date.split('T')[0] : '',
    contact_email: props.job.contact_email || '',
    contact_phone: props.job.contact_phone || '',
    contact_person: props.job.contact_person || '',
    benefits: props.job.benefits || [],
    company_culture: props.job.company_culture || '',
});
...
<template>
    <section>
        <header>
            <h2 class="text-lg font-medium text-gray-900">Update Job Posting</h2>
            <p class="mt-1 text-sm text-gray-600">Update your job posting with detailed requirements and benefits.</p>
        </header>

        <form @submit.prevent="submit" class="mt-6 space-y-8">
            <!-- Basic Information -->
            <div class="rounded-lg bg-gray-50 p-6">
                <h3 class="text-md mb-4 font-medium text-gray-900">Basic Information</h3>
            ...
            <!-- Job Requirements -->
            <div class="rounded-lg bg-gray-50 p-6">
                <h3 class="text-md mb-4 font-medium text-gray-900">Job Requirements</h3>
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div>
                        ...
                        <div v-if="form.errors.experience_level" class="mt-1 text-sm text-red-600">{{ form.errors.experience_level }}</div>
                    </div>
                    ...
                    <div>
                        ...
                        <TextInput
                            ...
                            required
                        />
                        <div v-if="form.errors.min_experience_years" class="mt-1 text-sm text-red-600">{{ form.errors.min_experience_years }}</div>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="mt-1 flex gap-2">
                            <TextInput v-model="newSkill" type="text" class="flex-1" placeholder="Add a required skill" @keyup.enter="addSkill" />
                            <button type="button" @click="addSkill" class="rounded-md bg-indigo-600 px-4 py-2 text-white hover:bg-indigo-700">
                                Add
                            </button>
                            <button
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="mt-1 flex gap-2">
                            ...
                            />
                            <button type="button" @click="addQualification" class="rounded-md bg-indigo-600 px-4 py-2 text-white hover:bg-indigo-700">
                                Add
                            </button>
                        </div>
                        ...
                        <div v-if="form.errors.preferred_qualifications" class="mt-1 text-sm text-red-600">
                            {{ form.errors.preferred_qualifications }}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Job Details -->
            <div class="rounded-lg bg-gray-50 p-6">
                <h3 class="text-md mb-4 font-medium text-gray-900">Job Details</h3>
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div>
                        ...
                        <div v-if="form.errors.job_type" class="mt-1 text-sm text-red-600">{{ form.errors.job_type }}</div>
                    </div>
                    ...
                    <div>
                        ...
                        <div v-if="form.errors.work_arrangement" class="mt-1 text-sm text-red-600">{{ form.errors.work_arrangement }}</div>
                    </div>
                    ...
                    <div>
                        ...
                        <div v-if="form.errors.application_deadline" class="mt-1 text-sm text-red-600">{{ form.errors.application_deadline }}</div>
                    </div>

                    <div>
                        <label for="job_start_date" class="block text-sm font-medium text-gray-700">Expected Start Date</label>
                        <TextInput id="job_start_date" v-model="form.job_start_date" type="date" class="mt-1 block w-full" />
                        <div v-if="form.errors.job_start_date" class="mt-1 text-sm text-red-600">{{ form.errors.job_start_date }}</div>
                    </div>
                </div>
            </div>
            ...
            <!-- Compensation -->
            <div class="rounded-lg bg-gray-50 p-6">
                <h3 class="text-md mb-4 font-medium text-gray-900">Compensation</h3>
                <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                    <div>
                        ...
                        <div v-if="form.errors.salary_type" class="mt-1 text-sm text-red-600">{{ form.errors.salary_type }}</div>
                    </div>
                    ...
                    <div>
                        ...
                        <TextInput
                            ...
                            placeholder="0.00"
                        />
                        <div v-if="form.errors.salary_min" class="mt-1 text-sm text-red-600">{{ form.errors.salary_min }}</div>
                    </div>
                    ...
                    <div>
                        ...
                        <TextInput
                            ...
                            placeholder="0.00"
                        />
                        <div v-if="form.errors.salary_max" class="mt-1 text-sm text-red-600">{{ form.errors.salary_max }}</div>
                    </div>
                    ...
                    <div class="md:col-span-3">
                        ...
                        <div class="mt-1 flex gap-2">
                            ...
                            />
                            <button type="button" @click="addBenefit" class="rounded-md bg-indigo-600 px-4 py-2 text-white hover:bg-indigo-700">
                                Add
                            </button>
                        </div>
            ...
            <!-- Contact Information -->
            <div class="rounded-lg bg-gray-50 p-6">
                <h3 class="text-md mb-4 font-medium text-gray-900">Contact Information</h3>
                <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                    <div>
            ...
            <!-- Company Culture -->
            <div class="rounded-lg bg-gray-50 p-6">
                <h3 class="text-md mb-4 font-medium text-gray-900">Company Culture</h3>
                <div>
                    ...
                    ></textarea>
                    <div v-if="form.errors.company_culture" class="mt-1 text-sm text-red-600">{{ form.errors.company_culture }}</div>
                </div>
            </div>
