        ...
        <div class="dashboard-grid">
            ...
            <div class="dashboard-card">
                ...
                <div class="uptime-grid">
                    <div v-for="(endpoint, name) in dashboardData.uptime" :key="name" :class="['uptime-item', endpoint.status]">
            ...
            <div class="dashboard-card">
                ...
                <div class="health-grid">
                    <div v-for="(check, name) in dashboardData.system_health" :key="name" :class="['health-item', check.status || 'unknown']">
            ...
            <div class="dashboard-card full-width">
                ...
                <div class="activity-list">
                    <div v-for="activity in dashboardData.recent_activity" :key="activity.id" class="activity-item">
