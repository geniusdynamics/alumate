<template>
    <div class="min-h-screen bg-gray-50">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-gray-600">Real-time system health and analytics monitoring</p>
                    </div>
                    <div class="flex space-x-4">
                        ...
                        <button
                            @click="runMonitoringCycle"
                            class="rounded-lg bg-blue-600 px-6 py-2 text-white hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            ...
            <div v-if="dashboardData.alerts && dashboardData.alerts.length > 0" class="mt-8">
                <div class="rounded-lg bg-white p-6 shadow-lg">
                    <div class="mb-4 flex items-center justify-between">
                        ...
                        <button @click="showAlertModal = !showAlertModal" class="text-blue-600 hover:text-blue-800">View All</button>
                    </div>
                    <div class="space-y-3">
                        <div
                            v-for="alert in dashboardData.alerts.slice(0, 5)"
                            :key="alert.timestamp"
        ...
        <!-- Alert Modal -->
        <AlertModal v-if="showAlertModal" :alerts="allAlerts" @close="showAlertModal = false" />
    </div>
</template>
