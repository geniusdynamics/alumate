...
watch(search, (value) => {
    router.get(
        route('admin.job-approval.index'),
        { search: value },
        {
            preserveState: true,
            replace: true,
...
<template>
    ...
    <AppLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800">Job Approval Queue</h2>
        </template>
            ...
            <div class="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
                ...
                <div class="rounded-lg bg-white p-6 shadow">
                    <div class="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
                        ...
                        <div v-if="selectedJobs.length > 0" class="flex items-center space-x-3">
                            ...
                            <button @click="bulkApprove" class="rounded-md bg-green-600 px-4 py-2 text-sm font-medium text-white hover:bg-green-700">
                                Bulk Approve
                            </button>
                            <button @click="bulkReject" class="rounded-md bg-red-600 px-4 py-2 text-sm font-medium text-white hover:bg-red-700">
                                Bulk Reject
                            </button>
                        </div>
                    </div>
                ...
                <div class="overflow-hidden bg-white shadow sm:rounded-md">
                    <div v-if="pending_jobs.data.length > 0" class="divide-y divide-gray-200">
                        <!-- Header -->
                        <div class="flex items-center bg-gray-50 px-6 py-3">
                            <input
                                type="checkbox"
                                ...
                                <div class="min-w-0 flex-1">
                                    <div class="flex items-center justify-between">
                                        <div class="flex-1">
                                            ...
                                            <p class="mt-2 line-clamp-2 text-sm text-gray-700">{{ job.description }}</p>
                    ...
                    <!-- Pagination -->
                    <div v-if="pending_jobs.links && pending_jobs.data.length > 0" class="border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
                        <div class="flex items-center justify-between">
