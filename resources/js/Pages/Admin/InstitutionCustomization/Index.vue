    ...
    <AdminLayout>
        <div class="institution-customization">
            ...
            <div class="customization-tabs">
                <button v-for="tab in tabs" :key="tab.key" @click="activeTab = tab.key" :class="['tab-button', { active: activeTab === tab.key }]">
                    ...
                    <form @submit.prevent="updateBranding" class="branding-form">
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <div class="color-input-group">
                                    <input v-model="brandingForm.primary_color" type="color" class="color-input" />
                                    <input v-model="brandingForm.primary_color" type="text" class="form-input" placeholder="#007bff" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="color-input-group">
                                    <input v-model="brandingForm.secondary_color" type="color" class="color-input" />
                                    <input v-model="brandingForm.secondary_color" type="text" class="form-input" placeholder="#6c757d" />
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="file-upload-area">
                                ...
                                <div class="upload-preview">
                                    <img v-if="institution.logo_url" :src="institution.logo_url" alt="Current logo" class="current-logo" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="file-upload-area">
                                ...
                                <div class="upload-preview banner-preview">
                                    <img v-if="institution.banner_url" :src="institution.banner_url" alt="Current banner" class="current-banner" />
                                    <div class="upload-placeholder" v-else>
                                        <Icon name="image" class="h-8 w-8" />
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-primary" :disabled="brandingLoading">
                                <Icon v-if="brandingLoading" name="loader" class="h-4 w-4 animate-spin" />
            ...
            <div v-if="activeTab === 'features'" class="tab-content">
                <div class="section-card">
                    ...
                    <div class="features-grid">
                        <div v-for="(feature, key) in availableFeatures" :key="key" class="feature-card">
                            <div class="feature-header">
                                ...
                                <label class="toggle-switch">
                                    <input v-model="featureFlags[key]" type="checkbox" @change="updateFeatures" />
                    ...
                    <div class="custom-fields-manager">
                            ...
                            <div v-for="(field, index) in customFields" :key="index" class="field-item">
                                <div class="field-config">
                                    <div class="field-basic">
                                        <input v-model="field.name" type="text" placeholder="Field Name" class="form-input" />
                                    ...
                                    <button @click="removeCustomField(index)" class="btn btn-danger btn-sm">
                        ...
                        <div class="form-actions">
                            <button @click="saveCustomFields" class="btn btn-primary" :disabled="customFieldsLoading">
                                <Icon v-if="customFieldsLoading" name="loader" class="h-4 w-4 animate-spin" />
                ...
                <div class="section-card">
                    ...
                    <div class="workflows-manager">
                        ...
                        <div class="workflows-list">
                            <div v-for="(workflow, index) in workflows" :key="index" class="workflow-item">
                                <div class="workflow-header">
                                    <input v-model="workflow.name" type="text" placeholder="Workflow Name" class="form-input workflow-name" />
                                    <label class="toggle-switch">
                                ...
                                <div class="workflow-config">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="actions-list">
                                            <div v-for="(action, actionIndex) in workflow.actions" :key="actionIndex" class="action-item">
                                                ...
                                                <input v-model="action.config" type="text" placeholder="Action configuration" class="form-input" />
                                                <button @click="removeWorkflowAction(workflow, actionIndex)" class="btn btn-danger btn-sm">
                                                    <Icon name="trash" class="h-4 w-4" />
                                                </button>
                                            </div>
                                            <button @click="addWorkflowAction(workflow)" class="btn btn-secondary btn-sm">
                                                <Icon name="plus" class="h-4 w-4" />
                                                Add Action
                                            </button>
                                        </div>
                                ...
                                <button @click="removeWorkflow(index)" class="btn btn-danger btn-sm">
                                    <Icon name="trash" class="h-4 w-4" />
                                    Remove Workflow
                                </button>
                            </div>
                        ...
                        <div class="form-actions">
                            <button @click="saveWorkflows" class="btn btn-primary" :disabled="workflowsLoading">
                                <Icon v-if="workflowsLoading" name="loader" class="h-4 w-4 animate-spin" />
                ...
                <div class="section-card">
                    ...
                    <form @submit.prevent="saveReportingConfig" class="reporting-form">
                        <div class="form-group">
                            ...
                            <div class="metrics-grid">
                                <label v-for="metric in availableMetrics" :key="metric.key" class="metric-option">
                                    <input v-model="reportingConfig.default_metrics" type="checkbox" :value="metric.key" class="metric-checkbox" />
                        ...
                        <div class="form-group">
                            ...
                            <input v-model.number="reportingConfig.data_retention_days" type="number" min="30" max="2555" class="form-input" />
                        </div>

                        <div class="form-actions">
                            <button type="submit" class="btn btn-primary" :disabled="reportingLoading">
                                <Icon v-if="reportingLoading" name="loader" class="h-4 w-4 animate-spin" />
            ...
            <div v-if="activeTab === 'integrations'" class="tab-content">
                <div class="section-card">
                    ...
                    <div class="integrations-grid">
                        <div v-for="(integration, key) in integrationOptions" :key="key" class="integration-card">
                            <div class="integration-header">
                                ...
                                <label class="toggle-switch">
                                    <input v-model="integrations[key].enabled" type="checkbox" @change="updateIntegrations" />
                                    <span class="toggle-slider"></span>
                                </label>
                            </div>
                            ...
                            <div v-if="integrations[key].enabled" class="integration-config">
                                <div class="form-group">
                                    ...
                                    <select v-model="integrations[key].provider" class="form-select">
                                        <option v-for="provider in integration.providers" :key="provider" :value="provider">
        ...
        <div v-if="showWhiteLabelModal" class="modal-overlay" @click="closeWhiteLabelModal">
            <div class="modal-container" @click.stop>
                ...
                <div class="modal-footer">
                    ...
                    <button @click="closeWhiteLabelModal" class="btn btn-secondary">Close</button>
                </div>
            </div>
        </div>
    </AdminLayout>
...
const integrations = reactive(
    Object.keys(props.integrationOptions).reduce(
        (acc, key) => {
...
const updateFeatures = async () => {
    try {
        await router.post(
            `/admin/institutions/${props.institution.id}/features`,
            {
...
const saveCustomFields = async () => {
    ...
    try {
        await router.post(
            `/admin/institutions/${props.institution.id}/custom-fields`,
            {
...
const saveWorkflows = async () => {
    ...
    try {
        await router.post(
            `/admin/institutions/${props.institution.id}/workflows`,
            {
...
const saveReportingConfig = async () => {
    ...
    try {
        await router.post(
            `/admin/institutions/${props.institution.id}/reporting`,
            {
...
const updateIntegrations = async () => {
    try {
        ...
        await router.post(
            `/admin/institutions/${props.institution.id}/integrations`,
            {
...
.customization-tabs {
    @apply mb-8 flex space-x-1 rounded-lg bg-gray-100 p-1 dark:bg-gray-800;
}
...
.tab-button.active {
    @apply bg-white text-blue-600 shadow-sm dark:bg-gray-700 dark:text-blue-400;
}
...
.file-upload-area {
    @apply rounded-lg border-2 border-dashed border-gray-300 p-4 dark:border-gray-600;
    @apply transition-colors hover:border-blue-400 dark:hover:border-blue-500;
}
...
.current-banner {
    @apply max-h-32 w-full rounded object-cover;
}
...
.feature-category {
    @apply mt-2 inline-block rounded bg-blue-100 px-2 py-1 text-xs font-medium text-blue-800 dark:bg-blue-900 dark:text-blue-200;
}
...
.toggle-slider {
    @apply absolute bottom-0 left-0 right-0 top-0 cursor-pointer rounded-full bg-gray-300 transition-colors dark:bg-gray-600;
}

.toggle-slider:before {
    @apply absolute bottom-0.5 left-0.5 h-5 w-5 rounded-full bg-white transition-transform content-[''];
}
...
.workflow-item {
    @apply space-y-4 rounded-lg border border-gray-200 p-4 dark:border-gray-700;
}
...
.integration-config {
    @apply space-y-3 border-t border-gray-200 pt-3 dark:border-gray-700;
}

.form-actions {
    @apply flex justify-end border-t border-gray-200 pt-6 dark:border-gray-700;
}
...
.config-preview {
    @apply rounded-lg bg-gray-50 p-4 dark:bg-gray-900;
}

.config-json {
    @apply whitespace-pre-wrap font-mono text-sm text-gray-800 dark:text-gray-200;
