    ...
    <div class="landing-page-dashboard">
        <div class="header">
            ...
            <div class="header-actions">
                <router-link to="/admin/landing-pages/create" class="btn btn-primary"> Create Landing Page </router-link>
            </div>
        </div>
                    ...
                    <tr v-for="page in landingPages.data" :key="page.id">
                        ...
                        <td>
                            <div class="action-buttons">
                                <router-link :to="`/admin/landing-pages/${page.id}`" class="btn btn-sm btn-secondary"> View </router-link>
                                <router-link :to="`/admin/landing-pages/${page.id}/edit`" class="btn btn-sm btn-primary"> Edit </router-link>
                                <button v-if="page.status === 'draft'" @click="publishPage(page.id)" class="btn btn-sm btn-success">Publish</button>
                                <button v-else @click="unpublishPage(page.id)" class="btn btn-sm btn-warning">Unpublish</button>
                                <button @click="duplicatePage(page.id)" class="btn btn-sm btn-secondary">Duplicate</button>
...
.audience-badge.institution {
    background: #e3f2fd;
    color: #1976d2;
}
.audience-badge.employer {
    background: #f3e5f5;
    color: #7b1fa2;
}
...
.audience-badge.alumni {
    background: #fff3e0;
    color: #f57c00;
}
.audience-badge.general {
    background: #f5f5f5;
    color: #666;
}
