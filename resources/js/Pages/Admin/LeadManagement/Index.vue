    ...
    <div class="lead-management">
        <div class="header">
            ...
            <div class="header-actions">
                <button @click="showCreateModal = true" class="btn btn-primary">Add Lead</button>
                <button @click="bulkSync" class="btn btn-secondary">Sync to CRM</button>
                <button @click="exportLeads" class="btn btn-secondary">Export</button>
            </div>
        </div>
        ...
        <div class="analytics-section">
            ...
            <div class="pipeline-section">
                ...
                <div class="pipeline-stages">
                    <div v-for="stage in pipeline" :key="stage.status" class="pipeline-stage" :class="stage.status">
            ...
            <div class="attention-items">
                <div v-for="lead in needsAttention" :key="lead.id" class="attention-item">
                    ...
                    <div class="lead-actions">
                        <button @click="viewLead(lead.id)" class="btn btn-sm btn-primary">View</button>
                        <button @click="contactLead(lead.id)" class="btn btn-sm btn-success">Contact</button>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <tr v-for="lead in leads.data" :key="lead.id">
                        ...
                        <td>
                            <div class="action-buttons">
                                <button @click="viewLead(lead.id)" class="btn btn-sm btn-secondary">View</button>
                                <button @click="editLead(lead)" class="btn btn-sm btn-primary">Edit</button>
                                <button @click="qualifyLead(lead)" class="btn btn-sm btn-success">Qualify</button>
                            </div>
                        </td>
                    </tr>
                </tbody>
                    ...
                    <form @submit.prevent="createLead">
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input v-model="createForm.first_name" type="text" required />
                            </div>
                            <div class="form-group">
                                <label>Last Name *</label>
                                <input v-model="createForm.last_name" type="text" required />
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <label>Company</label>
                                <input v-model="createForm.company" type="text" />
                            </div>
                            <div class="form-group">
                                <label>Job Title</label>
                                <input v-model="createForm.job_title" type="text" />
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    <form @submit.prevent="submitQualification">
                        ...
                        <div class="form-group">
                            ...
                            <textarea v-model="qualifyForm.notes" rows="4" placeholder="Additional qualification details..."></textarea>
                        </div>

                        <div class="form-actions">
                            <button type="submit" class="btn btn-success">Qualify Lead</button>
                            <button type="button" @click="showQualifyModal = false" class="btn btn-secondary">Cancel</button>
                        </div>
                    </form>
                </div>
            </div>
