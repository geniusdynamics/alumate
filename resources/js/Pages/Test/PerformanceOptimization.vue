<template>
    <div class="performance-optimization-demo">
        <div class="container mx-auto px-4 py-8">
            <h1 class="mb-8 text-3xl font-bold">Performance Optimization Demo</h1>
            ...
            <!-- Lazy Loading Demo -->
            <div class="mb-8">
                <h2 class="mb-4 text-2xl font-semibold">Lazy Loading Demo</h2>
            ...
            <!-- Code Splitting Demo -->
            <div class="mb-8">
                <h2 class="mb-4 text-2xl font-semibold">Code Splitting Demo</h2>
                <div class="space-y-4">
                    <button @click="loadChartComponent" :disabled="loadingChart" class="btn btn-primary">
                        {{ loadingChart ? 'Loading Chart...' : 'Load Chart Component' }}
                    </button>

                    <button @click="loadMapComponent" :disabled="loadingMap" class="btn btn-primary ml-4">
                        {{ loadingMap ? 'Loading Map...' : 'Load Map Component' }}
                    </button>

                    <button @click="loadSearchComponent" :disabled="loadingSearch" class="btn btn-primary ml-4">
                ...
                <div class="mt-6 space-y-6">
                    ...
                    <div v-if="mapComponent" class="rounded-lg bg-white p-6 shadow dark:bg-gray-800">
                        <h3 class="mb-4 text-lg font-semibold">Map Component (Lazy Loaded)</h3>
                        <component :is="mapComponent" />
                    </div>

                    <div v-if="searchComponent" class="rounded-lg bg-white p-6 shadow dark:bg-gray-800">
                        <h3 class="mb-4 text-lg font-semibold">Advanced Search (Lazy Loaded)</h3>
            ...
            <!-- Bundle Analysis -->
            <div class="mb-8">
                <h2 class="mb-4 text-2xl font-semibold">Bundle Analysis</h2>
                <div class="rounded-lg bg-white p-6 shadow dark:bg-gray-800">
                    ...
                    <div class="mt-6">
                        <h4 class="mb-2 font-semibold">Total Bundle Size: {{ formatSize(totalBundleSize) }}</h4>
                        <button @click="generateBundleReport" class="btn btn-secondary">Generate Bundle Report</button>
                    </div>
                </div>
            </div>
            ...
            <!-- Performance Metrics -->
            <div class="mb-8">
                <h2 class="mb-4 text-2xl font-semibold">Real-time Performance Metrics</h2>
                <div class="rounded-lg bg-white p-6 shadow dark:bg-gray-800">
                    ...
                    <div class="mt-6">
                        <h4 class="mb-2 font-semibold">Performance Score: {{ performanceScore }}/100</h4>
                        <div class="progress-bar">
                            <div class="progress-fill" :style="{ width: `${performanceScore}%` }" :class="getScoreClass(performanceScore)"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div v-if="alerts.length > 0" class="mb-8">
                <h2 class="mb-4 text-2xl font-semibold">Performance Alerts</h2>
                <div class="space-y-2">
            ...
            <!-- Optimization Tools -->
            <div class="mb-8">
                <h2 class="font-semibent mb-4 text-2xl">Optimization Tools</h2>
                <div class="rounded-lg bg-white p-6 shadow dark:bg-gray-800">
                    <div class="space-y-4">
                        <button @click="optimizePage" class="btn btn-success">Optimize Current Page</button>

                        <button @click="preloadCriticalResources" class="btn btn-primary ml-4">Preload Critical Resources</button>

                        <button @click="enableLazyLoading" class="btn btn-primary ml-4">Enable Lazy Loading</button>

                        <button @click="compressImages" class="btn btn-primary ml-4">Compress Images</button>
                    </div>

                    <div class="mt-6">
                        <h4 class="mb-2 font-semibold">Optimization Status</h4>
                        <div class="space-y-2">
...
const { metrics, alerts, getAverageMetrics, getPerformanceScore } = usePerformanceMonitoring('PerformanceOptimizationDemo');
...
const preloadCriticalResources = () => {
    ...
    const criticalResources = ['/build/assets/app.css', '/build/assets/app.js'];
...
.alert-warning {
    @apply border border-yellow-200 bg-yellow-50 text-yellow-800 dark:border-yellow-700 dark:bg-yellow-900 dark:text-yellow-200;
}
