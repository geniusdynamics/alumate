<template>
    <div class="mobile-container">
        <div class="mobile-section">
            <h1 class="mb-6 text-2xl font-bold text-gray-900 dark:text-white">Mobile Components Test</h1>

            <!-- Swipeable Tab Navigation Test -->
            <div class="mobile-section">
                <h2 class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Swipeable Tab Navigation</h2>
                <div class="h-96 overflow-hidden rounded-lg border border-gray-200 dark:border-gray-700">
                    <SwipeableTabNavigation :tabs="testTabs" :initial-tab="0" @tab-changed="handleTabChanged" @tab-swiped="handleTabSwiped">
                        <template #tab1="{ tab, active }">
                            <div class="p-4">
                                <h3 class="mb-2 text-lg font-medium text-gray-900 dark:text-white">{{ tab.label }}</h3>
                                <p class="text-gray-600 dark:text-gray-400">
                                    This is the content for the first tab. You can swipe left or right to navigate between tabs.
                                </p>
                        ...
                        <template #tab2="{ tab, active }">
                            <div class="p-4">
                                <h3 class="mb-2 text-lg font-medium text-gray-900 dark:text-white">{{ tab.label }}</h3>
                                <p class="text-gray-600 dark:text-gray-400">
                                    This is the second tab with different content. Try swiping to see the smooth transitions.
                                </p>
                                <div class="mt-4 grid grid-cols-2 gap-4">
                                    <div class="flex h-20 items-center justify-center rounded-lg bg-blue-100 dark:bg-blue-900/20">
                                        <span class="font-medium text-blue-600 dark:text-blue-400">Card 1</span>
                                    </div>
                                    <div class="flex h-20 items-center justify-center rounded-lg bg-green-100 dark:bg-green-900/20">
                                        <span class="font-medium text-green-600 dark:text-green-400">Card 2</span>
                                    </div>
                                </div>
                            </div>
                        </template>
                        ...
                        <template #tab3="{ tab, active }">
                            <div class="p-4">
                                ...
                                <div class="mt-4 space-y-2">
                                    <div v-for="i in 5" :key="i" class="flex items-center space-x-3 rounded-lg bg-gray-50 p-3 dark:bg-gray-800">
                                        <div class="flex h-8 w-8 items-center justify-center rounded-full bg-purple-500">
                                            <span class="text-sm font-medium text-white">{{ i }}</span>
                                        </div>
                                        <div class="flex-1">
            ...
            <div class="mobile-section">
                <h2 class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Touch Optimized Controls</h2>

                <!-- Buttons -->
                <div class="space-y-4">
                    <div>
                        <h3 class="mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">Buttons</h3>
                        <div class="space-y-3">
                    ...
                    <!-- Inputs -->
                    <div>
                        <h3 class="mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">Inputs</h3>
                        <div class="space-y-3">
                            <TouchOptimizedControls
                                type="input"
                                v-model="testInput"
                    ...
                    <!-- Select -->
                    <div>
                        <h3 class="mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">Select</h3>
                        <TouchOptimizedControls
                            type="select"
                            v-model="testSelect"
                    ...
                    <!-- Toggle -->
                    <div>
                        <h3 class="mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">Toggle</h3>
                        <TouchOptimizedControls
                            type="toggle"
                            v-model="testToggle"
                    ...
                    <!-- Slider -->
                    <div>
                        <h3 class="mb-2 text-sm font-medium text-gray-700 dark:text-gray-300">Slider</h3>
                        <TouchOptimizedControls type="slider" v-model="testSlider" label="Volume" :min="0" :max="100" :step="5" show-min-max />
                    </div>
                </div>
            </div>
            ...
            <div class="mobile-section">
                <h2 class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Mobile Layout Examples</h2>
                ...
                <div class="space-y-4">
                    <div class="mobile-card-enhanced">
                        <div class="mb-3 flex items-center space-x-3">
                            ...
                            <button class="rounded-lg p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
        ...
        <!-- Toast Notification -->
        <div v-if="showToastMessage" class="mobile-notification-enhanced mobile-notification-info mobile-animate-slide-down">
            <div class="flex items-center space-x-3">
...
.test-section {
    @apply mb-8 rounded-lg border border-gray-200 p-4 dark:border-gray-700;
}
