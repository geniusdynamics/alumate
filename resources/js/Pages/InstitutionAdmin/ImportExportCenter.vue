                ...
                <div class="flex h-16 justify-between">
                    <div class="flex items-center space-x-8">
                        ...
                        <nav class="flex space-x-8">
                            ...
                            <Link :href="route('institution-admin.import-export')" class="font-medium text-blue-600">Import/Export</Link>
                        </nav>
                    </div>
        ...
        <div class="py-6">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="p-5">
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        <dt class="truncate text-sm font-medium text-gray-500">Total Imports</dt>
                ...
                <div class="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                    <Link :href="route('graduates.import.create')" class="rounded-lg bg-white p-6 shadow transition-shadow hover:shadow-md">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                    ...
                    <Link :href="route('courses.import.create')" class="rounded-lg bg-white p-6 shadow transition-shadow hover:shadow-md">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                    ...
                    <Link :href="route('graduates.export')" class="rounded-lg bg-white p-6 shadow transition-shadow hover:shadow-md">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                    ...
                    <Link :href="route('courses.export')" class="rounded-lg bg-white p-6 shadow transition-shadow hover:shadow-md">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                ...
                <div class="rounded-lg bg-white shadow">
                    <div class="p-6">
                        <div class="mb-6 flex items-center justify-between">
                            ...
                            <Link :href="route('graduates.import.history')" class="text-sm font-medium text-indigo-600 hover:text-indigo-900">
                                View All History
                            </Link>
                        </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">File Name</th>
                                ...
                                <tbody class="divide-y divide-gray-200 bg-white">
                                    <tr v-for="import_ in importHistory.data" :key="import_.id">
                                        <td class="whitespace-nowrap px-6 py-4">
                                            <span
                                                class="inline-flex rounded-full bg-blue-100 px-2 py-1 text-xs font-semibold capitalize text-blue-800"
                                            >
                                                {{ import_.type }}
                                            </span>
                                        </td>
                                        <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-900">{{ import_.filename }}</td>
                                        <td class="whitespace-nowrap px-6 py-4">
                                            <span
                                        ...
                                        <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-500">
                                            <div class="text-sm">
                                                <div class="text-green-600">
                                                    {{ (import_.created_count || 0) + (import_.updated_count || 0) }} success
                                                </div>
                                                <div class="text-red-600" v-if="import_.skipped_count">{{ import_.skipped_count }} failed</div>
                                            </div>
                                        </td>
                                        <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-500">{{ import_.user?.name }}</td>
                                        <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-500">{{ formatDate(import_.created_at) }}</td>
                        ...
                        <div v-if="importHistory.data.length === 0" class="py-8 text-center text-gray-500">No import history found.</div>
...
const rollbackImport = (import_) => {
    if (confirm('Are you sure you want to rollback this import? This will remove all records that were imported.')) {
        router.post(
            route('graduates.import.rollback', import_.id),
            {},
            {
                preserveScroll: true,
            },
