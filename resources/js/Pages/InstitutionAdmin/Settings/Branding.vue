                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <div v-if="logoPreview" class="mt-4">
                                        <img :src="logoPreview" alt="Logo Preview" class="h-20 w-auto rounded-md bg-gray-100 p-2" />
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input
                                            ...
                                            class="absolute left-2 top-1/2 h-8 w-8 -translate-y-1/2 border-none p-0"
                                        />
                                    </div>
                                </div>
