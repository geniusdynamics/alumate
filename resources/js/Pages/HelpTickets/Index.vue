    ...
    <AppLayout title="Help & Support">
        <template #header>
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-semibold leading-tight text-gray-800">Help & Support</h2>
                <Link
            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <!-- Tickets List -->
                        <div class="space-y-4">
                            <div v-for="ticket in tickets.data" :key="ticket.id" class="rounded-lg border p-4 transition-colors hover:bg-gray-50">
                                <div class="flex items-start justify-between">
                                    ...
                                    <div class="ml-4 text-right">
                                        ...
                                        <div v-if="ticket.updated_at !== ticket.created_at" class="mt-1 text-xs text-gray-500">
