    ...
    <AppLayout title="Analytics Reports">
        <template #header>
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-semibold leading-tight text-gray-800">Analytics Reports</h2>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">Last Execution</th>
                                    ...
                                    <tr v-for="report in reports" :key="report.id">
                                        ...
                                        <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-900">
                                            <div v-if="report.is_scheduled" class="flex items-center">
                                                <ClockIcon class="mr-1 h-4 w-4 text-green-500" />
                                        ...
                                        <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-900">
                                            <div v-if="report.last_execution">
                                                <div class="flex items-center">
                                                    <span
                                                        :class="getStatusColor(report.last_execution.status)"
                                        ...
                                        <td class="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                                            <div class="flex items-center space-x-2">
                                                <button @click="previewReport(report)" class="text-indigo-600 hover:text-indigo-900">Preview</button>
                                                <button
                                                ...
                                                <button @click="editReport(report)" class="text-blue-600 hover:text-blue-900">Edit</button>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                ...
                <form @submit.prevent="createReport">
                    <div class="space-y-4">
                        ...
                        <div v-if="availableColumns.length > 0">
                            <label class="mb-2 block text-sm font-medium text-gray-700">Columns to Include</label>
        ...
        <Modal :show="showPreviewModal" @close="showPreviewModal = false" max-width="6xl">
            <div class="p-6">
                <h3 class="mb-4 text-lg font-medium text-gray-900">Report Preview</h3>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th
                                        v-for="column in Object.keys(previewData.data[0] || {})"
                                        :key="column"
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                <tr v-for="(row, index) in previewData.data" :key="index">
                                    <td v-for="(value, column) in row" :key="column" class="whitespace-nowrap px-6 py-4 text-sm text-gray-900">
