<template>
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-purple-600 py-16 text-white">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="text-center">
                    <h1 class="mb-4 text-4xl font-bold">Alumni Success Stories</h1>
                    <p class="mx-auto max-w-3xl text-xl opacity-90">
        ...
        <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
            <div class="mb-12">
                <h2 class="mb-8 text-3xl font-bold text-gray-900">Featured Stories</h2>
                <div v-if="featuredStories.length > 0" class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                    <SuccessStoryCard
            ...
            <div class="mb-8">
                ...
                <div v-else-if="stories.data && stories.data.length > 0" class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                    <SuccessStoryCard
            ...
            <div v-if="stories.data && stories.data.length > 0" class="flex justify-center">
                <nav class="flex items-center space-x-2">
                    <button
                        ...
                        class="rounded-md border border-gray-300 px-3 py-2 text-sm text-gray-500 hover:bg-gray-50 hover:text-gray-700"
                    >
                        Previous
                    </button>
                    <span class="px-3 py-2 text-sm text-gray-700"> Page {{ stories.current_page }} of {{ stories.last_page }} </span>
                    <button
