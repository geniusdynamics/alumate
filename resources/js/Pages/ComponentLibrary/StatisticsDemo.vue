    ...
    <div class="min-h-screen bg-gray-50 py-12 dark:bg-gray-900">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-12 text-center">
                <h1 class="mb-4 text-4xl font-bold text-gray-900 dark:text-white">Enhanced Statistics Counters Demo</h1>
                <p class="mx-auto max-w-3xl text-xl text-gray-600 dark:text-gray-400">
                    Showcasing animated statistics counters with real-time data integration, accessibility features, error handling, and
            ...
            <div class="mb-8 rounded-lg bg-white p-6 shadow-lg dark:bg-gray-800">
                <h2 class="mb-4 text-2xl font-semibold text-gray-900 dark:text-white">Demo Controls</h2>
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                    <div>
                        <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"> Layout </label>
                        <select
                    ...
                    <div>
                        <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"> Size </label>
                        <select
                    ...
                    <div>
                        <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"> Animation Duration (ms) </label>
                        <input
                    ...
                    <div>
                        <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"> Locale </label>
                        <select
                ...
                <div class="mt-4 flex flex-wrap gap-4">
                    ...
                    <label class="flex items-center">
                        <input v-model="demoConfig.showActions" type="checkbox" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500" />
            ...
            <div class="mt-12 rounded-lg bg-white p-6 shadow-lg dark:bg-gray-800">
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <button @click="clearEventLog" class="rounded-md bg-gray-500 px-4 py-2 text-sm text-white transition-colors hover:bg-gray-600">
                        Clear Log
                    </button>
                </div>
                <div class="max-h-64 overflow-y-auto">
                    <div v-if="eventLog.length === 0" class="py-4 text-center text-gray-500 dark:text-gray-400">
                    ...
                    <div v-else class="space-y-2">
                        ...
                        >
                            <div class="flex-1">
                                ...
                                <span class="ml-2 text-gray-600 dark:text-gray-400">{{ event.message }}</span>
                            </div>
