        ...
        <div class="alumni-map-page">
            ...
            <div class="page-header">
                <div class="header-content">
                    ...
                    <div class="header-actions">
                        <button @click="showPrivacySettings = true" class="btn-secondary" aria-label="Manage location privacy settings">
                        ...
                        <button @click="showLocationUpdate = true" class="btn-primary" aria-label="Update your location">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
            ...
            <div class="insights-panel" v-if="showInsights">
                <div class="panel-header">
                    ...
                    <button @click="showInsights = false" class="close-btn" aria-label="Close insights panel">
                ...
                <div class="insights-content">
                    ...
                    <div class="insight-section">
                        ...
                        <div class="insight-list">
                            <div v-for="country in stats.by_country?.slice(0, 5)" :key="country.country" class="insight-item">
                    ...
                    <div class="insight-section">
                        ...
                        <div class="insight-list">
                            <div v-for="industry in stats.by_industry?.slice(0, 5)" :key="industry.industry" class="insight-item">
                    ...
                    <div class="insight-section">
                        ...
                        <div class="insight-list">
                            <div v-for="region in stats.by_region?.slice(0, 5)" :key="region.region" class="insight-item">
            ...
            <div v-if="showPrivacySettings" class="modal-overlay" @click="showPrivacySettings = false">
                <div class="modal-content" @click.stop>
                    <div class="modal-header">
                        ...
                        <button @click="showPrivacySettings = false" class="close-btn" aria-label="Close privacy settings">
                            <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                            </svg>
                        </button>
                    ...
                    <div class="modal-body">
                        <p class="privacy-description">Control who can see your location on the alumni map. Your privacy is important to us.</p>

                        <div class="privacy-options">
                            <label class="privacy-option">
                                <input type="radio" v-model="privacySettings.location_privacy" value="public" name="location_privacy" />
                            ...
                            <label class="privacy-option">
                                <input type="radio" v-model="privacySettings.location_privacy" value="alumni_only" name="location_privacy" />
                                <div class="option-content">
                                    <div class="option-title">Alumni Only</div>
                                    <div class="option-description">Only verified alumni from your institution can see your location.</div>
                                </div>
                            </label>

                            <label class="privacy-option">
                                <input type="radio" v-model="privacySettings.location_privacy" value="private" name="location_privacy" />
                                <div class="option-content">
                                    <div class="option-title">Private</div>
                                    <div class="option-description">Your location is not shown on the map to anyone.</div>
                                </div>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="modal-footer">
                        <button @click="showPrivacySettings = false" class="btn-secondary">Cancel</button>
                        <button @click="savePrivacySettings" class="btn-primary">Save Settings</button>
                    </div>
                </div>
            </div>
            ...
            <div v-if="showLocationUpdate" class="modal-overlay" @click="showLocationUpdate = false">
                <div class="modal-content" @click.stop>
                    <div class="modal-header">
                        ...
                        <button @click="showLocationUpdate = false" class="close-btn" aria-label="Close location update">
                            <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                            </svg>
                        </button>
                        ...
                        <form @submit.prevent="updateLocation">
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    required
                                />
                                <p class="form-help">Enter your current location to help fellow alumni find you.</p>
                            </div>

                            <div class="form-actions">
                                <button type="button" @click="getCurrentLocation" class="btn-secondary" :disabled="gettingLocation">
                                    <svg v-if="!gettingLocation" class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path
                                            stroke-linecap="round"
                                            stroke-linejoin="round"
                                            stroke-width="2"
                    ...
                    <div class="modal-footer">
                        <button @click="showLocationUpdate = false" class="btn-secondary">Cancel</button>
                        <button @click="updateLocation" class="btn-primary" :disabled="!locationForm.address">Update Location</button>
                    </div>
                </div>
            </div>
...
const { isLoading, trackInteraction, trackApiCall, startLoading, endLoading } = usePerformanceMonitoring('AlumniMap');
...
const nearbyCount = computed(() => {
    ...
    return props.alumni.filter((alumnus) => {
        ...
        const distance = calculateDistance(props.userLocation.latitude, props.userLocation.longitude, alumnus.latitude, alumnus.longitude);
