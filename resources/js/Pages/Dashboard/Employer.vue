    ...
    <AppLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-xl font-semibold leading-tight text-gray-800">Employer Dashboard</h2>
                    <p class="mt-1 text-sm text-gray-600">Welcome back, {{ employer.company_name }}</p>
                </div>
            ...
            <div class="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>
                                    ...
                                    <Link :href="route('employer.profile')" class="font-medium underline"> Complete your profile </Link> to improve
                                    your visibility to candidates.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div>
                            <span class="inline-flex rounded-lg bg-white bg-opacity-20 p-3">
                                <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    />
                                    <path
                                        v-else-if="action.icon === 'document-text'"
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
                                        stroke-width="2"
                                    ...
                                    />
                                    <path
                                        v-else-if="action.icon === 'building-office'"
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
                                        stroke-width="2"
                    ...
                    <div class="overflow-hidden rounded-lg bg-white shadow">
                        <div class="p-5">
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        <dt class="truncate text-sm font-medium text-gray-500">Shortlisted</dt>
                    ...
                    <div class="overflow-hidden rounded-lg bg-white shadow">
                        <div class="p-5">
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        <dt class="truncate text-sm font-medium text-gray-500">Total Hires</dt>
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    ...
                    <div class="overflow-hidden rounded-lg bg-white shadow lg:col-span-2">
                        <div class="px-4 py-5 sm:p-6">
                            <div class="mb-4 flex items-center justify-between">
                                ...
                                <Link :href="route('employer.applications')" class="text-sm text-indigo-600 hover:text-indigo-500"> View all </Link>
                            </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="overflow-hidden rounded-lg bg-white shadow">
                            <div class="px-4 py-5 sm:p-6">
                                <h3 class="mb-4 text-lg font-medium leading-6 text-gray-900">Hiring Analytics</h3>
                                <div class="space-y-3">
                                    <div class="flex justify-between text-sm">
                ...
                <div class="overflow-hidden rounded-lg bg-white shadow">
                    <div class="px-4 py-5 sm:p-6">
                        <div class="mb-4 flex items-center justify-between">
                            ...
                            <Link :href="route('jobs.index')" class="text-sm text-indigo-600 hover:text-indigo-500"> Manage all jobs </Link>
                        </div>
                        <div v-if="recentActivities.recent_jobs.length > 0" class="space-y-3">
                            <div
                                v-for="job in recentActivities.recent_jobs"
                                :key="job.id"
                                class="flex items-center justify-between rounded-lg bg-gray-50 p-3"
                            >
                                <div>
