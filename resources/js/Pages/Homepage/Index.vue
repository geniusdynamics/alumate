<template>
    <HomepageLayout :title="pageTitle" :description="pageDescription" :keywords="pageKeywords">
        <div class="homepage-container">
            <!-- Audience Selector -->
            <AudienceSelector v-model:audience="currentAudience" @audience-changed="handleAudienceChange" />

            <!-- Hero Section - Critical, load immediately -->
            <HeroSection :audience="currentAudience" :hero-data="heroData" @cta-click="handleCTAClick" />
            ...
            >
                <template #placeholder>
                    <div class="h-96 animate-pulse rounded-lg bg-gray-50"></div>
                </template>
                <template #loading>
            ...
            >
                <template #placeholder>
                    <div class="h-64 animate-pulse rounded-lg bg-gray-50"></div>
                </template>
            </LazyComponent>
            ...
            >
                <template #placeholder>
                    <div class="h-80 animate-pulse rounded-lg bg-gray-50"></div>
                </template>
            </LazyComponent>
            ...
            <TrustIndicators :audience="currentAudience" />
...
import { AudienceType, CTAClickEvent } from '@/types/homepage';
