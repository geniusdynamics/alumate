...
export class MediaOptimizationService {
    ...
    generateVideoSources(
        ...
        const poster = asset.poster
            ? this.generateOptimizedUrl(asset.poster, {
                  width: 1920,
...
export const generateVideoSources = (asset: MediaAsset & any) => mediaOptimizer.generateVideoSources(asset);
