...
export class AccessibilityValidator {
     ...
     */
    public validateComponent(config: ResponsiveComponentConfig, componentType: string): AccessibilityValidationResult {
     ...
     */
    public generateScreenReaderMetadata(componentType: string, config: any): AccessibilityMetadata {
     ...
     */
    public autoFixIssues(config: ResponsiveComponentConfig, issues: AccessibilityIssue[]): ResponsiveComponentConfig {
