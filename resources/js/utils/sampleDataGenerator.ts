    ...
    individual: {
        default: {
            ...
            medium: {
                ...
                description:
                    'Join our exclusive alumni network and unlock opportunities for career growth, mentorship, and professional development.',
                ctaButtons: [
                    {
                        id: 'cta-1',
                        text: 'Join Network',
            ...
            long: {
                ...
                description:
                    'Join our exclusive alumni network and discover a world of possibilities. Connect with industry leaders, find mentors, explore career opportunities, and build lasting professional relationships that will accelerate your career growth and open doors to success.',
                ctaButtons: [
                    {
                        id: 'cta-1',
        ...
        minimal: {
            ...
            long: {
                ...
                subheading: 'Connect. Grow. Succeed.',
                description:
                    'A clean, simple approach to professional networking. Connect with fellow alumni, share opportunities, and grow your career through meaningful relationships.',
                ctaButtons: [
                    {
                        id: 'cta-1',
                        text: 'Get Started',
        ...
        rich: {
            ...
            medium: {
                ...
                description:
                    '🎯 Unlock exclusive opportunities, find world-class mentors, and accelerate your professional growth through our premium alumni network.',
                ctaButtons: [
                    {
                        id: 'cta-1',
    ...
    institution: {
        default: {
            ...
            long: {
                ...
                description:
                    "Enhance your alumni relations with our comprehensive platform designed specifically for educational institutions. Increase engagement, boost donations, facilitate networking, and build a thriving alumni community that supports your institution's mission and growth.",
                ctaButtons: [
                    {
                        id: 'cta-1',
                        text: 'Schedule Demo',
    ...
    employer: {
        default: {
            ...
            medium: {
                ...
                description:
                    'Connect with skilled professionals and recent graduates from top universities. Streamline your recruitment process and find the perfect candidates.',
                ctaButtons: [
                    {
                        id: 'cta-1',
                        text: 'Post Jobs',
...
function generateHeroSampleData(
    ...
    const data =
        heroSampleData[audienceType]?.[variation]?.[contentLength] ||
...
function generateTestimonialSampleData(
    ...
    const testimonials = testimonialSampleData[audienceType]?.default?.[contentLength] || testimonialSampleData.individual.default.medium;
