...
export type {
    ...
    ContainerConfig,
    PerformanceMetrics,
    AudienceType as TemplateAudienceType,
    CampaignType,
    TemplateCategory,
    TemplateStatus,
    TemplateFilters,
    Recommendation as TemplateRecommendation,
    TrendData as TemplateTrendData,
    TemplateCreateData,
    TemplateUpdateData,
} from './templates';
...
export type {
    ...
    LandingPageUpdateData,
    LandingPagePublishOptions,
    LandingPagePerformanceStats,
    AudienceType as LandingPageAudienceType,
    CampaignType as LandingPageCampaignType,
    LandingPageCategory,
} from './landing-pages';
...
export type {
    TemplateMetrics,
    LandingPageMetrics,
    LandingPageTrafficData,
    LandingPageConversionData,
    LandingPagePerformanceData,
    LandingPageSEOMetrics,
    KeywordRanking,
    TemplateRecommendation,
    MetricTrendData,
    TemplateABTest,
    TemplateABTestStatus,
    TemplateABTestVariant,
    TemplateTrafficSplit,
