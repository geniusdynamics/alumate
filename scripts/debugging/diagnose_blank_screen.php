...
echo "\n🌐 Test URLs:\n";
echo "=============\n";
echo "- http://localhost:8080/ (should show welcome page)\n";
echo "- http://localhost:8080/login (should show login form)\n";
echo "- http://localhost:8080/register (should show registration form)\n";
