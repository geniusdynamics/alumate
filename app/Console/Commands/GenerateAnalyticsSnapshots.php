...
class GenerateAnalyticsSnapshots extends Command
{
    protected $signature = 'analytics:generate-snapshots 
                            {--type=daily : Type of snapshot to generate (daily, weekly, monthly, graduate_outcomes, course_roi, employer_engagement, community_health, platform_benchmarks, market_trends)}
