...
/**
 * Validation rules for adding emails to sequences
 */
class StoreSequenceEmailRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        // Add unique validation for send_order within the sequence
        $rules['send_order'] = [
            'required',
            'integer',
            'min:0',
    ...
    {
        return [
            'template_id.required' => 'Email template is required.',
            'template_id.exists' => 'Selected template does not exist or is not accessible.',
            'subject_line.required' => 'Email subject line is required.',
            ...
            'send_order.required' => 'Send order is required.',
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            ...
            // Validate send order doesn't create gaps
            if ($this->has('send_order')) {
