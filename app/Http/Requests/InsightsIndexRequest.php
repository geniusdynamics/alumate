...
/**
 * Insights Index Request
 *
 * Validates requests for retrieving insights with filtering and pagination.
 */
class InsightsIndexRequest extends FormRequest
{
    /**
    ...
    public function messages(): array
    {
        return [
            ...
            'type.in' => 'Type must be either trend or recommendation.',
