...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('analytics_events', function (Blueprint $table) {
            ...
            $table->index(['tenant_id', 'created_at', 'event_type'], 'analytics_events_tenant_created_event_idx');

            // Composite index for user-specific analytics queries
            $table->index(['tenant_id', 'user_id', 'created_at'], 'analytics_events_tenant_user_created_idx');

            // Composite index for gamification points queries
            $table->index(['tenant_id', 'event_type', 'points_earned'], 'analytics_events_tenant_gamification_points_idx');

            // Composite index for session-based analytics
            $table->index(['tenant_id', 'session_id', 'created_at'], 'analytics_events_tenant_session_created_idx');
        });

        // Add indexes to heat_map_data table for performance optimization
    ...
    public function down(): void
    {
        Schema::table('analytics_events', function (Blueprint $table) {
            ...
            $table->dropIndex('analytics_events_tenant_user_created_idx');
